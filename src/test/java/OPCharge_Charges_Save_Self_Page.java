...
public class OPCharge_Charges_Save_Self_Page {
	...
	public OPCharge_Charges_Save_Self_Page (WebDriver driver)
  ...
  public void OPChargeScreenSelf (String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException 
  {
	...
	//Clicking on menu Icon
			...
			FileUtils.copyFile(screenshot, new File(".//ScreenShots//OPCharge_Charges_Save_Self_Test_QuickRegisterationForm.png")); 
			...
			Thread.sleep(3000);
		      ...
		      FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OPCharge_Charges_Save_Self_Test_QuickRegistrationSaved.png"));
			...
			//CreatedMRN
			  ...
			  Thread.sleep(5000);
			   ...
			   System.out.println("Encounter List Screen Not Appear"); 
				...
				FileUtils.copyFile(screenshot2, new File(".//ScreenShots//OPCharge_Charges_Save_Self_Test_EncounterListScreen.png")); 
	...
	//SideMenuBar
	  ...
	  Thread.sleep(5000);
	   ...
	   System.out.println("OP Charge Screen Not Appear"); 
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OPCharge_Charges_Save_Self_Test_OPChargeScreen.png")); 
	...
	//ServiceSelect
      ...
      FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OPCharge_Charges_Save_Self_Test_ChargesSave2.png"));
      Thread.sleep(3000);
