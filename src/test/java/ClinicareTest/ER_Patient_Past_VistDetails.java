...
public class ER_Patient_Past_VistDetails
{
	...
	@Test(priority=2)
	public void TC_02_ER_Patient_Past_VistDetails() throws InterruptedException, IOException, AWTException
	{

		ER_Patient_VistDetails regiss = new ER_Patient_VistDetails(driver);
		regiss.Pasvisit();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_Patient_Past_VistDetails "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_Patient_Past_VistDetails "+ dateFormat.format(date)));
	     }
