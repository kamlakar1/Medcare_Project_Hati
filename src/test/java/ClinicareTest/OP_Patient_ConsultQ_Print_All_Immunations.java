...
import ClinicarePages.ConsultQ_Print_All_Immunations;
import ClinicarePages.ConsultQ_Print_All_Med_Orders;
import ClinicarePages.ConsultQ_Print_Orders;
...
public class OP_Patient_ConsultQ_Print_All_Immunations
{
	...
	@Test(priority=2)
	public void TC_02_OP_OP_Patient_ConsultQ_Print_All_Immunations() throws InterruptedException, IOException, AWTException
	{

		ConsultQ_Print_All_Immunations regiss = new ConsultQ_Print_All_Immunations(driver);
		regiss.frsss();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","OP_Patient_ConsultQ_Print_All_Immunations "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//OP_Patient_ConsultQ_Print_All_Immunations "+ dateFormat.format(date)));
	     }
