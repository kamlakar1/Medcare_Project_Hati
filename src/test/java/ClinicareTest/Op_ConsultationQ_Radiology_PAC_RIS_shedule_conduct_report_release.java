...
import ClinicarePages.RadiologyPagePACAnesthesiaa;
...
public class Op_ConsultationQ_Radiology_PAC_RIS_shedule_conduct_report_release
{
	...
	@Test(priority=2)
	public void TC_02_ER_ConsultationQ_Radiology_PAC_RIS_shedule_conduct_report_release() throws InterruptedException, IOException, AWTException
	{

		RadiologyPagePACAnesthesiaa regis = new RadiologyPagePACAnesthesiaa(driver);
		regis.frssrs();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_ConsultationQ_Radiology_PAC_RIS_shedule_conduct_report_release "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_ConsultationQ_Radiology_PAC_RIS_shedule_conduct_report_release "+ dateFormat.format(date)));
	     }
