...
import ClinicarePages.ER_Registration_Case_Type;
...
public class ER_Registration_Case_Tyep_Add_Details_Save
{
	...
	@Test(priority=2)
	public void TC_02_ER_Registration_Case_Tyep_Add_Details_Save() throws InterruptedException, IOException, AWTException
	{

		ER_Registration_Case_Type regiss = new ER_Registration_Case_Type(driver);
		regiss.ER_Registration_C();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_Registration_Case_Tyep_Add_Details_Save "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_Registration_Case_Tyep_Add_Details_Save "+ dateFormat.format(date)));
	     }
