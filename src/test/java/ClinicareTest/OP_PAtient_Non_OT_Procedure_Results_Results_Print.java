...
public class OP_PAtient_Non_OT_Procedure_Results_Results_Print
{
	...
	@Test(priority=2)
	public void TC_02_OP_PAtient_Non_OT_Procedure_Results_Results_Print() throws InterruptedException, IOException, AWTException
	{

		PAtient_Non_OT_Procedure_Print regiss = new PAtient_Non_OT_Procedure_Print(driver);
		regiss.frsss();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","OP_PAtient_Non_OT_Procedure_Results_Results_Print "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//OP_PAtient_Non_OT_Procedure_Results_Results_Print "+ dateFormat.format(date)));
	     }
