...
import ClinicarePages.ER_Patient_Add_Radiology_Order_Go;
...
public class ER_Patient_Add_Radiology_Order_Go_TO_Radiology_Accept_EMR_Result_Radiology_Report
{
	...
	@Test(priority=2)
	public void TC_02_ER_Patient_Add_Radiology_Order_Go_TO_Radiology_Accept_EMR_Result_Radiology_Report() throws InterruptedException, IOException, AWTException
	{

		ER_Patient_Add_Radiology_Order_Go regiss = new ER_Patient_Add_Radiology_Order_Go(driver);
		regiss.ffrs();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_Patient_Add_Radiology_Order_Go_TO_Radiology_Accept_EMR_Result_Radiology_Report "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_Patient_Add_Radiology_Order_Go_TO_Radiology_Accept_EMR_Result_Radiology_Report "+ dateFormat.format(date)));
	     }
