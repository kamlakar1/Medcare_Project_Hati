...
public class ERPatient_Add_Nursing_Note
{
	...
	@Test(priority=2)
	public void TC_02_ERPatient_Add_Nursing_Note() throws InterruptedException, IOException, AWTException
	{

		ERPatient_Nursing_Note regiss = new ERPatient_Nursing_Note(driver);
		regiss.ERPatient_Nursing_Notee();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","ERPatient_Add_Nursing_Note "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ERPatient_Add_Nursing_Note "+ dateFormat.format(date)));
	     }
