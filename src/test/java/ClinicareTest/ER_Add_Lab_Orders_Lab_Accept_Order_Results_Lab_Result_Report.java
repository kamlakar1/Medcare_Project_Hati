...
public class ER_Add_Lab_Orders_Lab_Accept_Order_Results_Lab_Result_Report
{
	...
	@Test(priority=2)
	public void TC_02_ER_Add_Lab_Orders_Lab_Accept_Order_Results_Lab_Result_Report() throws InterruptedException, IOException, AWTException
	{

		ER_Add_Lab_Orders_Lab_Accept_Order regiss = new ER_Add_Lab_Orders_Lab_Accept_Order(driver);
		regiss.jrrs();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_Add_Lab_Orders_Lab_Accept_Order_Results_Lab_Result_Report "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_Add_Lab_Orders_Lab_Accept_Order_Results_Lab_Result_Report "+ dateFormat.format(date)));
	     }
