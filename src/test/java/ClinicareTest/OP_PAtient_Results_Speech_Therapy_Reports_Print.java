...
public class OP_PAtient_Results_Speech_Therapy_Reports_Print
{
	...
	public void TC_02_OP_PAtient_Results_Speech_Therapy_Reports_Print() throws InterruptedException, IOException, AWTException
	{
		...
		OP_PAtie_Speech_Therapy_Reports_Print regiss = new OP_PAtie_Speech_Therapy_Reports_Print(driver);
		regiss.frsss();
