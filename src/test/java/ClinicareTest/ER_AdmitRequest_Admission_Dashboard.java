...
public class ER_AdmitRequest_Admission_Dashboard
{
	...
	@Test(priority=2)
	public void TC_02_ER_AdmitRequest_Admission_Dashboard() throws InterruptedException, IOException, AWTException
	{

		ER_AdmitRequest__Dashboard regiss = new ER_AdmitRequest__Dashboard(driver);
		regiss.khs();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_AdmitRequest_Admission_Dashboard "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_AdmitRequest_Admission_Dashboard "+ dateFormat.format(date)));
	     }
