...
public class ER_Registration_Primary_Survey
{
	...
	@Test(priority=2)
	public void TC_02_ER_Registration_Primary_Survey() throws InterruptedException, IOException, AWTException
	{

		ER_Registration_Primary_Surveyy regiss = new ER_Registration_Primary_Surveyy(driver);
		regiss.errs();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_Registration_Primary_Survey "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_Registration_Primary_Survey "+ dateFormat.format(date)));
	     }
