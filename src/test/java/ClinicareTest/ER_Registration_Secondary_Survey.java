...
import ClinicarePages.ER_Registration_Primary_Surveyy;
import ClinicarePages.ER_Registration_Secondary_Surveyy;
...
public class ER_Registration_Secondary_Survey
{
	...
	@Test(priority=2)
	public void TC_02_ER_Registration_Secondary_Survey() throws InterruptedException, IOException, AWTException
	{

		ER_Registration_Secondary_Surveyy regiss = new ER_Registration_Secondary_Surveyy(driver);
		regiss.errrs();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_Registration_Secondary_Survey "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_Registration_Secondary_Survey "+ dateFormat.format(date)));
	     }
