...
public class OP_Patient_ConsultQ_Print_All_Med_Orders
{
	...
	@Test(priority=2)
	public void TC_02_OP_Patient_ConsultQ_Print_All_Med_Orders() throws InterruptedException, IOException, AWTException
	{

		ConsultQ_Print_All_Med_Orders regiss = new ConsultQ_Print_All_Med_Orders(driver);
		regiss.frsss();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","OP_Patient_ConsultQ_Print_All_Med_Orders "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//OP_Patient_ConsultQ_Print_All_Med_Orders "+ dateFormat.format(date)));
	     }
