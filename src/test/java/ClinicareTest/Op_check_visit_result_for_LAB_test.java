...
public class Op_check_visit_result_for_LAB_test
{
	...
	@Test(priority=2)
	public void TC_02_LAB_Order_Pages() throws InterruptedException, IOException, AWTException
	{

		LAB_Order_Pages regis = new LAB_Order_Pages(driver);
		regis.jrs();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","LAB_Order_Pages "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//LAB_Order_Pages "+ dateFormat.format(date)));
	     }
