...
public class OP_FinalBill_Partial_Settlement_Self_Page {
	...
	//---OPBill---//
			...
			By BillingMenu=By.xpath("//span[contains(text(),'Billing')]");
				...
				//PartialAmountEnter
				By PartialAmountEnter=By.cssSelector("input[ng-reflect-name='amount']");
				...
				public OP_FinalBill_Partial_Settlement_Self_Page (WebDriver driver)
				{
					this.driver=driver;
						
				}

  public void OPFinalBillPartialSettle(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException 
  {
		...
		//Clicking on menu Icon
				...
				Thread.sleep(5000);
				   ...
				   System.out.println("Quick Registration page failed"); 
					...
					FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_FinalBill_Partial_Settlement_Self_Test_QuickRegisterationForm.png")); 
				...
				Thread.sleep(3000);
			      ...
			      FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_FinalBill_Partial_Settlement_Self_Test_QuickRegistrationSaved.png"));
				...
				//CreatedMRN
				  ...
				  Thread.sleep(5000);
				   ...
				   System.out.println("Encounter List Screen Not Appear"); 
					...
					FileUtils.copyFile(screenshot2, new File(".//ScreenShots//OP_FinalBill_Partial_Settlement_Self_Test_EncounterListScreen.png")); 
    ...
    FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_FinalBill_Partial_Settlement_Self_Test_OPChargesSave.png"));
    Thread.sleep(3000);
    ...
    Assert.assertEquals(Actual_1, Expected_1, "Patient Charges Saved and applied");
	  ...
	  //PartialAmount 
	  Thread.sleep(3000);
	  driver.findElement(PartialAmount).clear();
	  Thread.sleep(2000);
	  driver.findElement(PartialAmountEnter).sendKeys("10");
    ...
    FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OP_FinalBill_Partial_Settlement_Self_Test_OP FinalBill Generate As Outstanding.png"));
    Thread.sleep(3000);
		...
		driver.findElement(BillMRNSearch).click();
		  ...
		  Thread.sleep(5000);
		   ...
		   System.out.println("Billing Summary Screen Not Appear"); 
			...
			FileUtils.copyFile(screenshot5, new File(".//ScreenShots//OP_FinalBill_Partial_Settlement_Self_Test_BillingSummary.png")); 
