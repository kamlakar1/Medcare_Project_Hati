...
public class OPCharge_Charges_Verification_Self_Page {
...
//---ChargeVerification---//
		...
		//ChargeVerificationIcon
		By ChargeVerificationIcon=By.cssSelector("a[ng-reflect-router-link='bill,charge-verification']");
		
		//VerificationAdvance
		By VerificationAdvance=By.cssSelector("mat-icon[ng-reflect-message='Collapse']");
		
		//MRNInput 
		By MRNInput=By.cssSelector("input[ng-reflect-placeholder='Patient MRN']");
		
		//SearchButton
		By SearchButton=By.cssSelector("button[ng-reflect-message='Search']");
		
		//Radio
		By Radio=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-charge-verification/app-patient-search/div/div/div/table/tbody/tr[2]/td[1]/div/mat-radio-button/label/span[1]/span[1]");
		

	
	public OPCharge_Charges_Verification_Self_Page (WebDriver driver)
  ...
  public void OPCharge_ChargeVerification_Self (String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par) throws InterruptedException, IOException 
  {
	...
	//Clicking on menu Icon
			...
			FileUtils.copyFile(screenshot, new File(".//ScreenShots//OPCharge_Charges_Verification_Self_Test_QuickRegisterationForm.png")); 
			...
			Thread.sleep(3000);
		      ...
		      FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OPCharge_Charges_Verification_Self_Test_QuickRegistrationSaved.png"));
			...
			//CreatedMRN
			  ...
			  Thread.sleep(5000);
			   ...
			   System.out.println("Encounter List Screen Not Appear"); 
				...
				FileUtils.copyFile(screenshot2, new File(".//ScreenShots//OPCharge_Charges_Verification_Self_Test_EncounterListScreen.png")); 
	...
	//SideMenuBar
	  ...
	  Thread.sleep(5000);
	   ...
	   System.out.println("OP Charge Screen Not Appear"); 
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OPCharge_Charges_Verification_Self_Test_OPChargeScreen.png")); 
	...
	//ServiceSelect
      ...
      FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OPCharge_Charges_Verification_Self_Test_ChargesSave.png"));
      Thread.sleep(3000);
   ...
   //---ChargeVerification---//
    ...
    //ChargeVerificationIcon
	  Thread.sleep(2000);
	  driver.findElement(ChargeVerificationIcon).click();
      
	//VerificationAdvance
	  Thread.sleep(2000);
	  driver.findElement(VerificationAdvance).click();
