...
public class NewAdmissionWithVIPPatient_OldIC_Test 
{
	...
	public void TC_02_User_Able_To_Do_Admission_With_VIP_OldIC(String PriNumberPar, String PatientNamePar,String MobilePar,String EmailPar,String LengthPar,String RegAddressPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException
	{
		ADTpages.NewAdmissionWithVIPPatient_OldIC VIPAdmissionOldIC=new ADTpages.NewAdmissionWithVIPPatient_OldIC(driver);
		VIPAdmissionOldIC.AdmissionWithVIPPatientOldIC (PriNumberPar, PatientNamePar, MobilePar, EmailPar, LengthPar, RegAddressPar, NamePar, IdentificationNOPar, PhoneNumberPar, AddressPar, ZipCodePar);
	}
	@BeforeTest
