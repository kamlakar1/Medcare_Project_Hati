...
public class ADT_Admission_Request_For_Registered_With_Passort 
{
	...
	public void TC_02_Verify_That_User_Is_Able_To_Do_Quick_Registration_With_Primary_ID_NEW_IC(String QuickPrimaryIdNumberPar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException
	{
		...
		QuickReg.Quick_Registration_Verification_With_passport_IC(QuickPrimaryIdNumberPar,QuickFullNamePar,QuickDateOfBirthPar,QuickMobileNumberPar,QuickEncounterRemarksPar,QuickAddNotesPar,QuickEncounterNotesPar,QuickPatientNotesPar,QuickReferralRemarksPar);	
	}
	...
	public void TC_03_User_Able_To_Do_AdmissionRequestform(String MRNPar,String EmailPar,String DOAPar,String LengthPar,String NotesPar,String RemarksPar) throws InterruptedException, IOException
	{
		...
		ADT.ADT_Request_Registered_With_passport_IC(MRNPar,EmailPar,DOAPar,LengthPar,NotesPar,RemarksPar);
	}
	@Test(priority=3)
	...
	{
		recorder = new ATUTestRecorder(".//Videos//","ADT_Admission_Request_For_Registered_With_Passort-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_Admission_Request_For_Registered_With_Passort"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
