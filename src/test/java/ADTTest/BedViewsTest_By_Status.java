...
public class BedViewsTest_By_Status 
{
	...
	{
		ADTpages.ADTBedViewsBY_Status ADTBedView=new ADTpages.ADTBedViewsBY_Status(driver);
		ADTBedView.ADT_Bed_View_By_Status();
	...
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","BedViewsTest_By_Status-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_BedViewsTest_By_Status"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
