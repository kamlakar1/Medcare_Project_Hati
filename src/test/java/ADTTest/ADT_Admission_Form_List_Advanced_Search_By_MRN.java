...
public class ADT_Admission_Form_List_Advanced_Search_By_MRN 
{
	...
	{
		ADTpages.ADTAdmissionForm_List_Advanced_Search_By_MRN  adtsearch=new ADTpages.ADTAdmissionForm_List_Advanced_Search_By_MRN (driver);
		adtsearch.ADTAdmissionFormListAdvancedSearch_By_MRN(MRNPar);
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADT_Admission_Form_List_Advanced_Search_By_MRN-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_Admission_Form_List_Advanced_Search_By_MRN"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
