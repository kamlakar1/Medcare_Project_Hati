...
public class ER_Registration_Location_Add_Vitals_Save_Test
{
	...
	{
		ClinicarePage2.ER_Registration_Location_Add_Vitals_Save regis = new ClinicarePage2.ER_Registration_Location_Add_Vitals_Save(driver);
		regis.AddVitals_Save(PatientMRN);
	}
	 @BeforeTest	 
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_Registration_Location_Add_Vitals_Save_Test "+dateFormat.format(date),false);			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_Registration_Location_Add_Vitals_Save_Test"+ dateFormat.format(date)));
	     }	 
	 }	 
	 @AfterSuite
