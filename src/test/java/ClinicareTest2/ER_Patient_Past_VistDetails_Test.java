...
public class ER_Patient_Past_VistDetails_Test
{
	...
	{
		ClinicarePage2.ER_Patient_Past_VistDetails regis = new ClinicarePage2.ER_Patient_Past_VistDetails(driver);
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","ER_Patient_Past_VistDetails_Test "+dateFormat.format(date),false);			recorder.start();	  
	 }	     
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//ER_Patient_Past_VistDetails_Test"+ dateFormat.format(date)));
	     }	 
	 }	 
	 @AfterSuite
