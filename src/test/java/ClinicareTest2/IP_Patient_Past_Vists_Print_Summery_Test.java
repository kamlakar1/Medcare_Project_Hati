...
public class IP_Patient_Past_Vists_Print_Summery_Test
{
	...
	{
		ClinicarePage2.IP_Patient_Past_Vists_Print_Summery regis = new ClinicarePage2.IP_Patient_Past_Vists_Print_Summery(driver);
		regis.Past_Vists_Print_Summery(PatientMRN);
	}
	 @BeforeTest	 
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","IP_Patient_Past_Vists_Print_Summery_Test "+dateFormat.format(date),false);			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//IP_Patient_Past_Vists_Print_Summery_Test"+ dateFormat.format(date)));
	     }	 
	 }	 
	 @AfterSuite
