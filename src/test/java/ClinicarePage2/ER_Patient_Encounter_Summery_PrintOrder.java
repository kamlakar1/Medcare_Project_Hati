...
public class ER_Patient_Encounter_Summery_PrintOrder  {
	...
	By PrintOrder=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/div/div[1]/span/app-patient-banner/div/div[4]/div/table/tbody/tr[1]/td/div/span[3]/button");
	public ER_Patient_Encounter_Summery_PrintOrder (WebDriver driver)

	{
		this.driver=driver;

	}
	public void Encounter_Summery_PrintOrder(String PatientMRN) throws InterruptedException, IOException, AWTException 
