...
public class OPPatient_SearchInClinicare_OPConsult_AdmitOrder_Save_LoginMedcare_ADTDashboard 
{
	...
	//Save Button
		...
		By Admit_Assessment = By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/div/div[1]/div/p-tabmenu/div/div/div/ul/li[2]/a");
		...
		public OPPatient_SearchInClinicare_OPConsult_AdmitOrder_Save_LoginMedcare_ADTDashboard (WebDriver driver)
	{
		this.driver=driver;
	}
	public void AdmitOrder(String PatientMRN) throws InterruptedException, IOException, AWTException 
	{
		...
		//TabSwitch
			...
			//........Clinicare DR Fill In PAtient........//	
				...
				//Admit Assisment
				Thread.sleep(10000);
				driver.findElement(Admit_Assessment).click();
