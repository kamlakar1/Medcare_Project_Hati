...
public class IP_PAtient_ResultsAndReports_Occupational_Therapy_Reports_Print 
{
	...
	// Locators (Encounter Summary)
		...
		By OccupationalTherapyReport=By.xpath("//app-view-result/div/div[1]/p-tabview/div/div[1]/div/ul/li[7]/a");
		By ConductQ=By.xpath("/html/body/app-root/app-main/div/div[1]/div/app-menu/ul/li[1]/ul/li[7]/a/img");
		By Print=By.xpath("//app-results/div/div/div/dev/p-table/div/div/table/tbody/tr/td[4]/button");
		
		public IP_PAtient_ResultsAndReports_Occupational_Therapy_Reports_Print (WebDriver driver)
		{
			this.driver=driver;
		}
	public void IP_Patient_OccupationalTherapyReport(String PatientMRN) throws InterruptedException, IOException, AWTException 
	{		
				...
				Thread.sleep(5000);
				driver.findElement(OccupationalTherapyReport).click();
