...
public class IP_Patient_NonOT_Procudure_Conduct_Notes_Mark_Conducted_PastVistis_Print_Summery 
{
	...
	By PatientName=By.cssSelector("input[id='patientname']");
		...
		By PrintSummery=By.xpath("//p-panel/div/div[2]/div/div/div[2]/div/p-table/div/div/table/tbody/tr/td[7]/button");
		...
		public IP_Patient_NonOT_Procudure_Conduct_Notes_Mark_Conducted_PastVistis_Print_Summery (WebDriver driver)
	{
		this.driver=driver;
	}
	public void No_OT_procedure_PrintSummery(String PatientMRN) throws InterruptedException, IOException, AWTException 
	{
				...
				Thread.sleep(3000);
				driver.findElement(ViewPAtient).click();
														
				Thread.sleep(5000);
				driver.findElement(PastVisist).click();
