...
public class IP_Patient_NonOT_Procudure_Conduct_Notes_Mark_Conducted_PastVistis 
{
	...
	By PatientName=By.cssSelector("input[id='patientname']");
		...
		public IP_Patient_NonOT_Procudure_Conduct_Notes_Mark_Conducted_PastVistis (WebDriver driver)
	{
		this.driver=driver;
	}
	public void No_OT_procedure(String PatientMRN) throws InterruptedException, IOException, AWTException 
	{
