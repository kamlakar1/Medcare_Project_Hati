...
public class IP_Patient_Add_Vitals_details_Save 
{
	...
	By PatientName=By.cssSelector("input[id='patientname']");
		...
		By Vitals=By.id("IPVT");
		By AddNewVitals=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/div/div[2]/div/app-vital-case-sheet/div/div/div/app-view-vitals/div/div/p-panel/div/div[1]/div[2]/div/div[5]/button");
		...
		public IP_Patient_Add_Vitals_details_Save (WebDriver driver)
	{
		this.driver=driver;
	}
	public void Vitals_details(String PatientMRN) throws InterruptedException, IOException, AWTException 
	{
