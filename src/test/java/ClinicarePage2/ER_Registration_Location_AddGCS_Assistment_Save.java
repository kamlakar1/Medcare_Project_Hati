...
public class ER_Registration_Location_AddGCS_Assistment_Save 
{
	...
	By Location=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-er-q/div/div/div/p-table/div/div/table/tbody/tr/td[2]/div[2]/span/b/small/span");
	By OpenEyes=By.name("eyeList");
	By VerbalResponse=By.name("verbalList");
	By Save=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-er-q/div/div/div/p-dialog[4]/div/div/div[3]/app-gsc-assesment/p-tabview/div/div[2]/p-tabpanel[1]/div/div/div[1]/div[2]/div/div[2]/app-lt-post-button/button");
	By PulsMin=By.id("pulseVal");
	By respRateVal=By.id("respRateVal");
	By BloodPresure=By.id("sbpVal");
	By SaveExit=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-er-q/div/div/div/p-dialog[4]/div/div/div[3]/app-gsc-assesment/p-tabview/div/div[2]/p-tabpanel[1]/div/div/div[1]/div[2]/div/div[2]/app-lt-post-button/button");
	By Close=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-er-q/div/div/div/p-dialog[4]/div/div/div[2]/div/button[2]");	
	
	public ER_Registration_Location_AddGCS_Assistment_Save (WebDriver driver)

	{
		this.driver=driver;

	}
	public void GCS_Assistment_Save(String PatientMRN) throws InterruptedException, IOException, AWTException 

	{
		...
		Robot robot = new Robot(); for (int i = 0; i < 5; i++) {
			...
			Thread.sleep(3000);
			driver.findElement(OpenEyes).click();
			
			Thread.sleep(3000);
			driver.findElement(VerbalResponse).click();
