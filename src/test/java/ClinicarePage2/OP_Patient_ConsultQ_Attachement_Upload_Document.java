...
public class OP_Patient_ConsultQ_Attachement_Upload_Document 
{
	...
	By SearchPatient=By.cssSelector("button[id='Search']");
		...
		By Attachment=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/div/div[1]/span/app-op-banner/div/div/div/div/div[4]/div/div[1]/span[5]/button");
		By Category=By.xpath("//p-tabpanel[1]/div/form/div/div[2]/div[1]/p-dropdown");
		By CategorySelOpt=By.xpath("/html/body/div[5]/div/div/div/ul/p-dropdownitem[1]/li");
		By Title=By.cssSelector("input[formcontrolname='title']");
		By ChooseFile=By.xpath("//p-tabpanel[1]/div/form/div/div[2]/div[4]/input");
		
		By UploadFile=By.xpath("//p-tabpanel[1]/div/form/div/div[2]/div[5]/div[1]/app-lt-post-button/button");
		By Close=By.xpath("/html/body/div[4]/div/div[2]/div/button");
		public OP_Patient_ConsultQ_Attachement_Upload_Document (WebDriver driver)
	{
		this.driver=driver;
	}
	public void OPConsult_UploadDocument(String PatientMRN) throws InterruptedException, IOException, AWTException 
	{
				...
				Thread.sleep(5000);
				driver.findElement(CategorySelOpt).click();
				
				Thread.sleep(5000);
				driver.findElement(Title).sendKeys("Test Document");
