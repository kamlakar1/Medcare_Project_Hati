...
public class ER_Registration_Location_Add_Vitals_Save  {
	...
	By Location=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-er-q/div/div/div/p-table/div/div/table/tbody/tr/td[2]/div[1]/span/b/small/span");
	...
	public ER_Registration_Location_Add_Vitals_Save (WebDriver driver)
	...
	public void AddVitals_Save(String PatientMRN) throws InterruptedException, IOException, AWTException 

	{
		...
		Robot robot = new Robot(); for (int i = 0; i < 5; i++) {
			...
			Thread.sleep(3000);
			driver.findElement(Temprature).sendKeys("30");
			
			Thread.sleep(3000);
			driver.findElement(TempUnit).click();
			
			Thread.sleep(3000);
			driver.findElement(TempUnitSelOPt).click();
			
			Thread.sleep(3000);
			driver.findElement(PulsMin).sendKeys("20");
			
			Thread.sleep(3000);
			driver.findElement(respRateVal).sendKeys("20");
			
			Thread.sleep(3000);
			driver.findElement(BloodPresure).sendKeys("180");
