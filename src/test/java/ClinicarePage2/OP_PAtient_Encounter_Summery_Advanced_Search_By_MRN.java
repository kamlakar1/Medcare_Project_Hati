...
public class OP_PAtient_Encounter_Summery_Advanced_Search_By_MRN 
{
	...
	By SearchPatient=By.cssSelector("button[id='Search']");
		...
		public OP_PAtient_Encounter_Summery_Advanced_Search_By_MRN (WebDriver driver)
	{
		this.driver=driver;
	}
	public void OPConsult_Advanced_Search(String PatientMRN) throws InterruptedException, IOException, AWTException 
	{
