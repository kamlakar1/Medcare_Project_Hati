...
public class IP_Re_Assisment_Add_History_Diagnosis_Examination_Order_Re_Assisment_Notes 
{
	...
	By ContinueBillyes=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/p-confirmdialog/div/div/div[3]/button[2]");
		...
		By checkbox98 = By.xpath("//p-table/div/div/table/tbody/tr[1]/td[2]/p-tablecheckbox/div/div[2]");
		...
		By ReAssesment=By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/div/div[1]/span/app-patient-banner/div/div[4]/div/table/tbody/tr[1]/td/div/span[2]/button");
		public IP_Re_Assisment_Add_History_Diagnosis_Examination_Order_Re_Assisment_Notes (WebDriver driver)
	{
		this.driver=driver;
	}
	public void Re_Assisment_Notes(String PatientMRN) throws InterruptedException, IOException, AWTException 
	{
				Thread.sleep(8000);
			//........Clinicare DR Fill In PAtient........//				
				...
				Thread.sleep(5000);
				driver.findElement(ReAssisment).click();
				...
				Thread.sleep(3000);				
				driver.findElement(ReAssesment).click();				
	}
}
