...
public class IP_Patient_Encounter_Summery_Advanced_Search_By_MRN 
{
	...
	By PatientName=By.cssSelector("input[id='patientname']");
		...
		public IP_Patient_Encounter_Summery_Advanced_Search_By_MRN (WebDriver driver)
	{
		this.driver=driver;
	}
	public void Advanced_Search(String PatientMRN) throws InterruptedException, IOException, AWTException 
	{
