...
public class Result_Entry_select_order_Click_result_entry_Enter_result_upload_document_save_submit
{
...
/*
	...
	*/
	@Test(priority=2)
	public void TC_04_Result_Entry_select_order_Click_result_entry_Enter_result_upload_document_save_submit() throws InterruptedException, IOException, AWTException
	{

		enter_media_observation_identificationsave2 registrationj=new enter_media_observation_identificationsave2(driver);
		registrationj.UploadDocument_resultentry();	  
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Result_Entry_select_order_Click_result_entry_Enter_result_upload_document_save_submit"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Result_Entry_select_order_Click_result_entry_Enter_result_upload_document_save_submit"+ dateFormat.format(date)));
	     }
