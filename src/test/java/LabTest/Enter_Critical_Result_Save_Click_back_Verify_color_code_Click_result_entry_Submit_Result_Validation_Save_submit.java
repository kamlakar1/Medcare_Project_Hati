...
public class Enter_Critical_Result_Save_Click_back_Verify_color_code_Click_result_entry_Submit_Result_Validation_Save_submit
{
...
/*
	...
	*/
	...
	@Test(priority=2)
	public void TC_04_Enter_Normal_Result_Save_Click_backVerify_color_code_Click_result_entry_Submit_Result_Validation_Save_Submit() throws InterruptedException, IOException, AWTException
	{

		enter_media_observation_identificationsave2 registrationj=new enter_media_observation_identificationsave2(driver);
		registrationj.Enter_Critical_Result();	  
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Enter_Critical_Result_Save_Click_back_Verify_color_code_Click_result_entry_Submit_Result_Validation_Save_submit"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Enter_Critical_Result_Save_Click_back_Verify_color_code_Click_result_entry_Submit_Result_Validation_Save_submit"+ dateFormat.format(date)));
	     }
