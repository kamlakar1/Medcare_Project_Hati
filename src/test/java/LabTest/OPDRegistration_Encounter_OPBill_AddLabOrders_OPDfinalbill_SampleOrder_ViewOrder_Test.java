...
import LabPages.OPDRegistration_Encounter_OPBill_AddLabOrders_OPDfinalbill_SampleOrder_ViewOrder;
import LabPages.Phlebotomy_Printand_submit_Pending_Dispatched_Reprint;
import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
public class OPDRegistration_Encounter_OPBill_AddLabOrders_OPDfinalbill_SampleOrder_ViewOrder_Test 
{
	...
	public void TC_01_Verify_Login(String Uesrid) throws InterruptedException, IOException 
	{
	 ...
	 @Test(priority=3)
	 public void TC_03_Verify_That_User_Can_Verify_That_Charge_Verification_For_OP_BILL() throws InterruptedException, IOException
	 {
		 OPDRegistration_Encounter_OPBill_AddLabOrders_OPDfinalbill_SampleOrder_ViewOrder charge=new OPDRegistration_Encounter_OPBill_AddLabOrders_OPDfinalbill_SampleOrder_ViewOrder(driver);
		 charge.OPD_OP_FinalBill_LabFlow();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		//WebDriverManager.chromedriver().setup();
				recorder = new ATUTestRecorder(".//Videos//","OPDRegistration_Encounter_OPBill_AddLabOrders_OPDfinalbill_SampleOrder_ViewOrder_Test-"+dateFormat.format(date),false);
				recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OPDRegistration_Encounter_OPBill_AddLabOrders_OPDfinalbill_SampleOrder_ViewOrder_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
