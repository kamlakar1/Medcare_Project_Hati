...
public class Result_approval_Select_order_Click_upload_document_Verify_previous_document_Upload_new_document_Submit
{
	...
	*/
	...
	@Test(priority=2)
	public void TC_04_Result_approval_Select_order_Click_upload_document_Verify_previous_document_Upload_new_document_Submit() throws InterruptedException, IOException, AWTException
	{

		enter_media_observation_identificationsave registrationj=new enter_media_observation_identificationsave(driver);
		registrationj.Upload_Document_to_Approval();	  
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Result_approval_Select_order_Click_upload_document_Verify_previous_document_Upload_new_document_Submit"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Result_approval_Select_order_Click_upload_document_Verify_previous_document_Upload_new_document_Submit"+ dateFormat.format(date)));
	     }
