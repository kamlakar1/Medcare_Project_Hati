...
import LabPages.enter_media_observation_identificationsave3;
...
public class Growth_Completed_Save_Result_Entry_enter_media_observation_identification_Save_Submit
{
	...
	*/
	@Test(priority=2)
	public void TC_04_Growth_Completed_Save_Result_Entry_enter_media_observation_identification_Save() throws InterruptedException, IOException, AWTException
	{

		enter_media_observation_identificationsave3 registrationj=new enter_media_observation_identificationsave3(driver);
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Growth_Completed_Save_Result_Entry_enter_media_observation_identification_Save_Submit "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Growth_Completed_Save_Result_Entry_enter_media_observation_identification_Save_Submit "+ dateFormat.format(date)));
	     }
