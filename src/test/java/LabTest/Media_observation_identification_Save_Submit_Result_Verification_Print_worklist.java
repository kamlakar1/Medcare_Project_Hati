...
import LabPages.Save_Submit_Result_Verification_Print_worklist;
...
public class Media_observation_identification_Save_Submit_Result_Verification_Print_worklist
{
...
*/
	@Test(priority=2)
	public void TC_04_Media_observation_identification_Save_Submit_Result_Verification_Print_worklist() throws InterruptedException, IOException, AWTException
	{

		Save_Submit_Result_Verification_Print_worklist registrationj=new Save_Submit_Result_Verification_Print_worklist(driver);
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Media_observation_identification_Save_Submit_Result_Verification_Print_worklist"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Media_observation_identification_Save_Submit_Result_Verification_Print_worklist"+ dateFormat.format(date)));
	     }
