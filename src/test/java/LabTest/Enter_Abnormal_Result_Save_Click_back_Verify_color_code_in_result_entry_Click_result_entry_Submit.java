...
public class Enter_Abnormal_Result_Save_Click_back_Verify_color_code_in_result_entry_Click_result_entry_Submit
{
	...
	*/
	@Test(priority=2)
	public void TC_04_Enter_Abnormal_Result_Save_Click_back_Verify_color_code_in_result_entry_Click_result_entry_Submit() throws InterruptedException, IOException, AWTException
	{
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Enter_Abnormal_Result_Save_Click_back_Verify_color_code_in_result_entry_Click_result_entry_Submit"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Enter_Abnormal_Result_Save_Click_back_Verify_color_code_in_result_entry_Click_result_entry_Submit"+ dateFormat.format(date)));
	     }
