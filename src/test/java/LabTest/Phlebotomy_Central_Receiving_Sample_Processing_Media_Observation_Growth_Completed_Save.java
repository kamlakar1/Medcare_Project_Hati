...
public class Phlebotomy_Central_Receiving_Sample_Processing_Media_Observation_Growth_Completed_Save 
{
...
public void TC_01_verify_That_User_Is_Able_To_Login_MedcareApplication(String Uesrid) throws InterruptedException, IOException
{
 ...
 @Test
 public void TC_04_Phlebotomy_Central_Receiving_Sample_Processing_Media_Observation_Growth_Completed_Save() throws InterruptedException, IOException, AWTException 
  {
	LabPages.Phlebotomy_Central_Receiving_Sample_Processing_Media_Observation_Growth_Completed_Save vv=new LabPages.Phlebotomy_Central_Receiving_Sample_Processing_Media_Observation_Growth_Completed_Save(driver);
	  vv.OPD_REGISTRATION();	  
}
 ...
 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
 {
	   ...
	   WebDriverManager.chromedriver().setup();
		...
		recorder = new ATUTestRecorder(".//Videos//","Phlebotomy_Central_Receiving_Sample_Processing_Media_Observation_Growth_Completed_Save"+dateFormat.format(date),false);
		recorder.start();
 ...
 public void FailedScreenShot(ITestResult Result) throws IOException
 {
     if(ITestResult.FAILURE==Result.getStatus())
     {
         ...
         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Phlebotomy_Central_Receiving_Sample_Processing_Media_Observation_Growth_Completed_Save"+ dateFormat.format(date)));
     }
