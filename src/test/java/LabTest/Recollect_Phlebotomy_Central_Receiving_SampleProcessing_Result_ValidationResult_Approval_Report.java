...
public class Recollect_Phlebotomy_Central_Receiving_SampleProcessing_Result_ValidationResult_Approval_Report
{
...
/*
	...
	*/
	...
	@Test(priority=2)
	public void TC_04_Recollect_Phlebotomy_Central_Receiving_SampleProcessing_Result_ValidationResult_Approval_Report() throws InterruptedException, IOException, AWTException
	{
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Recollect_Phlebotomy_Central_Receiving_SampleProcessing_Result_ValidationResult_Approval_Report"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Recollect_Phlebotomy_Central_Receiving_SampleProcessing_Result_ValidationResult_Approval_Report"+ dateFormat.format(date)));
	     }
