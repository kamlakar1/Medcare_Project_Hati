...
public class Enter_Critical_Result_Click_result_entry_Submit_Result_Validation_Modify_Save_Submit
{
...
*/	
	@Test(priority=4)
	public void TC_04_Enter_Critical_Result_Click_result_entry_Submit_Result_Validation_Modify_Save_Submit() throws InterruptedException, IOException, AWTException
	{
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Enter_Critical_Result_Click_result_entry_Submit_Result_Validation_Modify_Save_Submit"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Enter_Critical_Result_Click_result_entry_Submit_Result_Validation_Modify_Save_Submit"+ dateFormat.format(date)));
	     }
