...
public void TC_01_verify_That_User_Is_Able_To_Login_MedcareApplication(String Uesrid) throws InterruptedException, IOException
{
 ...
 @Test
  ...
  public void TC_02Media_Observation_Growth_Completed_Save_Result_Entry_Hold() throws InterruptedException, IOException, AWTException 
  {
 ...
 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
 {
	   ...
	   WebDriverManager.chromedriver().setup();
		...
		recorder = new ATUTestRecorder(".//Videos//","Media_Observation_Growth_Completed_Save_Result_Entry_Hold"+dateFormat.format(date),false);
		recorder.start();
 ...
 public void FailedScreenShot(ITestResult Result) throws IOException
 {
     if(ITestResult.FAILURE==Result.getStatus())
     {
         ...
         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Media_Observation_Growth_Completed_Save_Result_Entry_Hold"+ dateFormat.format(date)));
     }
