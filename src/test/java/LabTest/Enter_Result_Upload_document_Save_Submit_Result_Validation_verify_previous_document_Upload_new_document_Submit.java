...
public class Enter_Result_Upload_document_Save_Submit_Result_Validation_verify_previous_document_Upload_new_document_Submit
{
...
/*
	...
	*/
	@Test(priority=4)
	public void TC_04_Enter_Result_Upload_document_Save_Submit_Result_Validation_verify_previous_document_Upload_new_document_Submit() throws InterruptedException, IOException, AWTException
	{

		enter_media_observation_identificationsave registrationj=new enter_media_observation_identificationsave(driver);
		registrationj.ResultEntryDocumentUploadVerifynewupload();	  
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Enter_Result_Upload_document_Save_Submit_Result_Validation_verify_previous_document_Upload_new_document_Submit "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Enter_Result_Upload_document_Save_Submit_Result_Validation_verify_previous_document_Upload_new_document_Submit "+ dateFormat.format(date)));
	     }
