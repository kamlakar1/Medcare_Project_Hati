...
public class Click_print_and_submit_Result_Entry_View_orders
{
	...
	*/
	@Test(priority=4)
	public void TC_04_Click_print_and_submit_Result_Entry_View_orders() throws InterruptedException, IOException, AWTException
	{

		enter_media_observation_identificationsave regis = new enter_media_observation_identificationsave(driver);
		regis.Result_Entry_View_orders();
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Click_print_and_submit_Result_Entry_View_orders "+dateFormat.format(date),false);
			recorder.start();
