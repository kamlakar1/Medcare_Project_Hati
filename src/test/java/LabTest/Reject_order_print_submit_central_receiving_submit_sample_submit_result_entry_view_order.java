...
public class Reject_order_print_submit_central_receiving_submit_sample_submit_result_entry_view_order
{
	...
	*/
	@Test(priority=2)
	public void TC_04_Reject_order_print_submit_central_receiving_submit_sample_submit_result_entry_view_order() throws InterruptedException, IOException, AWTException
	{
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Reject_order_print_submit_central_receiving_submit_sample_submit_result_entry_view_order"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Reject_order_print_submit_central_receiving_submit_sample_submit_result_entry_view_order"+ dateFormat.format(date)));
	     }
