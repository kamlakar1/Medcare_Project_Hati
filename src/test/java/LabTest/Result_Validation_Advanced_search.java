...
public class Result_Validation_Advanced_search
{
...
/*
	...
	*/
	...
	@Test(priority=2)
	public void TC_04_Result_Validation_Advanced_search() throws InterruptedException, IOException, AWTException
	{

		enter_media_observation_identificationsave2 registrationj=new enter_media_observation_identificationsave2(driver);
		registrationj.Resultvalidation();	  
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Result_Validation_Advanced_search"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Result_Validation_Advanced_search"+ dateFormat.format(date)));
	     }
