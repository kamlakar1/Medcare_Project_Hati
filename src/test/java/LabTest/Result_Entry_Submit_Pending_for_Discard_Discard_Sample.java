...
public class Result_Entry_Submit_Pending_for_Discard_Discard_Sample
{
	...
	*/
	@Test(priority=2)
	public void TC_04_Result_Entry_Submit_Pending_for_Discard_Discard_Sample() throws InterruptedException, IOException, AWTException
	{

		enter_media_observation_identificationsave registrationj=new enter_media_observation_identificationsave(driver);
		registrationj.Pending_for_Discard_Discard_Sample();	  
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Result_Entry_Submit_Pending_for_Discard_Discard_Sample"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Result_Entry_Submit_Pending_for_Discard_Discard_Sample"+ dateFormat.format(date)));
	     }
