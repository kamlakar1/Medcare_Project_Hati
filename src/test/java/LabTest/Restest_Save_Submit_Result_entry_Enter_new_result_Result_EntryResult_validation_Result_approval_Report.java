...
public class Restest_Save_Submit_Result_entry_Enter_new_result_Result_EntryResult_validation_Result_approval_Report
{
	...
	*/
	@Test(priority=2)
	public void TC_04Restest_Save_Submit_Result_entry_Enter_new_result_Result_EntryResult_validation_Result_approval_Report() throws InterruptedException, IOException, AWTException
	{
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Restest_Save_Submit_Result_entry_Enter_new_result_Result_EntryResult_validation_Result_approval_Report"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Restest_Save_Submit_Result_entry_Enter_new_result_Result_EntryResult_validation_Result_approval_Report"+ dateFormat.format(date)));
	     }
