...
public class Pending_Allocation_Storage_Stock_Inhouse_Transfer_Pending_Received_Received_List
{
	...
	*/
	@Test(priority=4)
	public void TC_04_Pending_Allocation_Storage_Stock_Inhouse_Transfer_Pending_Received_Received_List() throws InterruptedException, IOException, AWTException
	{
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Pending_Allocation_Storage_Stock_Inhouse_Transfer_Pending_Received_Received_List"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Pending_Allocation_Storage_Stock_Inhouse_Transfer_Pending_Received_Received_List"+ dateFormat.format(date)));
	     }
