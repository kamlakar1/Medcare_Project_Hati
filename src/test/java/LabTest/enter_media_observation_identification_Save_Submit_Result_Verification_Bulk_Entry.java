...
public class enter_media_observation_identification_Save_Submit_Result_Verification_Bulk_Entry
{
	...
	*/
	...
	@Test(priority=2)
	public void TC_04_enter_media_observation_identification_Save_Submit_Result_Verification_Bulk_Entry() throws InterruptedException, IOException, AWTException
	{

		Result_Verification_Bulk_Entry registrationj=new Result_Verification_Bulk_Entry(driver);
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","enter_media_observation_identification_Save_Submit_Result_Verification_Bulk_Entry"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//enter_media_observation_identification_Save_Submit_Result_Verification_Bulk_Entry"+ dateFormat.format(date)));
	     }
