...
public class Recollect_Central_Receiving_Sample_Processing_Result_entry_Result_Validation_Result_Approval_Reports
{
	...
	*/
	...
	@Test(priority=2)
	public void TC_04_Recollect_Central_Receiving_Sample_Processing_Result_entry_Result_Validation_Result_Approval_Reports() throws InterruptedException, IOException, AWTException
	{
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Recollect_Central_Receiving_Sample_Processing_Result_entry_Result_Validation_Result_Approval_Reports"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Recollect_Central_Receiving_Sample_Processing_Result_entry_Result_Validation_Result_Approval_Reports"+ dateFormat.format(date)));
	     }
