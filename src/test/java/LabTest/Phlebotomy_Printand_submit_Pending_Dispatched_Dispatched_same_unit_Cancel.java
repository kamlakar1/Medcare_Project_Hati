...
*/
 @Test
  public void TC_04_Verify_That_User_Is_Able_Fill_The_Basic_Information_To_Registration_Page() throws InterruptedException, IOException, AWTException 
  {
	 LabPages.Phlebotomy_Printand_submit_Pending_Dispatched_Dispatched_same_unit_Cancel registration=new LabPages.Phlebotomy_Printand_submit_Pending_Dispatched_Dispatched_same_unit_Cancel(driver);
...
@BeforeTest
 ...
 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
 {
	   ...
	   WebDriverManager.chromedriver().setup();
		...
		recorder = new ATUTestRecorder(".//Videos//","Phlebotomy_Printand_submit_Pending_Dispatched_Dispatched_same_unit_Cancel"+dateFormat.format(date),false);
		recorder.start();
 ...
 public void FailedScreenShot(ITestResult Result) throws IOException
 {
     if(ITestResult.FAILURE==Result.getStatus())
     {
         ...
         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Phlebotomy_Printand_submit_Pending_Dispatched_Dispatched_same_unit_Cancel"+ dateFormat.format(date)));
     }
