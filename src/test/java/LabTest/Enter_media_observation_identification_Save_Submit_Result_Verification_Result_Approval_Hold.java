...
public class Enter_media_observation_identification_Save_Submit_Result_Verification_Result_Approval_Hold
{
	...
	public void TC_02_Create_prerequisit_with_patiantcreat_and_finallbill() throws InterruptedException, IOException, AWTException
	{
		...
		registrationj.ResultApporvalHold();	  
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Enter_media_observation_identification_Save_Submit_Result_Verification_Result_Approval_Hold "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Enter_media_observation_identification_Save_Submit_Result_Verification_Result_Approval_Hold "+ dateFormat.format(date)));
	     }
