...
public class Enter_Normal_Result_Save_Click_backVerify_color_code_Click_result_entry_Submit_Result_Validation_Save_Submit
{
...
/*
	...
	*/
	...
	public void TC_04_Enter_Normal_Result_Save_Click_backVerify_color_code_Click_result_entry_Submit_Result_Validation_Save_Submit() throws InterruptedException, IOException, AWTException
	{
		...
		registrationj.Enter_Normal_Result();	  
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
		   ...
		   WebDriverManager.chromedriver().setup();
			...
			recorder = new ATUTestRecorder(".//Videos//","Enter_Normal_Result_Save_Click_backVerify_color_code_Click_result_entry_Submit_Result_Validation_Save_Submit "+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Enter_Normal_Result_Save_Click_backVerify_color_code_Click_result_entry_Submit_Result_Validation_Save_Submit "+ dateFormat.format(date)));
	     }
