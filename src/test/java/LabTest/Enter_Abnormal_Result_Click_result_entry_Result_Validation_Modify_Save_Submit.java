...
public class Enter_Abnormal_Result_Click_result_entry_Result_Validation_Modify_Save_Submit
{
...
/*
	...
	*/
	@Test(priority=2)
	public void TC_04_Enter_Abnormal_Result_Click_result_entry_Result_Validation_Modify_Save_Submit() throws InterruptedException, IOException, AWTException
	{

		enter_media_observation_identificationsave2 registrationj=new enter_media_observation_identificationsave2(driver);
		registrationj.EnterAbnormal_ResultModify();	  
	...
	@BeforeTest
	 ...
	 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	 {
			...
			recorder = new ATUTestRecorder(".//Videos//","Dispatched_sample_processing_result_entry_result_validation_result_approval_report"+dateFormat.format(date),false);
			recorder.start();
	 ...
	 public void FailedScreenShot(ITestResult Result) throws IOException
	 {
	     if(ITestResult.FAILURE==Result.getStatus())
	     {
	         ...
	         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Dispatched_sample_processing_result_entry_result_validation_result_approval_report"+ dateFormat.format(date)));
	     }
