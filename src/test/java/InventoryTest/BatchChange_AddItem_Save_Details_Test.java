...
public class BatchChange_AddItem_Save_Details_Test
{
	...
	{
		InventoryPages.Login Loginapp=new Login(driver);
		Loginapp.login_Medcare(Uesrid);
	}	
	@Test(priority=2)
	public void TC_02_Verify_That_User_can_do_BatchChange_AddItem_Save() throws InterruptedException, IOException
	{
		BatchChange_AddItem_Save_Details BC=new BatchChange_AddItem_Save_Details (driver);
		BC.Batchchange_AddItem_Save();
	}		
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","BatchChange_AddItem_Save_Details_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_BatchChange_AddItem_Save_Details_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
