...
public class BatchChange_AddItem_Save_modify_saveAndsubmit_Details_Test
{
	...
	{
		BatchChange_AddItem_Save_modify_saveAndsubmit_Details BC=new BatchChange_AddItem_Save_modify_saveAndsubmit_Details(driver);
		BC.Batchchange_AddItem_Save_Modify_SaveAndSubmit();
	}		
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","BatchChange_AddItem_Save_modify_saveAndsubmit_Details_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_BatchChange_AddItem_Save_modify_saveAndsubmit_Details_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
