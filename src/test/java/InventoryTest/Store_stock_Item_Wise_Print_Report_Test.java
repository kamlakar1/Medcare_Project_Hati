...
public class Store_stock_Item_Wise_Print_Report_Test
{
	...
	public void TC_03_Verify_That_User_Can_Print_Stock_Stock_Item_Wise_Report() throws InterruptedException, IOException
	{
		Store_stock_Item_Wise_Print_Report Store_Stock=new Store_stock_Item_Wise_Print_Report (driver);
		Store_Stock.Store_Stock_Item_Wise_print_Report();
	}	
