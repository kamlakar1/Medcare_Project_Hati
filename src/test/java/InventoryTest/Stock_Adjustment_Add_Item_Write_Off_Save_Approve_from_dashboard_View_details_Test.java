...
public class Stock_Adjustment_Add_Item_Write_Off_Save_Approve_from_dashboard_View_details_Test
{
	...
	{
		Stock_Adjustment_Add_Item_Write_Off_Save_Approve_from_dashboard_View_details  WriteOff=new Stock_Adjustment_Add_Item_Write_Off_Save_Approve_from_dashboard_View_details (driver);
		WriteOff.Stock_Adjustment_AddItem_For_Write_Off_Save_ApproveFromDashboard();
	}		
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		WebDriverManager.chromedriver().setup();
		recorder = new ATUTestRecorder(".//Videos//","Stock_Adjustment_Add_Item_Write_Off_Save_Approve_from_dashboard_View_details_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_Stock_Adjustment_Add_Item_Write_Off_Save_Approve_from_dashboard_View_details_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
