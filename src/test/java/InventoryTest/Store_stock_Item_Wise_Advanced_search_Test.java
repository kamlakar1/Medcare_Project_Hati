...
public class Store_stock_Item_Wise_Advanced_search_Test
{
	...
	public void TC_03_Verify_That_User_Can_DO_Stock_Stock_Item_Wise_Advanced_Search() throws InterruptedException, IOException
	{
		Store_stock_Item_Wise_Advanced_search  Store_Stock=new Store_stock_Item_Wise_Advanced_search(driver);
		Store_Stock.Store_Stock_Item_Wise_Advanced_Search();
	}	
	@BeforeTest
