...
public class DisposalRequest_Against_Item_Save_Details_Test
{
	...
	@Test(priority=2)
	public void TC_02_Verify_That_User_can_do_DisposalRequest_Against_Item_Save_Details() throws InterruptedException, IOException
	{
		DisposalRequest_Against_Item_Save_Details DR=new DisposalRequest_Against_Item_Save_Details(driver);
		DR.Disposal_Request_Against_Item_Save_Details();
	}		
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","DisposalRequest_Against_Item_Save_Details_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DisposalRequest_Against_Item_Save_Details_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
