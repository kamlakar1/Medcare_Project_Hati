...
public class BatchChange_AddItem_saveAndsubmit_ApproveFromDashboard_details_Test
{
	...
	@Test(priority=2)
	public void TC_02_Verify_That_User_can_do_BatchChange_AddItem_Save_Modify_SaveAndSubmit() throws InterruptedException, IOException
	{
		BatchChange_AddItem_saveAndsubmit_ApproveFromDashboard_details  BC=new BatchChange_AddItem_saveAndsubmit_ApproveFromDashboard_details(driver);
		BC.Batchchange_SaveAndSubmit_ApproveFromDashBoard();
	}		
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","BatchChange_AddItem_saveAndsubmit_ApproveFromDashboard_details_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_BatchChange_AddItem_saveAndsubmit_ApproveFromDashboard_details_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
