...
public class Opening_Balance_Dashboard_Advanced_Search_Test
{
	...
	{
		Opening_Balance_Dashboard_Advanced_Search  OPBalance=new Opening_Balance_Dashboard_Advanced_Search (driver);
		OPBalance.Opening_Balance_Dashboard_AdvancedSearch();
	}	
	...
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","Opening_Balance_Dashboard_Advanced_Search_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_Opening_Balance_Dashboard_Advanced_Search_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
