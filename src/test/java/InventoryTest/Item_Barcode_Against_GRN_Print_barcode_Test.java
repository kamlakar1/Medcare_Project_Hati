...
import InventoryPages.Item_Barcode_Against_GRN_Print_barcode;
...
public class Item_Barcode_Against_GRN_Print_barcode_Test
{
	...
	public void TC_03_Verify_That_User_can_Create_Opening_Balance_Printing_Barcode_Against_GRN(String IteamGroupPar,String IteamCategoryPar,String IteamCodePar,String IteamNamePar,String BatchNoPar,String ExpirayDatePar,String QuantityPar) throws InterruptedException, IOException
	{
		Item_Barcode_Against_GRN_Print_barcode OPBalance=new Item_Barcode_Against_GRN_Print_barcode(driver);
		OPBalance.User_Can_Create_Opening_Balance_Print_BarcodeBY_GRN(IteamGroupPar,IteamCategoryPar,IteamCodePar,IteamNamePar,BatchNoPar,ExpirayDatePar,QuantityPar);
	}	
