...
public class Opening_Balance_Add_item_Save_Modify_Save_View_Details_Test
{
	...
	{
		Opening_Balance_Add_item_Save_Modify_Save_View_Details OPBalance=new Opening_Balance_Add_item_Save_Modify_Save_View_Details(driver);
		OPBalance.User_Can_Create_Opening_Balance_Save_EDITBalance(IteamGroupPar,IteamCategoryPar,IteamCodePar,IteamNamePar,BatchNoPar,ExpirayDatePar,QuantityPar);
	}	
