...
public class Opening_Balance_Add_item_Enter_item_details_Save_Cancel_Test
{
	...
	{
		Opening_Balance_Add_item_Enter_item_details_Save_Cancel  OPBalance=new Opening_Balance_Add_item_Enter_item_details_Save_Cancel (driver);
		OPBalance.User_Can_Create_Opening_Balance_Save_CancelBalance(IteamGroupPar,IteamCategoryPar,IteamCodePar,IteamNamePar,BatchNoPar,ExpirayDatePar,QuantityPar);
	}	
	...
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","Opening_Balance_Add_item_Save_Modify_Save_View_Details_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_Opening_Balance_Add_item_Save_Modify_Save_View_Details_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
