...
public class BatchChange_AddItem_Save_Cancel_Test
{
	...
	@Test(priority=2)
	public void TC_02_Verify_That_User_can_do_BatchChange_AddItem_Save_Cancel() throws InterruptedException, IOException
	{
		BatchChange_AddItem_Save_Cancel BC=new BatchChange_AddItem_Save_Cancel(driver);
		BC.Batchchange_AddItem_Save_Cancel();
	}		
	@BeforeTest
