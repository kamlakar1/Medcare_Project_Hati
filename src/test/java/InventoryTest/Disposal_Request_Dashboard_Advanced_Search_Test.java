...
public class Disposal_Request_Dashboard_Advanced_Search_Test
{
	...
	{
		Disposal_request_dashboard_Advanced_Search DR=new Disposal_request_dashboard_Advanced_Search(driver);
		DR.Disposal_Request_Advanced_Search();
	}		
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","Disposal_Request_Dashboard_Advanced_Search_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_Disposal_Request_Dashboard_Advanced_Search_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
