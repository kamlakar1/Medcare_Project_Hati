...
public class Batch_change_dashboard_Advanced_Search_Test
{
	...
	@Test(priority=2)
	public void TC_02_Verify_That_User_can_do_advanced_Search_On_Batch_Change_Dashboard() throws InterruptedException, IOException
	{
		Batch_change_dashboard_Advanced_Search BC=new Batch_change_dashboard_Advanced_Search(driver);
		BC.Batchchange_Advanced_Search();
	}		
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","Batch_change_dashboard_Advanced_Search_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_Batch_change_dashboard_Advanced_Search_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
