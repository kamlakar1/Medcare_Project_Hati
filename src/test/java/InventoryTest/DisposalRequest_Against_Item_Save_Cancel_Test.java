...
public class DisposalRequest_Against_Item_Save_Cancel_Test
{
	...
	{
		DisposalRequest_Against_Item_Save_Cancel DR=new DisposalRequest_Against_Item_Save_Cancel(driver);
		DR.Disposal_Request_Against_Item_Save_Cancel();
	}		
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","DisposalRequest_Against_Item_Save_Cancel_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DisposalRequest_Against_Item_Save_Cancel_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
