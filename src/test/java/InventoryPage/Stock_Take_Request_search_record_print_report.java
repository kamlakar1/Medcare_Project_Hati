...
public class Stock_Take_Request_search_record_print_report {
	...
	public Stock_Take_Request_search_record_print_report (WebDriver driver)
	...
	public void Stock_Take_Requestfunc() throws InterruptedException, IOException 
	{
		...
		Thread.sleep(2000);
		driver.findElement(StockTakeNo).sendKeys("HISCKLS01ST10002");
		Thread.sleep(1000);
		driver.findElement(Ssearch).click();
		Thread.sleep(1000);
		driver.findElement(print_it).click();
		Thread.sleep(1000);
