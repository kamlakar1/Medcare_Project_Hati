...
public class Stock_take_request_Add_new_save_Print_Cancel {
    ...
    By Cancellll = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-stocktakerequest/div[2]/div[1]/table/tbody/tr[1]/td[10]/a[3]/mat-icon");	
    ...
    public Stock_take_request_Add_new_save_Print_Cancel (WebDriver driver)
	...
	public void Stock_take_request_Afunc() throws InterruptedException, IOException 
	{
	...
	//	String getstokno = driver.findElement(stocknoget).getText();
     //   System.out.println(getstokno);
		...
		driver.findElement(Cancellll).click();
		Thread.sleep(3000);
		driver.findElement(CancelReason).click();
		Thread.sleep(1000);
		driver.findElement(Not_Requiredd).click();
		Thread.sleep(1000);
		driver.findElement(ReasonSave).click();
		//driver.findElement(Return).click();
		//Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Stock_take_request_Add_new_save_Print_Cancel.png")); 
		Thread.sleep(1000);
