...
public class Store_Indent_Against_Item_Add_Item_Save_Print_report {
	...
	By Checkbox =By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-additem/div/div[2]/div/mat-table/mat-row/mat-cell[1]/mat-checkbox");
	...
	public Store_Indent_Against_Item_Add_Item_Save_Print_report (WebDriver driver)
	...
	public void Store_Indent_Against_Item_Add_Itemfunc() throws InterruptedException, IOException 
	{
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Store_Indent_Against_Item_Add_Item_Save_Print_report.png")); 
		Thread.sleep(1000);
