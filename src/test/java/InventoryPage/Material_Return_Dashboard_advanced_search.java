...
public class Material_Return_Dashboard_advanced_search {
   ...
   public Material_Return_Dashboard_advanced_search (WebDriver driver)
	...
	public void Material_Return_Dashboard_advanced_searchfunc() throws InterruptedException, IOException 
	{
		...
		Thread.sleep(1000);
		driver.findElement(Returnno).sendKeys("HISCKLS01MRET10014");
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Material_Return_Dashboard_advanced_search.png")); 
		Thread.sleep(1000);
