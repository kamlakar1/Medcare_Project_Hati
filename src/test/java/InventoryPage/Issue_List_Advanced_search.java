...
public class Issue_List_Advanced_search {
   ...
   public Issue_List_Advanced_search (WebDriver driver)
	...
	public void Issue_List_Advanced_searchfunc() throws InterruptedException, IOException 
	{
		...
		Thread.sleep(1000);
		driver.findElement(Quantity_12).sendKeys("1");
	    Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Issue_List_Advanced_search.png")); 
		Thread.sleep(1000);
