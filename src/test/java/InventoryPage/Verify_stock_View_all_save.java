...
public class Verify_stock_View_all_save {
	...
	By Vrify = By.cssSelector("a[ng-reflect-router-link='stocktakerequest,verifystock-d']");
    ...
    public Verify_stock_View_all_save (WebDriver driver)
	...
	public void Verify_stock_Viesavefunc() throws InterruptedException, IOException 
	{
	...
	//	String getstokno = driver.findElement(stocknoget).getText();
     //   System.out.println(getstokno);
		...
		WebElement HoverSideBar2=driver.findElement(SideBarMenu);
		act.moveToElement(HoverSideBar2).build().perform();
		Thread.sleep(5000);
		driver.findElement(Vrify).click();
		Thread.sleep(1000);
		driver.findElement(storeopt_2).click();
		Thread.sleep(1000);
		driver.findElement(OP_Store_11).click();
		Thread.sleep(1000);
		driver.findElement(stocktakeno).click();
		Thread.sleep(1000);
		driver.findElement(srocktakenoo).click();
		Thread.sleep(1000);
		driver.findElement(count).click();
		Thread.sleep(1000);
		driver.findElement(countopt).click();
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Verify_stock_View_all_save.png")); 
		Thread.sleep(1000);
