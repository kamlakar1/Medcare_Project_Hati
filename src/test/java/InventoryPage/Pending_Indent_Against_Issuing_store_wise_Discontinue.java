...
public class Pending_Indent_Against_Issuing_store_wise_Discontinue {
	...
	By Issuing_Store_Wise = By.xpath("//span[contains(text(),'Issuing Store Wise')]");
	...
	public Pending_Indent_Against_Issuing_store_wise_Discontinue (WebDriver driver)
	...
	public void Pending_Indent_Against_Issuing_store_wise_Discontinuefunc() throws InterruptedException, IOException 
	{
		...
		Thread.sleep(1000);
		driver.findElement(Issuing_Store_Wise).click();
		Thread.sleep(1000);
...
//
	...
	//	Assert.assertEquals(ActualQuantity, ExpectedQuantity, "Quantity has been verified sucessfully and Approval rejected");
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Pending_Indent_Against_Issuing_store_wise_Discontinue.png")); 
		Thread.sleep(1000);
