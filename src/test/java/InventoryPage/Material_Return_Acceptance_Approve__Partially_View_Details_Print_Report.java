...
public class Material_Return_Acceptance_Approve__Partially_View_Details_Print_Report {
	...
	By Detail_s = By.cssSelector("a[ng-reflect-message='Details']");
	
   public Material_Return_Acceptance_Approve__Partially_View_Details_Print_Report (WebDriver driver)
	...
	public void Material_Return_funcc() throws InterruptedException, IOException 
	{
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Material_Return_Acceptance_Approve__Partially_View_Details_Print_Report.png")); 
		Thread.sleep(1000);
