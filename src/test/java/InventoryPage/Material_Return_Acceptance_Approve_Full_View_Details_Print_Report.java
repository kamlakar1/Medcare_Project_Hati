...
public class Material_Return_Acceptance_Approve_Full_View_Details_Print_Report {
   ...
   public Material_Return_Acceptance_Approve_Full_View_Details_Print_Report (WebDriver driver)
	...
	public void Material_Return_Acceptance_Approvfunc() throws InterruptedException, IOException 
	{
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Material_Return_Acceptance_Approve_Full_View_Details_Print_Report.png")); 
		Thread.sleep(1000);
