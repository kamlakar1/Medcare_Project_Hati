...
public class Store_Indent_Approval_Print_Report_View_details {
	...
	public Store_Indent_Approval_Print_Report_View_details (WebDriver driver)
	...
	public void Store_Indent_Approval_Print_Report_View_detailsfunc(String IndentNo) throws InterruptedException, IOException 
	{
		...
		FileUtils.copyFile(screenshot_9, new File(".//ScreenShots//Store_Indent_Approval_Print_Report_View_details.png")); 
		Thread.sleep(2000);
