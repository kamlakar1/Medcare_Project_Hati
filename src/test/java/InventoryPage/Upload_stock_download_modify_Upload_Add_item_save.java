...
public class Upload_stock_download_modify_Upload_Add_item_save {
    ...
    By Excel = By.xpath("/html/body/div[2]/div[2]/div/div/div/button[1]");
    ...
    public Upload_stock_download_modify_Upload_Add_item_save (WebDriver driver)
	...
	public void Upload_stock_download_func() throws InterruptedException, IOException 
	{
	...
	//	String getstokno = driver.findElement(stocknoget).getText();
     //   System.out.println(getstokno);
		...
		//driver.findElement(Return).click();
		//Thread.sleep(1000);
		driver.findElement(UploadStock).click();
		Thread.sleep(3000);
		driver.findElement(storeupload).click();
		Thread.sleep(1000);
		driver.findElement(OP_Store_11).click();
		Thread.sleep(1000);
		driver.findElement(UPstocktakeno).click();
		Thread.sleep(1000);
		driver.findElement(stockno).click();
		Thread.sleep(1000);
		driver.findElement(countup).click();
		Thread.sleep(1000);
		driver.findElement(countoptup).click();
		Thread.sleep(1000);
		driver.findElement(Downlaod).click();
		Thread.sleep(1000);
		driver.findElement(Excel).click();
		Thread.sleep(1000);
		driver.findElement(Upload).click();
		Thread.sleep(1000);
		WebElement browse = driver.findElement(choosecsv);
		   //click on ‘Choose file’ to upload the desired file
		browse.sendKeys("C:\\Users\\Kamlakar\\git\\Medcare_Automation_Framework\\MedcareFramrwork_id-backend\\49393135-21a9-45e6-ba4b-2c1c35592d09.xlsx");
		Thread.sleep(1000);
		driver.findElement(Uplaodd).click();
		Thread.sleep(1000);
		driver.findElement(addnewup).click();
		Thread.sleep(2000);
		driver.findElement(cehckboxItemGroup).click();
		Thread.sleep(1000);
		driver.findElement(upadditems).click();
		Thread.sleep(1000);
		driver.findElement(Quantityup).sendKeys("3");
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Upload_stock_download_modify_Upload_Add_item_save.png")); 
		Thread.sleep(1000);
