...
public class Store_Indent_Approval_Discontinue_View_details {
	...
	public Store_Indent_Approval_Discontinue_View_details (WebDriver driver)
	...
	public void Store_Indent_Approval_Discontinue_View_detailsfunc() throws InterruptedException, IOException 
	{
		...
		/*
		 * Thread.sleep(3000); driver.findElement(Checkbox_1).click();
		 * Thread.sleep(1000); driver.findElement(Approve).click(); Thread.sleep(1000);
...
//
	...
	//	Assert.assertEquals(ActualQuantity, ExpectedQuantity, "Quantity has been verified sucessfully and Approval rejected");
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Store_Indent_Approval_Discontinue_View_details.png")); 
		Thread.sleep(1000);
