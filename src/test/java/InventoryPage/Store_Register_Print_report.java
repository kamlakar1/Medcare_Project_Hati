...
public class Store_Register_Print_report {
	...
	By Print_1 = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialreturn/div[3]/mat-table/mat-row[1]/mat-cell[12]/a[2]/mat-icon");
   ...
   public Store_Register_Print_report (WebDriver driver)
	...
	public void Store_Register_Print_reportfunc() throws InterruptedException, IOException 
	{
		...
		driver.findElement(Print_1).click();
		Thread.sleep(2000);
	...
	//	Assert.assertEquals(Curenturl, "https://medcare-productqa.hatiintl.com/#/Dashboard/kkkkk");
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Store_Register_Print_report.png")); 
		Thread.sleep(1000);
