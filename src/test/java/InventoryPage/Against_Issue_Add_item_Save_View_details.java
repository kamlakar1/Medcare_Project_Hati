...
public class Against_Issue_Add_item_Save_View_details {
	...
	By ReturnReson=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-materialreturn/div/div[1]/mat-table/mat-row/mat-cell[13]/mat-form-field");
	...
	By Detailssss = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialreturn/div[3]/mat-table/mat-row/mat-cell[13]/a");
    ...
    By search = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-get-return-issue/div/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/a/mat-icon");
	By selectrec = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-get-return-issue/div/div[2]/div[1]/mat-table/mat-row[1]/mat-cell[2]");
   By checkbox = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-get-return-issue/div/div[2]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
	public Against_Issue_Add_item_Save_View_details (WebDriver driver)
	...
	public void Material_Return_Savefuccccccc() throws InterruptedException, IOException 
	{
		...
		//driver.findElement(AddItemlist).click();
		Thread.sleep(1000);
		driver.findElement(Add_Itms).click();
		Thread.sleep(1000);
		driver.findElement(Quantity_11).clear();
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		driver.findElement(Detailssss).click();
		//Thread.sleep(2000);
		//driver.findElement(GetReturnNo).click();
		Thread.sleep(2000);
		String GetItemcode_1 = driver.findElement(GetItemcode).getText();
		String ActualQuantity = GetItemcode_1;
		String ExpectedQuantity = GetItemcode_1;
		Assert.assertEquals(ActualQuantity, ExpectedQuantity, "Item no has been verified successfully");
		Thread.sleep(1000);
		File screenshot_10 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Against_Issue_Add_item_Save_View_details.png")); 
		Thread.sleep(1000);
