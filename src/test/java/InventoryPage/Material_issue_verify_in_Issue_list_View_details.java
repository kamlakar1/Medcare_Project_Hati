...
public class Material_issue_verify_in_Issue_list_View_details {
	...
	By ViewDetails = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialissue/mat-tab-group/div/mat-tab-body[1]/div/div[1]/div/table/tbody/tr[1]/td[13]/a/mat-icon");
	By verif = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialissue/mat-tab-group/div/mat-tab-body[1]/div/div[1]/div/table/tbody/tr[1]/td[2]");
	public Material_issue_verify_in_Issue_list_View_details (WebDriver driver)
	...
	public void Material_issue_verify_in_Issue_list_View_detailsfunc() throws InterruptedException, IOException 
	{
		...
		Thread.sleep(1000);
		driver.findElement(Material_Issue).click();
		Thread.sleep(1000);
		driver.findElement(Pending_issue).click();
		Thread.sleep(1000);
		driver.findElement(ViewDetails).click();
		Thread.sleep(3000);
		
		String kk = driver.findElement(verif).getText();
		String Actual = kk;
		String Expected = kk;
		Assert.assertEquals(Actual, Expected, "Verify the details");
		
		/*
		driver.findElement(Expand).click();
		Thread.sleep(1000);
		String takeindno = driver.findElement(Indent_No).getText();
		driver.findElement(Indent__No).sendKeys(takeindno);
		Thread.sleep(1000);
		driver.findElement(serachbutton).click();
		Thread.sleep(1000);
		driver.findElement(detailsss).click();
		Thread.sleep(1000);
		driver.findElement(Itemdetailscheckbox).click();
		Thread.sleep(1000);
		driver.findElement(ExpandPlus).click();
		Thread.sleep(1000);
		driver.findElement(Selectbatch).click();
		Thread.sleep(1000);
		driver.findElement(Selectbatchopt).click();
		Thread.sleep(1000);
		driver.findElement(Quantity_12).sendKeys("2");
	    Thread.sleep(1000);
	    driver.findElement(Save).click();
	    Thread.sleep(1000);
	    driver.findElement(Yes).click();
	    Thread.sleep(3000);
	    driver.findElement(IssueList).click();
	    Thread.sleep(3000);
	    String IssueListindvrify = driver.findElement(Indnoverify).getText();
		String ActualQuantity = IssueListindvrify;
		String ExpectedQuantity = IssueListindvrify;
		Assert.assertEquals(ActualQuantity, ExpectedQuantity, "Idenno has been verified sucessfully");
		*/
		File screenshot_10 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Material_issue_verify_in_Issue_list_View_details.png")); 
		Thread.sleep(1000);
