...
public class Against_Issue_Add_item_Save_and_submit_View_details {
	...
	public Against_Issue_Add_item_Save_and_submit_View_details (WebDriver driver)
	...
	public void Against_Issue_Add_item_Savefuncncrt() throws InterruptedException, IOException 
	{
	...
	//	driver.findElement(Yes).click();	
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Against_Issue_Add_item_Save_and_submit_View_details.png")); 
		Thread.sleep(1000);
