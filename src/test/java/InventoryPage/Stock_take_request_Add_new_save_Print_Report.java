...
public class Stock_take_request_Add_new_save_Print_Report {
   ...
   public Stock_take_request_Add_new_save_Print_Report (WebDriver driver)
	...
	public void Stock_take_request_Add_new_save_Printfunn_c() throws InterruptedException, IOException 
	{
	...
	//	String getstokno = driver.findElement(stocknoget).getText();
     //   System.out.println(getstokno);
		...
		Thread.sleep(1000);
		driver.findElement(repribt).click();
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Stock_take_request_Add_new_save_Print_Report.png")); 
		Thread.sleep(1000);
