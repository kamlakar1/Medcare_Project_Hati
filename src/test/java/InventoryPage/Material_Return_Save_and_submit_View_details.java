...
public class Material_Return_Save_and_submit_View_details {
	...
	public Material_Return_Save_and_submit_View_details (WebDriver driver)
	...
	public void Material_Return_Savefuc() throws InterruptedException, IOException 
	{
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Material_Return_Save_and_submit_View_details.png")); 
		Thread.sleep(1000);
