...
public class Material_issue_Pending_Issue_Print_Report {
	...
	By print =By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialissue/mat-tab-group/div/mat-tab-body[1]/div/div[1]/div/table/tbody/tr/td[12]/a/mat-icon");
	...
	public Material_issue_Pending_Issue_Print_Report (WebDriver driver)
	...
	public void Material_issue_Pending_Issue_Print_Reportfunc() throws InterruptedException, IOException 
	{
		...
		Thread.sleep(1000);
		driver.findElement(Quantity_1).sendKeys("5");
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Material_issue_Pending_Issue_Print_Report.png")); 
		Thread.sleep(1000);
