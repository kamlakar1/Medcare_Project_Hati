...
public class Against_item_Add_item_Save_approve_From_dashboard {
	...
	By Checkbox =By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialreturn/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
	...
	public Against_item_Add_item_Save_approve_From_dashboard (WebDriver driver)
	...
	public void Against_item_Add_item_Savefunc_func() throws InterruptedException, IOException 
	{
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Against_item_Add_item_Save_approve_From_dashboard.png")); 
		Thread.sleep(1000);
