...
public class Material_Issue_Issue_List_Print_report {
	...
	By PrintReport = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialissue/mat-tab-group/div/mat-tab-body[1]/div/div[1]/div/table/tbody/tr/td[12]/a/mat-icon");
   public Material_Issue_Issue_List_Print_report (WebDriver driver)
	...
	public void Material_Issue_Issue_List_Print_reportfunc() throws InterruptedException, IOException 
	{
		...
		Thread.sleep(3000);
		driver.findElement(PrintReport).click();
		/*
		...
		Thread.sleep(1000);
		driver.findElement(PrintIssueList).click();
		*/
		Thread.sleep(1000);
		File screenshot_10 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Material_Issue_Issue_List_Print_report.png")); 
		Thread.sleep(1000);
