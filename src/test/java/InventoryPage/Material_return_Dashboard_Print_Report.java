...
public class Material_return_Dashboard_Print_Report {
	...
	By print = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialreturn/div[3]/mat-table/mat-row/mat-cell[12]/a[2]");
	public Material_return_Dashboard_Print_Report (WebDriver driver)
	...
	public void Material_return_Dashboard_Print_Reportfunc() throws InterruptedException, IOException 
	{
		...
		Thread.sleep(3000);
		WebElement l = driver.findElement(startdate);
		// input text
		l.sendKeys("66");
		...
		WebElement ll = driver.findElement(enddate);
		// input text
		ll.sendKeys("66");
		// sending Ctrl+a by Keys.Chord()
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Material_return_Dashboard_Print_Report.png")); 
		Thread.sleep(1000);
