...
public class Against_Issue_Add_item_Save_Modify_Submit_View_details {
	...
	public Against_Issue_Add_item_Save_Modify_Submit_View_details (WebDriver driver)
	...
	public void Against_Issue_Add_item_Savefuncnc() throws InterruptedException, IOException 
	{
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Against_Issue_Add_item_Save_Modify_Submit_View_details.png")); 
		Thread.sleep(1000);
