...
public class Against_item_near_by_expiry_Add_item_Save_submit_View_details {
	...
	By ItemGroupCheckbox =By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-additem-batchwise/div/div[2]/div/mat-table/mat-row/mat-cell[1]");		
	By bulltetbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-materialreturn/div/mat-grid-list[1]/div/mat-grid-tile[6]/div/mat-card-content/section/mat-slide-toggle");		
			
public Against_item_near_by_expiry_Add_item_Save_submit_View_details (WebDriver driver)
	...
	public void Against_item_Add_item_Save_Modifyfuccc() throws InterruptedException, IOException 
	{
		...
		//Thread.sleep(1000);
		driver.findElement(ItemCode).sendKeys("MDT0065");
		Thread.sleep(3000);
		driver.findElement(ItemGroupCheckbox).click();
		Thread.sleep(1000);
		driver.findElement(Add_Itms).click();
		Thread.sleep(1000);
		driver.findElement(bulltetbox).click();
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Against_item_Add_item_Save_Modify_Submit_View_details.png")); 
		Thread.sleep(1000);
