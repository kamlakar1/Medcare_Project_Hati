...
public class Against_Issue_Add_item_Save_and_submit_View_details {
  ...
  @Test
  public void TC_02_Against_Issue_Add_item_Save_and_submit_View_details() throws InterruptedException, IOException 
  
  {
	  InventoryPage.Against_Issue_Add_item_Save_and_submit_View_details AdvanceSearch=new InventoryPage.Against_Issue_Add_item_Save_and_submit_View_details(driver);
	  AdvanceSearch.Against_Issue_Add_item_Savefuncncrt();
