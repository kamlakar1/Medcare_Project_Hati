...
public class OP_Debit_Note_OPCharge_Against_Company_Payer_Page {
...
//---Encounter---//
	...
	//Encounter Type
			...
			//Tariff
			By Tariff=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-patient-registration/div[2]/mat-tab-group/div/mat-tab-body[1]/div/div/div[2]/table/tbody/tr[1]/td[4]");
...
//---DebitNote---//
		...
		public OP_Debit_Note_OPCharge_Against_Company_Payer_Page (WebDriver driver)
  ...
  public void OPChargeDebitNoteagainstPayer(String PrimaryIdNumberPar,String ExparyDatePar,String SecondaryIdNumberPar,String SecondaryExparyDatePar,String FullNamePar,String DateOfBirthPar,String MotherNamePar,String PatientNotesPar,String ResidentialAddressPar,String PostCodePar,String MobileNumberPar,String Emailpar,String PersonalFaxpar,String WorkFaxpar,String WorkContactNopar,String HomeContactNopar,String PolicyNoPar, String HolderNamePar, String CustomerNamePar, String GLRefNOPar, String ExpiryDatePar, String GLAmountPar, String CoverageAmountPar, String ContactNamePar, String DesignationPar, String ContactNoPar, String GLRemarksPar, String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException 
  {
	 ...
	 //---GLApproval---//
				  ...
				  driver.findElement(GLSave).click();
				     ...
				     FileUtils.copyFile(screenshot3,new File(".//ScreenShots//GLApproval.png"));
				     Thread.sleep(3000);
			      ...
			      FileUtils.copyFile(screenshot1, new File(".\\ScreenShots\\OP_DebitNote_OPCharges_Save_Against_Company_Payer_Test.GLApproval Saved.png"));
