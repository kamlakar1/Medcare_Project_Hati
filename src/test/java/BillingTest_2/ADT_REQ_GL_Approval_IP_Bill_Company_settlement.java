...
import BillingPages_2.ADTRequestForm;
import BillingPages_2.ADT_Reg_Insurance_GL_Approval_IP_Bill_Save_Company_settlement;
...
public class ADT_REQ_GL_Approval_IP_Bill_Company_settlement 
{
	...
	public void TC_05_Verify_User_Can_DO_GL_Approval_For_IP_Charges_And_IPD_BILL_With_insurance(String PolicyNoPar,String PolicyDatePar,String HolderNamePar,String CustomerNamePar,String GLRefNOPar,String GLDatePar,String ExpiryDatePar,String GLAmountPar,String CoverageAmountPar,String ContactNamePar,String DesignationPar,String ContactNoPar,String GLRemarksPar) throws InterruptedException, IOException
	{
		ADT_Reg_Insurance_GL_Approval_IP_Bill_Save_Company_settlement GLIPChargesipbill=new ADT_Reg_Insurance_GL_Approval_IP_Bill_Save_Company_settlement(driver);
		GLIPChargesipbill.GLApprovalForADT_Req_IPCharges_IPBILL_COmpany_Settelement(PolicyNoPar,PolicyDatePar,HolderNamePar,CustomerNamePar,GLRefNOPar,GLDatePar,ExpiryDatePar,GLAmountPar,CoverageAmountPar,ContactNamePar,DesignationPar,ContactNoPar,GLRemarksPar);	 
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","Admission_Request_Insurance_Admission_Form_save_Admission_GL_Approval_IP_charge_Save_Charges_IP_Bill_Save-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_Admission_Request_Insurance_Admission_Form_save_Admission_GL_Approval_IP_charge_Save_Charges_IP_Bill_Save"+dateFormat.format(date)));
		}
	}
	@AfterSuite
