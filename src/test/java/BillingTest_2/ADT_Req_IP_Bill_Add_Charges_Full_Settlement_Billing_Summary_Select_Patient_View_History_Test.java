...
public class ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_History_Test 
{
	...
	{
		BillingPages_2.ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_History ip=new BillingPages_2.ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_History(driver);
		ip.ADT_REQ_IPD_BIll_FullSettelment_Billing_Summary_VIew_History();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_History_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_History_Test.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
