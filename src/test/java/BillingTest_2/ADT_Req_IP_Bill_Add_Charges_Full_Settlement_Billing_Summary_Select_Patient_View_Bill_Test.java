...
import BillingPages_2.ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_Bill;
...
public class ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_Bill_Test 
{
	...
	@Test(priority=5)
	public void TC_05_Verify_That_User_Is_Able_To_View_Bill_After_Bill_Is_Generated() throws InterruptedException, IOException
	{
		ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_Bill ip=new ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_Bill(driver);
		ip.ADT_REQ_IPD_BIll_FullSettelment_Billing_Summary_VIew_Bill();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_Bill_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_Bill_Test.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
