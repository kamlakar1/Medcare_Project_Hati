...
public class ADT_Req_Insurance_IP_Charges_Charge_Conversion_Insurance_To_Self_Test 
{
	...
	{
		BillingPages_2.ADTRequestForm ADT=new ADTRequestForm (driver);
	...
	{
		BillingPages_2.ADTAdmissionForm_WIth_Reg_with_Insurance ADTForm=new BillingPages_2.ADTAdmissionForm_WIth_Reg_with_Insurance(driver);
	...
	public void TC_05_User_Can_Add_IP_Charges_and_Can_Convert_Charges_Insurance_To_Self() throws InterruptedException, IOException
	{
		BillingPages_2.ADT_Req_Insurance_IP_Charges_Charge_Conversion_Insurance_To_Self  IP=new BillingPages_2.ADT_Req_Insurance_IP_Charges_Charge_Conversion_Insurance_To_Self (driver);
		IP.IPChargesForSelandInsurance_With_Charge_Conversion();
	}
		
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADT_Req_Insurance_IP_Charges_Charge_Conversion_Insurance_To_Self_Test"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_Req_Insurance_IP_Charges_Charge_Conversion_Insurance_To_Self_Test.png"+dateFormat.format(date)));
		}
	}
	@AfterSuite
