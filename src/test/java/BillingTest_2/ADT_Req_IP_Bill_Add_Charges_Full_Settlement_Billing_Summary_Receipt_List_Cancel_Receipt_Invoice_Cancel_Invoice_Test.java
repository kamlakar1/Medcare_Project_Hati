...
import BillingPages_2.ADTAdmissionForm_WIth_Reg;
import BillingPages_2.ADTRequestForm;
import BillingPages_2.ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Receipt_List_Cancel_Receipt_Invoice_Cancel_Invoice;
import BillingPages_2.AdmissionRegScreen;
import BillingPages_2.Login;
import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
import io.github.bonigarcia.wdm.WebDriverManager;

public class ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Receipt_List_Cancel_Receipt_Invoice_Cancel_Invoice_Test 
{
	...
	@Test(priority=5)
	public void TC_05_Verify_That_User_Is_Able_To_View_History_Of_Patient_After_Bill_Is_Completed() throws InterruptedException, IOException
	{
		ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Receipt_List_Cancel_Receipt_Invoice_Cancel_Invoice ip=new ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Receipt_List_Cancel_Receipt_Invoice_Cancel_Invoice(driver);
		ip. Billing_Summary_Receipt_List_Cancel_Receipt_Invoice_Cancel_Invoice();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_Reprint_Invoice_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_Reprint_Invoice_Test.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
