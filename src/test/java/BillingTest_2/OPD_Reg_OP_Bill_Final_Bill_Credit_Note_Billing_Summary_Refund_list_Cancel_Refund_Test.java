...
public class OPD_Reg_OP_Bill_Final_Bill_Credit_Note_Billing_Summary_Refund_list_Cancel_Refund_Test 
{
	...
	public void TC_02_Verify_That_User_Is_Able_To_Do_Quick_Registration(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException
	{
	 ...
	 {
		 BillingPages_2.OPD_Reg_OP_Bill_Final_Bill_Credit_Note_Billing_Summary_Refund_list_Cancel_Refund   charge=new BillingPages_2.OPD_Reg_OP_Bill_Final_Bill_Credit_Note_Billing_Summary_Refund_list_Cancel_Refund (driver);
		 charge.OPD_OP_Bill_Credit_note();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","OPD_Reg_OP_Bill_Final_Bill_Credit_Note_Billing_Summary_Refund_list_Cancel_Refund_Test"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OPD_Reg_OP_Bill_Final_Bill_Credit_Note_Billing_Summary_Refund_list_Cancel_Refund_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
