...
public class ADTRequest_AdmissionForm_saveAdmission_IPBill_PartialSettlement 
{
	...
	@Test(priority=5)
	public void TC_05_Verify_That_User_Is_Able_Create_IP_BILL_With_Partial_Settlement() throws InterruptedException, IOException
	{
		BillingPages_2.ADTRequestedForm_IP_Bill_Full_Settlement_Partial_Settlement  ip=new BillingPages_2.ADTRequestedForm_IP_Bill_Full_Settlement_Partial_Settlement(driver);
		ip.ADT_Patient_IPD_BIll_Partial_Settlement();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADTRequest_AdmissionForm_saveAdmission_IPBill_PartialSettlement-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADTRequest_AdmissionForm_saveAdmission_IPBill_PartialSettlement.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
