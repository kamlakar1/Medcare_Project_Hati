...
import BillingPages_2.GLApproval_ADT_Requested_FOR_IP_Charge_IP_BILL;
import OPDpages.Login;
import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
import io.github.bonigarcia.wdm.WebDriverManager;

public class Admission_Request_Insurance_Admission_Form_GL_Approval_IP_Bill_Save_Company_Settlement 
{
	...
	{
		GLApproval_ADT_Requested_FOR_IP_Charge_IP_BILL GLIPChargesipbill=new GLApproval_ADT_Requested_FOR_IP_Charge_IP_BILL(driver);
		GLIPChargesipbill.GLApprovalForADT_Req_IPCharges_IPBILL(PolicyNoPar,PolicyDatePar,HolderNamePar,CustomerNamePar,GLRefNOPar,GLDatePar,ExpiryDatePar,GLAmountPar,CoverageAmountPar,ContactNamePar,DesignationPar,ContactNoPar,GLRemarksPar);	 
	}
	@BeforeTest
