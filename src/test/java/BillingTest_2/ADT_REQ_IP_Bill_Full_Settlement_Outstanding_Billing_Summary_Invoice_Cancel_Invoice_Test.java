...
public class ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice_Test 
{
	...
	{
		BillingPages_2.ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice ip=new BillingPages_2.ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice(driver);
		ip.IPCharges_IPD_BIll_Outstanding_Invoice_Cancel_Invoice();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice_Test.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
