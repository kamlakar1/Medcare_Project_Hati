...
public class Admission_Request_Insurance_Admission_Form_save_Admission_GL_Approval_IP_charge_Save_Charges_IP_Bill_Apply_Group_Discount 
{
	...
	{
		recorder = new ATUTestRecorder(".//Videos//","Admission_Request_Insurance_Admission_Form_save_Admission_GL_Approval_IP_charge_Save_Charges_IP_Bill_Apply_Group_Discount-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_Admission_Request_Insurance_Admission_Form_save_Admission_GL_Approval_IP_charge_Save_Charges_IP_Bill_Apply_Group_Discount.png"+dateFormat.format(date)));
		}
	}
	@AfterSuite
