...
import BillingPages_2.ADTRequestedForm_IPcharge_Charges_IP_Bill_Full_Settlement_Cash;
import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
import io.github.bonigarcia.wdm.WebDriverManager;

public class ADTRequest_AdmissionForm_saveAdmission_IPcharge_SaveCharges_IPBill_Full_Settlement_Cash 
{
	...
	@Test(priority=5)
	public void TC_05_Verify_That_User_Is_Able_to_Save_IP_Charges_Then_Create_IP_BILL_FullSettelment_Cash_For_Patient() throws InterruptedException, IOException
	{
		ADTRequestedForm_IPcharge_Charges_IP_Bill_Full_Settlement_Cash  ipd=new ADTRequestedForm_IPcharge_Charges_IP_Bill_Full_Settlement_Cash(driver);
		ipd.IPCharges_IPD_BIll_FullSettelment_Cash();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADTRequest_AdmissionForm_saveAdmission_IPcharge_SaveCharges_IPBill_Full_Settlement_Cash"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADTRequest_AdmissionForm_saveAdmission_IPcharge_SaveCharges_IPBill_Full_Settlement_Cash.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
