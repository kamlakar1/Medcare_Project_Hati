...
public class ADTRequest_AdmissionForm_saveAdmission_IPBill_AddCharges_ApplyGroupDiscount_FullSettlement 
{
	...
	@Test(priority=5)
	public void TC_05_Verify_That_User_Is_Able_Create_IP_BILL_FullSettelment_Apply_Group_Discount() throws InterruptedException, IOException
	{
		BillingPages_2.ADTRequestedForm_IP_Bill_Full_Settlement_Cash_Apply_GroupDiscount ip=new BillingPages_2.ADTRequestedForm_IP_Bill_Full_Settlement_Cash_Apply_GroupDiscount(driver);
		ip.IPCharges_IPD_BIll_FullSettelment_Apply_Group_Discount();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADTRequest_AdmissionForm_saveAdmission_IPBill_AddCharges_ApplyGroupDiscount_FullSettlement"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADTRequest_AdmissionForm_saveAdmission_IPBill_AddCharges_ApplyGroupDiscount_FullSettlement.png" ,dateFormat.format(date)));
		}
	}
	@AfterSuite
