...
public class ADTRequested_save_Admission_Deposit_Add_against_Account_Save_Refund_Test 
{
	...
	@Test(priority=5)
		public void TC_05_Verify_Taht_User_is_Able_To_Add_Deposit_Against_Patient_Save_refund() throws InterruptedException, IOException 
	{
		BillingPages_2.ADT_Admission_Form_save_Admission_Deposit_Add_Against_Account_Save_Refund IPchargeScreen=new BillingPages_2.ADT_Admission_Form_save_Admission_Deposit_Add_Against_Account_Save_Refund(driver);
		IPchargeScreen.OP_TO_IP_Patient_Deposit_Add_Agains_Account_Save_Refund();	  
	} 
	@BeforeTest
	public void startBrowser() throws ATUTestRecorderException 
	{ 
		recorder = new ATUTestRecorder(".//Videos//","ADTRequested_save_Admission_Deposit_Add_against_Account_Save_Refund_Test"+dateFormat.format(date),false);
		recorder.start();   
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADTRequested_save_Admission_Deposit_Add_against_Account_Save_Refund_Test.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
