...
import BillingPages.OPD_Req_Deposit_Refund_OP_Final_Bill_Patient_Ledger_search_patient_View_Ledger;
import Pages.Login;
...
public class OPD_Req_Deposit_Refund_OP_Final_Bill_Patient_Ledger_search_patient_View_Ledger_Test 
{
	...
	public void TC_02_Verify_That_User_Is_Able_To_Do_Quick_Registration(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException
	{
	 ...
	 @Test(priority=2)
	 public void TC_03_Verify_That_User_Can_Do_Deposit_against_Patient_Then_Refund_View_Ledger() throws InterruptedException, IOException
	 {
		 OPD_Req_Deposit_Refund_OP_Final_Bill_Patient_Ledger_search_patient_View_Ledger charge=new OPD_Req_Deposit_Refund_OP_Final_Bill_Patient_Ledger_search_patient_View_Ledger(driver);
		 charge.IPD_Patient_Deposit_Add_Agains_Patient_Save_Refund_Patient_Ledger();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","OPD_Req_Deposit_Refund_OP_Final_Bill_Patient_Ledger_search_patient_View_Ledger_Test"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OPD_Req_Deposit_Refund_OP_Final_Bill_Patient_Ledger_search_patient_View_Ledger_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
