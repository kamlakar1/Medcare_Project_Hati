...
public class ADT_REQ_Self_IP_Bill_Add_Charges_Against_Self_Final_Bill_Charge_Verification_Search_Patient_Test 
{
	...
	@Test(priority=5)
	public void TC_05_Verify_That_User_Is_Able_To_View_Bill_After_Bill_Charge_Verification_Search_Patien() throws InterruptedException, IOException
	{
		BillingPages_2.ADT_REQ_Self_IP_Bill_Add_Charges_Against_Self_Final_Bill_Charge_Verification_Search_Patient  ip=new BillingPages_2.ADT_REQ_Self_IP_Bill_Add_Charges_Against_Self_Final_Bill_Charge_Verification_Search_Patient(driver);
		ip.ADT_REQ_IPD_BIll_FullSettelment_Charge_Verification();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADT_REQ_Self_IP_Bill_Add_Charges_Against_Self_Final_Bill_Charge_Verification_Search_Patient_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_REQ_Self_IP_Bill_Add_Charges_Against_Self_Final_Bill_Charge_Verification_Search_Patient_Test.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
