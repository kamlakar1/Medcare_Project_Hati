...
public class AdmissionRequest_Insurance_GLApproval_AdmissionForm_IPcharge 
{
	...
	{
		recorder = new ATUTestRecorder(".//Videos//","AdmissionRequest_Insurance_GLApproval_AdmissionForm_IPcharge"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_AdmissionRequest_Insurance_GLApproval_AdmissionForm_IPcharge.png"+dateFormat.format(date)));
		}
	}
	@AfterSuite
