...
public class OP_REG_Patient_OP_Bill_FInal_bill_Charge_Verification_Search_patient_Test 
{
	...
	public void TC_02_Verify_That_User_Is_Able_To_Do_Quick_Registration(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException
	{
	 ...
	 {
		 BillingPages_2.OP_REG_Patient_OP_Bill_FInal_bill_Charge_Verification_Search_patient  charge=new BillingPages_2.OP_REG_Patient_OP_Bill_FInal_bill_Charge_Verification_Search_patient(driver);
		 charge.OPD_OP_Bill_Charge_Verification();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","OP_REG_Patient_OP_Bill_FInal_bill_Charge_Verification_Search_patient_Test"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OP_REG_Patient_OP_Bill_FInal_bill_Charge_Verification_Search_patient_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
