...
public class OP_Reg_Encounter_Creation_ADT_OP_to_IP_GL_Approval_IP_Bill_Company_Settlement_Test 
{
	WebDriver driver;
	...
	public void TC_05_Verify_User_Can_DO_GL_Approval_And_Company_Settlement_For_OP_TO_IP_Patient_With_IP_BILL_(String PolicyNoPar,String PolicyDatePar,String HolderNamePar,String CustomerNamePar,String GLRefNOPar,String GLDatePar,String ExpiryDatePar,String GLAmountPar,String CoverageAmountPar,String ContactNamePar,String DesignationPar,String ContactNoPar,String GLRemarksPar) throws InterruptedException, IOException
	{
		BillingPages_2.OP_Reg_Encounter_Creation_ADT_OP_to_IP_GL_Approval_IP_Bill_Company_Settlement GLIPBILL=new BillingPages_2.OP_Reg_Encounter_Creation_ADT_OP_to_IP_GL_Approval_IP_Bill_Company_Settlement(driver);
		GLIPBILL.GLApprovalForOPToIP_IP_BILL_Company_Settlement(PolicyNoPar,PolicyDatePar,HolderNamePar,CustomerNamePar,GLRefNOPar,GLDatePar,ExpiryDatePar,GLAmountPar,CoverageAmountPar,ContactNamePar,DesignationPar,ContactNoPar,GLRemarksPar);	 
	}
	@BeforeTest
