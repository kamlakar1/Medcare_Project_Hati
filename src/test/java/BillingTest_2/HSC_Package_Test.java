...
import BillingPages_2.HSC_Package;
import BillingPages_2.Login;
import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
import io.github.bonigarcia.wdm.WebDriverManager;
public class HSC_Package_Test
{
	WebDriver driver;
	...
	{
		HSC_Package ECH=new HSC_Package (driver);
		ECH.HSCPackage(MinAgePar,MaxAgePar,StartDatePar,EndDatePar);
	}
	@BeforeTest
