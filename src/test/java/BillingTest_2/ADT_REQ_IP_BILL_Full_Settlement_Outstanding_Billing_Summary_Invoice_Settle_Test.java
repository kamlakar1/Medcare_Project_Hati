...
import BillingPages_2.ADT_REQ_IP_BILL_Full_Settlement_Outstanding_Billing_Summary_Invoice_Settle;
...
public class ADT_REQ_IP_BILL_Full_Settlement_Outstanding_Billing_Summary_Invoice_Settle_Test 
{
	...
	{
		ADT_REQ_IP_BILL_Full_Settlement_Outstanding_Billing_Summary_Invoice_Settle  ip=new ADT_REQ_IP_BILL_Full_Settlement_Outstanding_Billing_Summary_Invoice_Settle (driver);
		ip.IPCharges_IPD_BIll_Outstanding_Invoice_Settle();
	}
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","ADT_REQ_IP_BILL_Full_Settlement_Outstanding_Billing_Summary_Invoice_Settle_Test-"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_REQ_IP_BILL_Full_Settlement_Outstanding_Billing_Summary_Invoice_Settle_Test.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
