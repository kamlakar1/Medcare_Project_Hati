...
public class OPD_REG_Deposit_Refund_against_patient_Billing_summary_Print_Refund_Report_Test 
{
	...
	public void TC_02_Verify_That_User_Is_Able_To_Do_Quick_Registration(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException
	{
	 ...
	 @Test(priority=2)
	 public void TC_03_Verify_That_User_Can_Do_Deposit_against_Patient_Then_Refund_Print_Refund_Report() throws InterruptedException, IOException
	 {
		 BillingPages_2.OPD_REG_Deposit_Refund_against_patient_Billing_summary_Print_Refund_Report charge=new BillingPages_2.OPD_REG_Deposit_Refund_against_patient_Billing_summary_Print_Refund_Report(driver);
		 charge. OPD_Patient_Deposit_Add_Agains_Patient_Save_Refund_Refund_Report();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		recorder = new ATUTestRecorder(".//Videos//","OPD_REG_Deposit_Refund_against_patient_Billing_summary_Print_Refund_Report_Test"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OPD_REG_Deposit_Refund_against_patient_Billing_summary_Print_Refund_Report_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
