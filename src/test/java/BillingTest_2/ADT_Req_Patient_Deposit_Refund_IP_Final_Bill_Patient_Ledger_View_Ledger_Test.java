...
public class ADT_Req_Patient_Deposit_Refund_IP_Final_Bill_Patient_Ledger_View_Ledger_Test 
{
	...
	@Test(priority=2)
	@Parameters ({"PrimaryIdNumber12","PatientNamePar","ExpiryDatePar","DOBPar","MobilePar","EmailPar","DOAPar","LengthPar","NotesPar","RemarksPar"})
	public void TC_02_User_Able_To_Do_AdmissionRequestform(String PrimaryIdNumber12,String PatientNamePar,String ExpiryDatePar,String DOBPar,String MobilePar,String EmailPar,String DOAPar,String LengthPar,String NotesPar,String RemarksPar) throws InterruptedException, IOException
	{
		BillingPages_2.ADTRequestForm ADT=new BillingPages_2.ADTRequestForm(driver);
		ADT.ADTFORREQUEST(PrimaryIdNumber12,PatientNamePar,ExpiryDatePar,DOBPar,MobilePar,EmailPar,DOAPar,LengthPar,NotesPar,RemarksPar);
	}
	...
	@Test(priority=5)
		public void TC_05_Verify_Taht_User_is_Able_To_Add_Deposit_Against_Patient_Save_refund_View_Ledger() throws InterruptedException, IOException 
	{
		BillingPages_2.ADT_Req_Patient_Deposit_Refund_IP_Final_Bill_Patient_Ledger_View_Ledger IP=new BillingPages_2.ADT_Req_Patient_Deposit_Refund_IP_Final_Bill_Patient_Ledger_View_Ledger(driver);
		IP.IPD_Patient_Deposit_Add_Agains_Patient_Save_Refund_VIew_Ledgere();	  
	} 
	@BeforeTest
	public void startBrowser() throws ATUTestRecorderException 
	{ 
		recorder = new ATUTestRecorder(".//Videos//","ADT_Req_Patient_Deposit_Refund_IP_Final_Bill_Patient_Ledger_View_Ledger_Test-"+dateFormat.format(date),false);
		recorder.start();   
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADT_Req_Patient_Deposit_Refund_IP_Final_Bill_Patient_Ledger_View_Ledger_Test-.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
