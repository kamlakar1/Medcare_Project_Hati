...
public class ADTRequested_save_Admission_Deposit_Add_against_patient_Save_Test 
{
	...
	{ 
		recorder = new ATUTestRecorder(".//Videos//","ADTRequested_save_Admission_Deposit_Add_against_patient_Save_Test"+dateFormat.format(date),false);
		recorder.start();   
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_ADTRequested_save_Admission_Deposit_Add_against_patient_Save_Test.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
