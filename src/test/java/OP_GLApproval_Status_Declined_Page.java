...
public class OP_GLApproval_Status_Declined_Page {
...
//---GLStatus---//
		...
		//StatusSelect
		By StatusSelect=By.xpath("//span[contains(text(),'DECLINED GL')]");
...
//ContactInformation 
		...
		public OP_GLApproval_Status_Declined_Page (WebDriver driver)
  ...
  
  {
	  ...
	  driver.findElement(GLSave).click();
	     ...
	     FileUtils.copyFile(screenshot3,new File(".//ScreenShots//OP_GLApproval_Status_Declined_Test.png"));
	     Thread.sleep(3000);
      ...
      FileUtils.copyFile(screenshot1, new File(".\\ScreenShots\\OP_GLApproval_Status_Declined_Test.png"));
