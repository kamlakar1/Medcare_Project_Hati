...
public class ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice 
{
	WebDriver driver;
	...
	public void IPCharges_IPD_BIll_Outstanding_Invoice_Cancel_Invoice() throws InterruptedException, IOException
	{
	...
	public ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice(WebDriver driver)
	{
		this.driver=driver;
	}
}
