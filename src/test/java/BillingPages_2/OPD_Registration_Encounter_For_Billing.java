...
public class OPD_Registration_Encounter_For_Billing 
{
	...
	By doctoropts=By.xpath("//span[contains(text(),'DATO DR PHIL OSMAN')]");
	...
	public void Encounter_updated(String EncounterRemarksPar,String AddNotesPar,String NamePar,String IdentificationNOPar,String PhoneNoPar,String AddressPar,String PostcodeParAdetailsPar) throws InterruptedException, IOException, AWTException 
	{
		//Encounter details
	...
	driver.findElement(ReferralRemarks12).sendKeys(ReferralRemarksPar);*/
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("mat-icon[ng-reflect-message='Add Referral']")).click();
