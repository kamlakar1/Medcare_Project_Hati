...
public class ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_Bill 
{
	WebDriver driver;
...
//MRN
	...
	public void ADT_REQ_IPD_BIll_FullSettelment_Billing_Summary_VIew_Bill()throws InterruptedException, IOException
	{
		...
		//Clicking on Row Bill Details 
		Thread.sleep(3000);
		driver.findElement(RowBillDetailsClick).click();  
		//View Bill Click
		Thread.sleep(3000);
		driver.findElement(ViewBillClick).click();  
	...
	public ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_Bill(WebDriver driver)
	{
		this.driver=driver;
	}
}
