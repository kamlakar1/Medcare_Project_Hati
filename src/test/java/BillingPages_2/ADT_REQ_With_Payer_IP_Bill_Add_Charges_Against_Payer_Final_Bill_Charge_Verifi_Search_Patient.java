...
public class ADT_REQ_With_Payer_IP_Bill_Add_Charges_Against_Payer_Final_Bill_Charge_Verifi_Search_Patient {
	...
	//advanced search
	By AdvancedSearchClick3=By.xpath("mat-icon[ng-reflect-message='Expand']");
	//MRN 
