...
public class ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_History 
{
	WebDriver driver;
	...
	//VIew History
		By HistoryViewClick=By.cssSelector("mat-icon[ng-reflect-message='History']");
		
		
		public void ADT_REQ_IPD_BIll_FullSettelment_Billing_Summary_VIew_History()throws InterruptedException, IOException
	{
		...
		//History view click
		Thread.sleep(3000);
		driver.findElement(HistoryViewClick).click(); 
		

		File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot4, new File(".//ScreenShot//History_view.png"+ dateFormat.format(date)));
		

	}
	public ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_View_History(WebDriver driver)
	{
		this.driver=driver;
	}
}
