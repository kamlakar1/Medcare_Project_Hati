...
public class ADT_Req_Insurance_IP_Charges_Charge_Conversion_Self_To_Insurance 
{
	WebDriver driver;
	...
	//FromPayerSelect
	By FromPayerSelect=By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[2]/span");
	
	//ToPayerClick
	By ToPayerClick=By.cssSelector("mat-select[placeholder='Select To Payer']");
	
	//ToPayerSelect
	By ToPayerSelect=By.xpath("//span[contains(text(),'AIA Berhad')]");
	...
	public void IPChargesForSelandInsurance_With_Charge_ConversionSelftoINsurance() throws InterruptedException, IOException
	{
	...
	public ADT_Req_Insurance_IP_Charges_Charge_Conversion_Self_To_Insurance(WebDriver driver)
	{
		this.driver=driver;
	}
}
