...
public class ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_Reprint_Invoice 
{
	WebDriver driver;
	...
	//Invoice Slip
		...
		public void ADT_REQ_IPD_BIll_FullSettelment_Billing_Summary_Invoice_Reprint()throws InterruptedException, IOException
	{
		...
		FileUtils.copyFile(screenshot4, new File(".//ScreenShot//Invoice_Reprint_view.png"+ dateFormat.format(date)));
		

	}
	public ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_Reprint_Invoice(WebDriver driver)
	{
		this.driver=driver;
	}
}
