...
public class HSC_Package 
{
	...
	//ECH Package
	By HSCPackageClick=By.xpath("//span[contains(text(),'HSC Package')]");
	//Add new
	...
	By PackageServiceNameSelOpt=By.xpath("//span[contains(text(),' Angiography – Aorta Thoracic')]");
	...
	By ServiceNameSelOpt=By.xpath("/html/body/div[2]/div/div/div/mat-option[4]/span");

	//Service Name
	By ServiceNameClcik1=By.cssSelector("input[ng-reflect-placeholder='Service Name']");
	By ServiceNameSelOpt1=By.xpath("/html/body/div[2]/div/div/div/mat-option[2]/span");
	...
	public void HSCPackage(String MinAgePar,String MaxAgePar, String StartDatePar, String EndDatePar) throws InterruptedException 
	{
		...
		//ECH Package
		Thread.sleep(4000);
		driver.findElement(HSCPackageClick).click();
		...
		Thread.sleep(2000);
		driver.findElement(ServiceNameClcik).sendKeys("Hae");
		Thread.sleep(2000);
		...
		Thread.sleep(4000);
		driver.findElement(ServiceNameClcik1).sendKeys("Lap");
		Thread.sleep(2000);
		driver.findElement(ServiceNameSelOpt1).click();
	...
	public HSC_Package(WebDriver driver)
	{
		this.driver=driver;
	}
}
