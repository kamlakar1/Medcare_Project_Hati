...
public class ADTRequestedForm_IPcharge_IP_Bill_Partial_Settlement_for_Op_To_IP 
{
	...
	public void IPCharges_IPD_BIll_Partial_Settlement() throws InterruptedException, IOException
	{
		...
		Thread.sleep(10000);
		WebElement MRN1=driver.findElement(By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-admission-dashboard/mat-drawer-container[2]/mat-drawer-content/div/table/tbody/tr/td[2]"));
