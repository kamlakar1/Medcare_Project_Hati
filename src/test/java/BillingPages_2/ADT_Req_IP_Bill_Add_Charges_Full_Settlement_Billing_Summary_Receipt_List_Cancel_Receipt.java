...
public class ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Receipt_List_Cancel_Receipt 
{
	WebDriver driver;
	...
	//Invoice Slip
		...
		//Receipt List 
		By ReceiptClick=By.cssSelector("div[id='mat-tab-label-4-2']");
		...
		public void ADT_REQ_IPD_BIll_FullSettelment_Billing_Summary_Receipt_List_Cancel_Receipt()throws InterruptedException, IOException
	{
	...
	public ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Receipt_List_Cancel_Receipt(WebDriver driver)
	{
		this.driver=driver;
	}
}
