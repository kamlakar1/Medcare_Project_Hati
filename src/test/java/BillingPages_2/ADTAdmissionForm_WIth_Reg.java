...
public class ADTAdmissionForm_WIth_Reg 
{
	...
	//Select Bed
	By BedClick=By.xpath("//span[contains(text(),'WW3-A')]");
...
*/
		...
		FileUtils.copyFile(screenshot, new File("C:\\Selenium Eclipse WorkSpace\\Medcare_Hati\\ScreenShot\\ADTAdmissionForm.png"));  
		...
		//Get the list of window handles
	      ...
	      else
	      {
		    ...
		    //ScreenShot6
		      ...
		      FileUtils.copyFile(screenshot6,new File("C:\\Selenium Eclipse WorkSpace\\Medcare_Hati\\ScreenShot\\AdmissionRequest6.png"));
	        ...
	        //ScreenShot7
		      ...
		      FileUtils.copyFile(screenshot7,new File("C:\\Selenium Eclipse WorkSpace\\Medcare_Hati\\ScreenShot\\ScreenShots\\AdmissionRequest7.png"));
