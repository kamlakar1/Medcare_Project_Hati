...
public class OPD_REG_Deposit_Refund_against_patient_Billing_summary_Cancel_Refund
{
	WebDriver driver;
	//----QuickRegistration---//
	...
	public OPD_REG_Deposit_Refund_against_patient_Billing_summary_Cancel_Refund(WebDriver driver)
	{
		this.driver=driver;
	}
	public void OPD_Patient_Deposit_Add_Agains_Patient_Save_Refund_Cancel_Refund() throws InterruptedException, IOException
	{
		...
		//...Cancel Refund.....//
				...
				FileUtils.copyFile(screenshot1, new File(".//ScreenShot//OPD_REG_Deposit_Refund_against_patient_Billing_summary_Cancel_Refund"+ dateFormat1.format(date)));
