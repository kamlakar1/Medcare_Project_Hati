...
public class ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_Send_Email 
{
	WebDriver driver;
	...
	By MRNDashClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-admission-dashboard/mat-drawer-container/mat-drawer-content/div/table/tbody/tr[1]/td[2]");
	//IP Charges
	...
	//Send Email
	By SendEmailClick=By.cssSelector("mat-icon[ng-reflect-message='Send Mail']");
	//Too Email
	By TooEmailClick=By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-compose-mail-dialog/div[2]/div[1]/mat-form-field/div/div[1]/div/mat-chip-list/div/input");
	//Send Button
	By SendBtnClick=By.cssSelector("button[id='btnSend']");
	public void ADT_REQ_IPD_BIll_FullSettelment_Billing_Summary_Send_Email()throws InterruptedException, IOException
	{
		...
		Thread.sleep(8000);
		WebElement MRN1=driver.findElement(MRNDashClick);
		...
		//Row Bill Details Click
		Thread.sleep(3000);
		driver.findElement(RowBillDetailsClick).click();  

		//Send Email Click
		Thread.sleep(3000);
		driver.findElement(SendEmailClick).click();  

		//Too Email Click
		Thread.sleep(4000);
		driver.findElement(TooEmailClick).sendKeys("manisha@hatiintl.com");
		
		//Click on Send Button
		Thread.sleep(3000);
		driver.findElement(SendBtnClick).click(); 
	...
	public ADT_Req_IP_Bill_Add_Charges_Full_Settlement_Billing_Summary_Select_Patient_Send_Email(WebDriver driver)
	{
		this.driver=driver;
	}
}
