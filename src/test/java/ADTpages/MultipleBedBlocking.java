...
public class MultipleBedBlocking 
{
	...
	By WardSelOpt=By.xpath("//div[@role='listbox']/mat-option[3]");
    ...
    By Checkbox_2 = By.xpath("/html/body/div[5]/div[2]/div/mat-dialog-container/app-bed-selection/div/div[2]/div/div/div/table/tbody/tr/td[1]/mat-checkbox");

	//Save Button
	//By SaveClick1=By.xpath("");
	...
	By NextTimeWardSel=By.xpath("//div[@role='listbox']/mat-option[3]");
	//Tab Bed Block
