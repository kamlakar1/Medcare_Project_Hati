...
public class NewAdmissionWithVIPPatient_NewIC 
{
	...
	//VIP
	By VIP=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-patient-registration/div[3]/form/div[1]/div/div[2]/div[1]/mat-checkbox/label/span[1]/span[2]");
	...
	public void AdmissionWithVIPPatientNewIC(String PriNumberPar, String PatientNamePar,String MobilePar,String EmailPar,String LengthPar,String RegAddressPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException 

	{
		...
		//Adding Name
		Thread.sleep(3000);
		WebElement kk = driver.findElement(NameClick);



		//Actions actions = new Actions(driver);
		act.moveToElement(kk).click().sendKeys(NamePar).perform();
