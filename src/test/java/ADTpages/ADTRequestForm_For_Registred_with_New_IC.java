...
public class ADTRequestForm_For_Registred_with_New_IC 
{
	...
	public void ADT_Request_Registered_With_NEW_IC(String MRNPar,String EmailPar, String DOAPar, String LengthPar, String NotesPar, String RemarksPar) throws InterruptedException, IOException
	{
		...
		driver.findElement(Save).click();
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("mat-icon[ng-reflect-message='Yes']")).click();
		driver.findElement(By.cssSelector("mat-icon[ng-reflect-message='Yes']")).click();
	...
	public void ADT_Request_Registered_With_passport_IC(String MRNPar,String EmailPar, String DOAPar, String LengthPar, String NotesPar, String RemarksPar) throws InterruptedException, IOException
	{
		...
		Long id=d.getTime();
		Thread.sleep(2000);
		driver.findElement(PriNumber).sendKeys("123"+id);
		

		//Name
		Thread.sleep(2000);
		driver.findElement(Name).sendKeys("jamal");

		//ExpiryDate
		Thread.sleep(2000);
		driver.findElement(ExpiryDate).sendKeys("23/07/2026");
		...
		//DOB
		Thread.sleep(2000);
		driver.findElement(DOB).sendKeys("23/07/2026");

		//Mobile 
		Thread.sleep(2000);
		driver.findElement(Mobile).sendKeys("987654567");
*/
		//Email
		Thread.sleep(2000);
		driver.findElement(Email).sendKeys(EmailPar);
	...
	public ADTRequestForm_For_Registred_with_New_IC (WebDriver driver)
