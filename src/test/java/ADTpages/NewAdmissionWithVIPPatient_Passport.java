...
public class NewAdmissionWithVIPPatient_Passport 
{
	...
	public void AdmissionWithVIPPatient(String PriNumberPar, String PatientNamePar,String MobilePar,String EmailPar,String LengthPar,String RegAddressPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		//ExipryDate
		Thread.sleep(3000);
		driver.findElement(Expirydate).sendKeys("24/07/2026");
		...
		//DOB
		Thread.sleep(3000);
		driver.findElement(DOB).sendKeys("23/07/1990");
