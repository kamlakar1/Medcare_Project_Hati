...
public class ADT_Request_Form_For_NEW_IC 
{
	...
	By Priselect=By.xpath("//span[contains(text(),'New IC')][1]");
	
	By Priselect_3=By.xpath("//span[contains(text(),'Old IC')][1]");

	By Priselect_2=By.xpath("//span[contains(text(),'Old IC')][1]");
	...
	By mat = By.xpath("//span[contains(text(),'+255')]");

	public void ADT_Admission_request_With_NEW_IC(String PriNumberPar, String PatientNamePar, String DOBPar, String MobilePar, String EmailPar, String DOAPar, String LengthPar, String NotesPar, String RemarksPar) throws InterruptedException, IOException
	{
		Thread.sleep(2000);
		...
		driver.findElement(AdmDepsearch).sendKeys("General Medicine");
	...
	public ADT_Request_Form_For_NEW_IC (WebDriver driver)
	...
	public void ADT_Admission_request_With_old_IC(String PriNumberPar, String PatientNamePar, String DOBPar, String MobilePar, String EmailPar, String DOAPar, String LengthPar, String NotesPar, String RemarksPar) throws InterruptedException, IOException
	{
		...
		driver.findElement(Priselect_3).click();
	...
	public void ADT_Admission_request_With_oldd_IC(String PriNumberPar, String PatientNamePar, String DOBPar, String MobilePar, String EmailPar, String DOAPar, String LengthPar, String NotesPar, String RemarksPar) throws InterruptedException, IOException
	{
		Thread.sleep(2000);
		Actions act = new Actions(driver);
		Thread.sleep(2000);
