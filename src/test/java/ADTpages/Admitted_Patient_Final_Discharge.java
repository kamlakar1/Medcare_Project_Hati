...
//-----Billing----//
   ...
   //ViewBill
   By ViewBill=By.cssSelector("mat-icon[ng-reflect-message='View Bill']");
   
   //IsFinal
   By IsFinal=By.cssSelector("mat-checkbox[ng-reflect-name='isFinalBill']");
   
   //FinalSave
   By FinalSave=By.cssSelector("mat-icon[ng-reflect-message='Save']");
   
   //BillConfirm
   By BillConfirm=By.cssSelector("mat-icon[ng-reflect-message='Yes']");
   ...
   //AdmissionDash
   By AdmissionDash=By.cssSelector("a[ng-reflect-router-link='admission-dashboard-new']");
   
   //FinalDischargeIcon
   By FinalDischargeIcon=By.cssSelector("img[ng-reflect-message='Final Discharge']");
   
   //FinalRemarks 
   By FinalRemarks=By.xpath("/html/body/div[5]/div[2]/div/mat-dialog-container/app-remark-dialog/div/div/div[2]/mat-grid-list/div/mat-grid-tile[2]/div/mat-form-field/div/div[1]/div[3]/textarea");
	  ...
	  driver.findElement(SearchClick12).click();
	    ...
	    //----ClinicalDischarge---//
		 ...
		 //----Billing----//
		      ...
		      //IsFinal
		      Thread.sleep(10000);
		      driver.findElement(IsFinal).click();
		      
		      //FinalSave
		      Thread.sleep(3000);
		      driver.findElement(FinalSave).click();
		      
		      //BillConfirm
		      Thread.sleep(3000);
		      driver.findElement(BillConfirm).click();
		    ...
		    //AdmissionDash
				Thread.sleep(3000);
				driver.findElement(AdmissionDash).click();
			...
			//FinalDischargeIcon
				Thread.sleep(3000);
				driver.findElement(FinalDischargeIcon).click();
