...
public class ADTAdmissionFormwith_Convert_Charges_OP_To_IP 
{
	...
	By TypeOfAdmissionSelopt=By.xpath("//div[@role='listbox']/mat-option[3]");

	//Reason for admission
	By ReasonForAdmissionClick=By.cssSelector("mat-select[ng-reflect-name='reasonForAdmission']");
	By ReasonForAdmissionSelOpt=By.xpath("//div[@role='listbox']/mat-option[3]");
	...
	//Assigned Bed
	//Click on Add button
	By AddButtonClick=By.xpath("//a//mat-icon[@ng-reflect-message='Add'][1]");
	                            ///html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-admission-form/mat-drawer-container/mat-drawer-content/div/div[1]/div[1]/div[2]/div[2]/div[1]/b/a[1]/mat-icon
	//Select ward
	...
	By TariffSelOpt=By.xpath("//span[contains(text(),'Foriegn Tariff')]");
	...
	//MRN                            /html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-admission-form/mat-drawer-container/mat-drawer-content/div/div[1]/div[1]/div[2]/div[2]/div[1]/b/a[1]/mat-icon
	...
	By Registration=By.xpath("//span[contains(text(),'Registration')]");
	...
	By EncounterList=By.cssSelector("a[ng-reflect-router-link='patient,patient-encounter-list']");
	...
	public void ADT_Admission_Form_Convert_Charges(String LengthOfStayPar,String AdmittingDiagPar,String AddNotesPar,String PatientNotesPar,String AdmissionRemarksPar,String ReferralRemarksPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar) throws InterruptedException, IOException
	{
		...
		Thread.sleep(7000);
		driver.findElement(By.id("200102")).click();
		...
		Thread.sleep(5000);
		WebElement MRN1=driver.findElement(By.xpath("//tbody[@role='rowgroup']/tr[2]/td[1]"));
...
*/
		Thread.sleep(5000);
		driver.findElement(By.cssSelector("mat-icon[ng-reflect-message='Close']")).click();
...
*/
		...
		Thread.sleep(2000);
		driver.findElement(By.cssSelector("mat-icon[ng-reflect-message='Add new kin']")).click();
		Thread.sleep(2000);
		//Tab3 Documents
