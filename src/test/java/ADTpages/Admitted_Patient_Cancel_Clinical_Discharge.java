...
public class Admitted_Patient_Cancel_Clinical_Discharge 
{
	...
	//SpecilitySel
	By Specilitysel=By.xpath("//span[contains(text(),'General Medicine')]");
	...
	//ReasonSelect
	By ReasonSelect=By.xpath("//span[contains(text(),' Clinical Discharge Cancellation ')]");
	...
	By CountruMObile = By.cssSelector("mat-select[ng-reflect-name='countryCode']");
...

	{
		...
		//CountryCode
		Thread.sleep(3000);
		driver.findElement(CountruMObile).click();
