...
public class Book_Reschedule_ExistingAppointment_against_Department {
    ...
    By appointmenttype = By.xpath("/html/body/div[6]/div[2]/div/div/div/mat-option[3]/span");
...
By DATODRPHILOSMAN  = By.xpath("//span//b[contains(text(),'DATO DR PHIL OSMAN')]");
	...
	public void ExitingAppontmetfunc(String AppointmenttypeA, String consultationA, String specialityA, String EmailA, String WorkcontctA, String HomecontactA, String RemarksA) throws InterruptedException, AWTException, IOException {
		...
		ArrayList<Object> tabss = new ArrayList<Object> (driver.getWindowHandles());
		Thread.sleep(2000);
		driver.switchTo().window((String) tabss.get(2));
		Thread.sleep(7000);
