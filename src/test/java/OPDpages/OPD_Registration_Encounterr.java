...
public class OPD_Registration_Encounterr {
	...
	public OPD_Registration_Encounterr(WebDriver driver) {
		this.driver= driver;
	}
	...
	public void Encounter(String EncounterRemarksPar,String AddNotesPar,String NamePar,String IdentificationNOPar,String PhoneNoPar,String AddressPar,String PostcodeParAdetailsPar) throws InterruptedException, IOException, AWTException
	{
		...
		{
			System.out.println("Checkin for existing appointment has been redirected to the  Encounter Details page"); 
		} else 
		{
			System.out.println("Redirecting to the Encounter Details page for existing appointment failed"); 
		}
...
actions1.keyDown(Keys.CONTROL).sendKeys(Keys.END).perform(); */
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Departmet_existing_appointment_Encounterdetails.png"));
...
driver.findElement(CityNSelOpt).click();*/
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Departmet_existing_appointment_NextOfKindetails.png"));
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShots//Departmet_existing_appointment_Uploaddocs.png"));
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Departmet_existing_appointment_OpdRegusterationEncounter.png"));
