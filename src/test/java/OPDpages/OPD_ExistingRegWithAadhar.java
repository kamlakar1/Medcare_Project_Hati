...
public class OPD_ExistingRegWithAadhar
{
	...
	By PrimaryIdentificationselOpt=By.xpath("//span[contains(text(),'Aadhaar Card')]");
	...
	//	Thread.sleep(20000);
		...
		Thread.sleep(1000);
		driver.findElement(AllDropDownSearch).sendKeys("Aadhaar Card");
		Thread.sleep(1000);
	...
	//	driver.findElement(GenderSelOpt).click();
		...
		/*
		 * //Scrolling the web page Thread.sleep(2000); Actions actions = new
