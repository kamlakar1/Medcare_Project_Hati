...
public class OPD_ExistingRegWithPAN
{
	...
	By PrimaryIdentificationselOpt=By.xpath("//span[contains(text(),'PAN')]");
	...
	{	  
		...
		Thread.sleep(1000);
		driver.findElement(AllDropDownSearch).sendKeys("PAN");
		Thread.sleep(1000);
