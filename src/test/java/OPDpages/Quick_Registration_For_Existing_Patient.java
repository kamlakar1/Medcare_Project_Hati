...
public class Quick_Registration_For_Existing_Patient 
{
	...
	public void Quick_Registration_With_Existing(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException 
	{
		...
		ArrayList<Object> tabs554 = new ArrayList<Object> (driver.getWindowHandles());
		Thread.sleep(2000);
		driver.switchTo().window((String) tabs554.get(2));
		//SideBAR
		Thread.sleep(3000);
		...
		ArrayList<Object> tabs5544 = new ArrayList<Object> (driver.getWindowHandles());
		Thread.sleep(2000);
		driver.switchTo().window((String) tabs5544.get(3));
		...
		ArrayList<Object> tabs244 = new ArrayList<Object> (driver.getWindowHandles());
		Thread.sleep(2000);
		driver.switchTo().window((String) tabs244.get(02));
