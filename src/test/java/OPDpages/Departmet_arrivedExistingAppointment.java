...
public class Departmet_arrivedExistingAppointment {
	...
	public Departmet_arrivedExistingAppointment(WebDriver driver) {
		this.driver= driver;
	...
	public void Appointmentarrivedfunc() throws InterruptedException, AWTException, IOException {
		...
		{
			System.out.println("Department existing :- Booked Existing appointment status has been changed to Arrived succesfully"); 
		} else 
		{
			System.out.println(" Department existing :- Booked Existing appointment status not changed to Arrived succesfully"); 
		}
		File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Department_existing_appoint_arrived.png"));
