...
public class arrivedExistingAppointment {
	...
	public arrivedExistingAppointment(WebDriver driver) {
		this.driver= driver;
	...
	public void Appointmentarrivedfunc() throws InterruptedException, AWTException, IOException {
		...
		{
			System.out.println("Booked Existing appointment status has been changed to Arrived succesfully"); 
		} else 
		{
			System.out.println("Booked Existing appointment status not changed to Arrived succesfully"); 
		}
		File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Departmet_existing_appointment_ArrivedExistingAppointment.png"));
