...
public class Quick_Registration_With_NEW_IC 
{
	...
	public void Quick_Registration_Verification_With_New_IC(String QuickPrimaryIdNumberPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException 
	{
     ...
     index++;
		...
		//Selecting Counter
		/*
		 * Thread.sleep(1000); driver.findElement(Counterclick).click();
		 * Thread.sleep(1000);
