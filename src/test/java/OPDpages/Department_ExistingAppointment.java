...
public class Department_ExistingAppointment {
	...
	By searchh = By.cssSelector("mat-icon[ng-reflect-message='Expand']");
	By Collapse = By.cssSelector("input[placeholder='Search']");
	...
	By appointmettype = By.xpath("/html/body/div[6]/div[2]/div/div/div/mat-option[4]/span");
	...
	public void ExitingAppontmetfunc(String AppointmenttypeA, String consultationA, String specialityA,String EmailA, String WorkcontctA, String HomecontactA, String RemarksA) throws InterruptedException, AWTException, IOException {
		...
		WebElement APPOINTMENTt1 = wait.until(ExpectedConditions.elementToBeClickable(APPOINTMENTt));
		APPOINTMENTt1.click();
	...
	//	driver.findElement(Next).click();
		...
		WebElement searchh1 = wait.until(ExpectedConditions.elementToBeClickable(searchh));
		searchh1.click();
		...
		WebElement clickonsearch1 = wait.until(ExpectedConditions.elementToBeClickable(clickonsearch));
		clickonsearch1.click();
	//	driver.findElement(clickonsearch).click();
		WebElement radiobuttonr1 = wait.until(ExpectedConditions.elementToBeClickable(radiobuttonr));
		radiobuttonr1.click();
	...
	//	driver.findElement(Email).clear();
		WebElement Email3= wait.until(ExpectedConditions.elementToBeClickable(Email));
		Email3.sendKeys(EmailA);
