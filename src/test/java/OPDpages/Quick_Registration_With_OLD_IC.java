...
public class Quick_Registration_With_OLD_IC 
{
	WebDriver driver=null; 
	public Quick_Registration_With_OLD_IC(WebDriver driver) 
	{
		this.driver=driver;
	...
	public void Quick_Registration_Verification_With_OLD_IC(String QuickPrimaryIdNumberPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException 
	{
		...
		//Clicking on DOB
		Thread.sleep(1000);
		driver.findElement(DOBclick).sendKeys("12/02/1991");
		//Country Code
		Thread.sleep(1000);
		...
		{
			System.out.println("Showing Encounter List"); 
		} else 
		{
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShots//QuickRegEncounterListForNewIC.png"));
