...
public class Quick_Registration_For_Existing_Patient_with_Army 
{
	WebDriver driver=null; 
	public Quick_Registration_For_Existing_Patient_with_Army(WebDriver driver) 
	{
		this.driver=driver;
	...
	By Primaryidselectvalue=By.xpath("//span[contains(text(),'Army')]");
...
*/
		...
		//Clicking on Gender
		/*
		 * Thread.sleep(500); driver.findElement(Genderclick).click();
		 * Thread.sleep(500); driver.findElement(AllDropDownSearch).sendKeys("FEMALE");
		 * Thread.sleep(500); driver.findElement(Genderselectvalue).click();
		 */
		//Clicking on DOB
		Thread.sleep(500);
