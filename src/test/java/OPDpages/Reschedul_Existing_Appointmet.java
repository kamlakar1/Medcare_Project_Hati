...
public class Reschedul_Existing_Appointmet {
	...
	By opd2 = By.xpath("/html/body/div[6]/div[2]/div/div/div/div/div[1]/div[1]/div[1]/div/img");
	...
	By DATODRPHILOSMAN  = By.xpath("//div[@class='div-doctor-list'][1]/ul/li[3]/span/button");
...
/*
	...
	*/
		 ...
		 * rb.delay(900);
		 * 
		 * // Copy your image path String projectpath = System.getProperty("user.dir");
		 * StringSelection ss = new StringSelection(projectpath +
		 * "\\image\\kk.png.png");
		 ...
		 * 
		 * // Release the image path rb.keyRelease(KeyEvent.VK_CONTROL);
		 * rb.keyRelease(KeyEvent.VK_V);
		 * 
		 * //Enter and release rb.keyPress(KeyEvent.VK_ENTER);
		 * rb.keyRelease(KeyEvent.VK_ENTER); Thread.sleep(900);
	

		driver.findElement(GenderOpt).click();
		Thread.sleep(900);
		driver.findElement(Gendesend).sendKeys("MALE");
		Thread.sleep(900);
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath("//div[@role='listbox']/mat-option[2]")).click();
		Thread.sleep(4000);
