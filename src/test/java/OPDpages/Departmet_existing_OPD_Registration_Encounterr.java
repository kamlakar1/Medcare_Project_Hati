...
public class Departmet_existing_OPD_Registration_Encounterr {
	...
	By DoctorSelOpt=By.xpath("//span[contains(text(),'Ram Patil')]");
	//Clinic
	...
	public Departmet_existing_OPD_Registration_Encounterr(WebDriver driver) {
		this.driver= driver;
	}
	...
	public void Encounter(String EncounterRemarksPar,String AddNotesPar,String NamePar,String IdentificationNOPar,String PhoneNoPar,String AddressPar,String PostcodeParAdetailsPar) throws InterruptedException, IOException, AWTException
	{
		...
		{
			System.out.println("Department existing:- Checkin for existing appointment has been redirected to the  Encounter Details page"); 
		} else 
		{
			System.out.println("Department existing:- Redirecting to the Encounter Details page for existing appointment failed"); 
		}
		...
		Thread.sleep(1000);
		driver.findElement(Search).sendKeys("Ram");
		Thread.sleep(1000);
		driver.findElement(DoctorSelOpt).sendKeys(Keys.ENTER);
		*/
		Thread.sleep(1200);
		driver.findElement(DoctorClick).click();
		Thread.sleep(1200);
...
actions1.keyDown(Keys.CONTROL).sendKeys(Keys.END).perform(); */
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Department_existing_appoint_Encounterdetails.png"));
...
driver.findElement(CityNSelOpt).click();*/
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Department_existing_appoint_NextOfKindetails.png"));
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShots//Department_existing_appoint_Uploaddocs.png"));
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Department_existing_appoint_OpdRegusterationEncounter.png"));
