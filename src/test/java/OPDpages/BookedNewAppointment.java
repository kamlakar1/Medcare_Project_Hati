...
public class BookedNewAppointment {
	...
	public BookedNewAppointment(WebDriver driver) {
		this.driver= driver;
	...
	public void Appointmentarrivedfunc(String PatientNameA) throws InterruptedException, AWTException, IOException {
		...
		{
			System.out.println("New appointment has been changed successfully status is booked"); 
		} else 
		{
			System.out.println("New appointment not been booked"); 
		}

		File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//BookedNewAppointment.png"));
