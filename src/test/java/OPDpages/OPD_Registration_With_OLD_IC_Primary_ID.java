...
public class OPD_Registration_With_OLD_IC_Primary_ID
{
...
*/
	...
	//	driver.findElement(OkDialog).click();
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OPDRegistrationWithOLDIC.png"));
