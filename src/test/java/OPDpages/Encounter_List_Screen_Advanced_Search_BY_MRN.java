...
public class Encounter_List_Screen_Advanced_Search_BY_MRN 
{
	...
	//By Search=By.xpath("mat-icon[mattooltip='Search']");
		...
		By MRNL=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-patient-encounter-list/mat-drawer-container/mat-drawer-content/div/table/tbody/tr[1]/td[1]");
