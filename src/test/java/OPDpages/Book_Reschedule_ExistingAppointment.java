...
public class Book_Reschedule_ExistingAppointment {
	...
	By radiobuttonr =By.xpath("//tbody[@role='rowgroup']/tr/td[1]");
	...
	//By Serach = By.xpath("/html/body/div[9]/div[2]/div/mat-dialog-container/app-appointment-quick-search/div[2]/form/mat-grid-list[4]/div/mat-grid-tile[3]/div/button");
	//By selectAppointment = By.xpath("/html/body/div[6]/div[2]/div/mat-dialog-container/app-appointment-quick-search/div[2]/div[1]/table/tbody/tr[1]/td[1]");
	...
	By doctpr = By.xpath("//mat-option//span[contains(text(),'Doctor')]");
	By DATODRPHILOSMAN  = By.xpath("//span//b[contains(text(),'DATO DR PHIL OSMAN')]");
	...
	public void ExitingAppontmetfunc(String AppointmenttypeA, String consultationA, String specialityA, String EmailA, String WorkcontctA, String HomecontactA, String RemarksA) throws InterruptedException, AWTException, IOException {
		...
		ArrayList<Object> tab_s = new ArrayList<Object> (driver.getWindowHandles());
		Thread.sleep(2000);
		driver.switchTo().window((String) tab_s.get(2));
		Thread.sleep(2000);
		...
		driver.findElement(doctpr).click();
		 ...
		 * image=driver.findElement(UploadImhe);
		 * action.moveToElement(image).click().perform(); Robot rb = new Robot();
		 * rb.delay(900); // Copy your image path
		 * 
		 * String projectpath = System.getProperty("user.dir"); StringSelection ss = new
		 * StringSelection(projectpath + "\\image\\kk.png.png");
		 * Toolkit.getDefaultToolkit().getSystemClipboard().setContents(ss, null);
		 * //Paste you image path rb.keyPress(KeyEvent.VK_CONTROL);
		 * rb.keyPress(KeyEvent.VK_V); // Release the image path
		 * rb.keyRelease(KeyEvent.VK_CONTROL); rb.keyRelease(KeyEvent.VK_V); //Enter and
		 * release rb.keyPress(KeyEvent.VK_ENTER); rb.keyRelease(KeyEvent.VK_ENTER);
		 * Thread.sleep(900);
		
		
		driver.findElement(gender).click();
		Thread.sleep(900);
		driver.findElement(genderinput).sendKeys("MALE");
		Thread.sleep(900);
