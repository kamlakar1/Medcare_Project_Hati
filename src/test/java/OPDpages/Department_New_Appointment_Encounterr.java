...
public class Department_New_Appointment_Encounterr {
	...
	public Department_New_Appointment_Encounterr(WebDriver driver) {
		this.driver= driver;
	}
...
actions1.keyDown(Keys.CONTROL).sendKeys(Keys.END).perform(); */
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//New_appointment_department_Encounterdetails.png"));
...
driver.findElement(CityNSelOpt).click();*/
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//New_appointment_department_NextOfKindetails.png"));
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShots//New_appointment_department_Uploaddocs.png"));
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//New_appointment_department_OpdRegusterationEncounter.png"));
