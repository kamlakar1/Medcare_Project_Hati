...
public class Book_Existing_appointment_against_doctor_Quick_Registration 
{
	...
	public  void Quick_Registration_Verificationn(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException 
	{   
		...
		System.out.println("Print the patient name" + EnterPatientName);
				...
				Thread.sleep(5000);
				WebElement overforopdslide91=driver.findElement(SideBarMenu);
				act.moveToElement(overforopdslide91).build().perform();
				Thread.sleep(5000);
