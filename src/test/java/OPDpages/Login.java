...
public void login_Medcare_1() throws InterruptedException, IOException, AWTException {
...
public void login_Medcare_3() throws InterruptedException, IOException, AWTException {
	...
	driver.findElement(tab1).sendKeys("1");
	driver.findElement(tab2).sendKeys("0");
	driver.findElement(tab3).sendKeys("7");
	driver.findElement(tab4).sendKeys("2");
	driver.findElement(tab5).sendKeys("1");
	driver.findElement(tab6).sendKeys("0");
	driver.findElement(tab7).sendKeys("7");
	driver.findElement(tab8).sendKeys("2");
