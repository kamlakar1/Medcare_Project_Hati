...
public class Reschedule_existing_appointment_against_depsrt_Quick_Registration 
{

	WebDriver driver=null; 
	public Reschedule_existing_appointment_against_depsrt_Quick_Registration(WebDriver driver) 
	{
		this.driver=driver;
