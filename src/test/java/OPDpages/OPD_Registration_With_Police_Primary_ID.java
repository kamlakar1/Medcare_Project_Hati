...
public class OPD_Registration_With_Police_Primary_ID 
{
...
//Tab3 Health Tourist details
	...
	By AgentIdentificationTypeSelOpt=By.xpath("/html/body/div[5]/div[2]/div/div/div/mat-option[3]");
	...
	//	Thread.sleep(20000);
		...
		/*
		 * //Race Thread.sleep(1000); driver.findElement(RaceClick).click();
		 * //Thread.sleep(1000);
...
*/
		...
		FileUtils.copyFile(screenshot, new File("C:\\Selenium Eclipse WorkSpace\\Medcare_Hati\\ScreenShot\\OPDRegistration.png"));  
