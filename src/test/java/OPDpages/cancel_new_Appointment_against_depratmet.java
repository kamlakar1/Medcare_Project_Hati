...
public class cancel_new_Appointment_against_depratmet {
	...
	//ReasonSelect
	By ReasonSelect=By.xpath("//span[contains(text(),'Appointment Cancellation')]");
	...
	public cancel_new_Appointment_against_depratmet (WebDriver driver)
