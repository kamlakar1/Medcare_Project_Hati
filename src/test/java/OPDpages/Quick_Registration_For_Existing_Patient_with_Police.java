...
public class Quick_Registration_For_Existing_Patient_with_Police 
{
	WebDriver driver=null; 
	public Quick_Registration_For_Existing_Patient_with_Police(WebDriver driver) 
	{
		this.driver=driver;
	...
	By Primaryidselectvalue=By.xpath("//span[contains(text(),'Police')]");
	...
	//Tariff
	By Tariffclick12=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-sample-patient-registration/div[3]/div[1]/div[2]/table/tbody/tr[1]/td[4]/mat-select/div/div[1]");
	...
	public void Quick_Registration_With_Existing_With_Police(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException 
	{
		...
		Thread.sleep(500);
		driver.findElement(AllDropDownSearch).sendKeys("Police");
		Thread.sleep(500);
		...
		//Thread.sleep(500);
		//findElement(Genderselectvalue).click();
		//Clicking on DOB
		Thread.sleep(500);
		...
		{
			System.out.println(EnterPatientName+" "+"Quick registertaion existing patient with primary id Police has been created and sercahed succesfully"); 
		} else 
		{
			System.out.println("Quick registertaion existing patient with primary id Police not fount!!!"); 
		}
		...
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Quick_registeration_has_been_created_with_primary_id_Police_and_serached.png"));  
