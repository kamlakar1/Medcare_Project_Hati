...
public class Departmet_Existing_appointment_Quick_Registration 
{
	WebDriver driver=null; 
	public Departmet_Existing_appointment_Quick_Registration(WebDriver driver) 
	{
		this.driver=driver;
	...
	By EncounterNotesButtonClick=By.cssSelector("input[ng-reflect-placeholder='Encounter Notes']");
...
*/
		...
		ArrayList<Object> tabsss = new ArrayList<Object> (driver.getWindowHandles());
		Thread.sleep(2000);
		driver.switchTo().window((String) tabsss.get(2));
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Department_existing_appoint_QuickRegisteration.png"));  
