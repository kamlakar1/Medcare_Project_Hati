...
public class OPD_Reg_WIth_OLD_IC_With_VIP_Patient {
	...
	//VIP Check Box
	By VIPCheckBox=By.cssSelector("mat-checkbox[ng-reflect-name='isVip']");
	...
	By SecondaryIdentificationSelOpt=By.xpath("//div[@role='listbox']/mat-option[3]");
	...
	By AgentIdentificationTypeSelOpt=By.xpath("//div[@role='listbox']/mat-option[3]");
	...
	//	Thread.sleep(20000);
		...
		Thread.sleep(2000);
		driver.findElement(VIPCheckBox).click();
	...
	//	driver.findElement(SecondaryIDNumClick).sendKeys(SecondaryIdNumber12);
		...
		driver.findElement(OccupationSelOpt).click();
		 ...
		 Thread.sleep(1000); driver.findElement(RaceClick).click();
		 Thread.sleep(1000);
		 driver.findElement(AllDropDownSearch).sendKeys("Refugee");
		 Thread.sleep(1000); driver.findElement(RaceSelOpt).click();
...
*/
		...
		//Health TouristCode
		Thread.sleep(1000);
		driver.findElement(HealthTouristCodeClick).sendKeys(Healthtouristcodepar); 
		...
		//Agent Identification Number
		Thread.sleep(1000);
		driver.findElement(AgentIdentificationNumberClick).sendKeys(AgentIdNoPar); 

		//Agent Name
		Thread.sleep(2000);
		driver.findElement(AgentNameClick).sendKeys(AgentNamePar); 

		//Start End Date
		Thread.sleep(2000);
		driver.findElement(StartdateClik).sendKeys(StartDatePar); 
		Thread.sleep(1000);
		driver.findElement(EnddateClick).sendKeys(EndDatePar); 

		//Contact Number
		Thread.sleep(2000);
		driver.findElement(ContactNoClick).sendKeys(ContactNoPar4); 

		//EmailId
		Thread.sleep(2000);
		driver.findElement(EmailIdClick).sendKeys(EmailIdPar4); 

		//Address
		Thread.sleep(2000);
		driver.findElement(AddressClick).sendKeys(Address23Par);
		...
		//PostCode
		Thread.sleep(2000);
		driver.findElement(PostCOdeClick).sendKeys(PostCodePar34);
...
*/
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OPD_Reg_OLD_IC_With_VIP_Patient.png"));
