...
public class PatientBlock {
	...
	//Reason
			...
			By Reasonselect=By.xpath("//span[contains(text(),' Patient block ')]");
	//Remarks 
  ...
  
  {
	...
	//  driver.findElement(EncounterList).click();
	  ...
	  WebElement mrnvale=driver.findElement(By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-patient-appointment-list/mat-drawer-container/mat-drawer-content/div[2]/table/tbody/tr[1]/td[3]"));
