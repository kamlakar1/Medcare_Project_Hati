...
public class ER_Registration_Secondary_Surveyy {
	...
	By kSelectReaction = By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/div/div[2]/div/app-case-sheet/p-dialog/div/div/div[3]/app-patient-allergy/div/div/div/p-tabview/div/div[2]/p-tabpanel[1]/div/p-scrollpanel/div/div[1]/div/div/div[2]/div/div[1]/div[1]/p-multiselect/div/div[3]");
	By kSelectReactionopt = By.xpath("/html/body/div[4]/div/div/div[2]/ul/p-multiselectitem[1]/li");
	By Severity = By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/div/div[2]/div/app-case-sheet/p-dialog/div/div/div[3]/app-patient-allergy/div/div/div/p-tabview/div/div[2]/p-tabpanel[1]/div/p-scrollpanel/div/div[1]/div/div/div[2]/div/div[1]/div[2]/p-dropdown/div/div[2]");
	...
	By SecondarySurvey = By.xpath("//app-patient-casesheet/div/div[1]/div/p-tabmenu/div/div/div/ul/li[3]/a/span[1]");
	public ER_Registration_Secondary_Surveyy (WebDriver driver)
	...
	public void errrs() throws InterruptedException, IOException, AWTException 

	{
		...
		Thread.sleep(3000);
		driver.findElement(Name_MPI).sendKeys("UNKNOWN-17:12:47:09");
		Thread.sleep(3000);
