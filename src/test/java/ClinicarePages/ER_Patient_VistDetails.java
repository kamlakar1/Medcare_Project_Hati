...
public class ER_Patient_VistDetails {
	...
	public ER_Patient_VistDetails (WebDriver driver)
	...
	public void Pasvisit() throws InterruptedException, IOException, AWTException 

	{
		...
		driver.findElement(Name_MPI).sendKeys("UNKNOWN-17:12:50:22");
		Thread.sleep(3000);
		...
		//driver.findElement(savenursing).click();
		//Thread.sleep(10000);
		
		String GetItemADDED = driver.findElement(GetSubjectiveNotesHistory).getText();
		
		
		String Actual  = GetItemADDED;
		String Expected = GetItemADDED;
		
		Assert.assertEquals(Actual, Expected , "past visit successfully");
