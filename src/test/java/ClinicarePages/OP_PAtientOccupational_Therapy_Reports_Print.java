...
public class OP_PAtientOccupational_Therapy_Reports_Print  {
	...
	By OccupationalTherapy = By.xpath("//app-other-orders/div/div/div/div/div/div[1]/p-scrollpanel/div/div[1]/div/div/p-panelmenu/div/div[3]/div/div/a");
	By SearchOccupational = By.xpath("//p-scrollpanel/div/div[1]/div/form/div/div[1]/div/div/p-table/div/div/table/tbody/tr[1]/td[2]/p-tablecheckbox/div/div[2]");
	...
	By OccupationalTherapyReports = By.xpath("//span[contains(text(),'Occupational Therapy Reports')]");
	By MarkConducted = By.xpath("//span[contains(text(),'Mark Conducted')]");
	By Printt = By.xpath("//app-view-result/div/div[2]/app-results/div/div/div/dev/p-table/div/div/table/tbody/tr/td[4]/button");
	...
	By OccupationalTherapty = By.cssSelector("img[src='https://mykare-qa.hatiintl.com/lt-assets/menu-icons/OCC.png']");
	public OP_PAtientOccupational_Therapy_Reports_Print (WebDriver driver)
...

	{
		...
		//----Serach Name_MPI and add the primary and secodary survey---//
		Thread.sleep(5000);
		driver.findElement(patientNameMpi).sendKeys("FFFSON");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(OccupationalTherapy).click();
		Thread.sleep(3000);
		driver.findElement(SearchOccupational).click();
		Thread.sleep(3000);
		...
		driver.findElement(OccupationalTherapty).click();
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(OccupationalTherapyReports).click();
		Thread.sleep(3000);
