...
public class ER_Registeartion {
	...
	By tab8 = By.id("tab8");
	 ...
	 // Xpath Locators
    By ED_Registeration = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/ng-sidebar/aside/app-sidebar/app-menu/ul/li[5]/a/span[1]");
    By EDregitserationtwo = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/ng-sidebar/aside/app-sidebar/app-menu/ul/li[5]/ul/li/ul/li[2]/a/span[1]");
    By PrimaryID = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-emergency-registration/div[2]/form[1]/div[1]/div/div[2]/mat-grid-list/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]/mat-select/div/div[1]/span");
    By PrimaryIDopt = By.xpath("//span[contains(text(),'Passport')]");
    By PrlimariIDnumber = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-emergency-registration/div[2]/form[1]/div[1]/div/div[2]/mat-grid-list/div/mat-grid-tile[2]/div/mat-form-field/div/div[1]/div[3]");
    By ExpiryDate = By.xpath("input[formcontrolname='expiryDate']");
    By Title = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-emergency-registration/div[2]/form[1]/div[2]/mat-grid-list[1]/div/mat-grid-tile[1]/div/app-master-form-field/div/mat-form-field/div/div[1]/div[3]/mat-select/div/div[2]");
    By Titleopt = By.xpath("//span[contains(text(),'Tan Sri Datuk')]");
    By Geneder = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-emergency-registration/div[2]/form[1]/div[2]/mat-grid-list[1]/div/mat-grid-tile[4]/div/app-master-form-field/div/mat-form-field/div/div[1]/div[3]");
    By MALEopt = By.xpath("//span[contains(text(),'MALE')]");
    By DateoFBirth = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-emergency-registration/div[2]/form[1]/div[2]/mat-grid-list[2]/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]");
    By mobileNumber = By.cssSelector("input[formcontrolname='mobileNumber']");
    By Specialityt = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-emergency-registration/div[2]/form[2]/div/div/div[3]/div[1]/mat-form-field/div/div[1]/div[3]/mat-select/div/div[1]");
    By Department = By.xpath("/html/body/div[5]/div[2]/div/div/div/mat-option[1]/span/ngx-mat-select-search/div/input");
    By Specilatyopt = By.xpath("//span[contains(text(),'General Medicine')]");
    By dOCTOR = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-emergency-registration/div[2]/form[2]/div/div/div[3]/div[2]/mat-form-field/div/div[1]/div[3]/mat-select/div/div[1]");
    By DATODRPHILOSMAN = By.xpath("//span[contains(text(),'DATO DR PHIL OSMAN')]");
    By Clinik = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-emergency-registration/div[2]/form[2]/div/div/div[3]/div[3]/app-master-form-field/div/mat-form-field/div/div[1]/div[3]/mat-select/div/div[1]");
    By SendksyClinic = By.xpath("/html/body/div[5]/div[2]/div/div/div/mat-option[1]/span/ngx-mat-select-search/div/input");
    By ConsultationRoom4 = By.xpath("//span[contains(text(),'Consultation Room 4')]");
    By Tariff = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-emergency-registration/div[2]/div[1]/div[2]/table/tbody/tr/td[4]/mat-select");
    By SelfTarif = By.xpath("/html/body/div[5]/div[2]/div/div/div/mat-option[1]/span/ngx-mat-select-search/div/input");
    By SelfTariff = By.xpath("//span[contains(text(),'Self Tariff')]");
    
    
    By SaveEncounter = By.xpath("button[id='Save Encounter']");
    By mainmenu_1=By.cssSelector("mat-icon[ng-reflect-message='Menu']");

	public ER_Registeartion (WebDriver driver)
	...
	public void ER_Registration_Bay () throws InterruptedException, IOException, AWTException 

	{
		 Thread.sleep(20000);
		 
		driver.findElement(mainmenu_1).click();
		Thread.sleep(4000);
        ...
        // Click on Emergency Registration menu
        driver.findElement(ED_Registeration).click();
        Thread.sleep(1000);
        driver.findElement(EDregitserationtwo).click();
        Thread.sleep(1000);

        // Select Primary ID
        driver.findElement(PrimaryID).click();
        Thread.sleep(1000);
        driver.findElement(PrimaryIDopt).click();
        Thread.sleep(1000);

        // Enter Primary ID Number (Example: Passport Number)
        driver.findElement(PrlimariIDnumber).sendKeys("P12345678");
        Thread.sleep(1000);

        // Select Expiry Date
        driver.findElement(ExpiryDate).sendKeys("12/12/2030");
        Thread.sleep(1000);

        // Select Title
        driver.findElement(Title).click();
        Thread.sleep(1000);
        driver.findElement(Titleopt).click();
        Thread.sleep(1000);

        // Select Gender
        driver.findElement(Geneder).click();
        Thread.sleep(1000);
        driver.findElement(MALEopt).click();
        Thread.sleep(1000);

        // Enter Date of Birth
        driver.findElement(DateoFBirth).sendKeys("01/01/1980");
        Thread.sleep(1000);
        ...
        // Select Speciality
        driver.findElement(Specialityt).click();
        Thread.sleep(1000);
        driver.findElement(Department).sendKeys("General Medicine");
        Thread.sleep(1000);
        driver.findElement(Specilatyopt).click();
        Thread.sleep(1000);

        // Select Doctor
        driver.findElement(dOCTOR).click();
        Thread.sleep(1000);
        driver.findElement(DATODRPHILOSMAN).click();
        Thread.sleep(1000);

        // Select Clinic
        driver.findElement(Clinik).click();
        Thread.sleep(1000);
        driver.findElement(SendksyClinic).sendKeys("Consultation Room 4");
        Thread.sleep(1000);
        driver.findElement(ConsultationRoom4).click();
        Thread.sleep(1000);

        // Select Tariff
        driver.findElement(Tariff).click();
        Thread.sleep(1000);
        driver.findElement(SelfTariff).click();
        Thread.sleep(1000);
        driver.findElement(SaveEncounter).click();
        Thread.sleep(1000);
