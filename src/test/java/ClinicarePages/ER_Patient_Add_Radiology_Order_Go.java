...
public class ER_Patient_Add_Radiology_Order_Go {
	...
	//Consulation
	By Result = By.xpath("//app-patient-casesheet/div/div[2]/div/app-view-result/div/div[1]/p-selectbutton/div/div[2]/span[1]");
	...
	By print = By.xpath("//app-view-result/div/div[2]/app-results/div/div/div/dev/div/div/div/p-table/div/div/table/tbody/tr[1]/td[5]");
	By RadiologyOrders = By.id("PLAN_RO");
	By mcjehclk = By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/div/div[2]/div/app-case-sheet/p-dialog/div/div/div[3]/app-radiology-order/div/div/div/p-tabview/div/div[2]/p-tabpanel[1]/div/form/div/div[1]/div/div/p-table/div/div/table/tbody/tr[1]/td[2]/p-tablecheckbox/div/div[2]");
	By Frequency3 = By.xpath("//p-tabpanel[1]/div/form/div/div[2]/div/div/div[1]/div/p-autocomplete/span/button");
	By Frequencyeverymorning3 = By.xpath("//span[contains(text(),'ON')]");
	...
	By EndDateTime = By.xpath("//app-administration-casesheet/div/div/div/div/div[3]/div/div[3]/div[1]/b/p-calendar/span/input");
	By clickicdate = By.xpath("/html/body/div[4]/div[2]/div[3]/button[1]");
	public ER_Patient_Add_Radiology_Order_Go (WebDriver driver)
	...
	public void ffrs() throws InterruptedException, IOException, AWTException 

	{
		...
		driver.findElement(Name_MPI).sendKeys("UNKNOWN-17:12:51:28");
		Thread.sleep(3000);
	...
	// RIS flow Schedule, conductq, reporting and Releasing	

		driver.findElement(mainmenu23).click();
		Thread.sleep(7000);	

		driver.findElement(RIS).click();
		Thread.sleep(7000);

		//driver.findElement(Name_MRN).sendKeys("HISCKLMRN241018786");
		//Thread.sleep(3000);

		//driver.findElement(Search_2).click();
		//Thread.sleep(3000);
		...
		driver.findElement(RadiologyEquipment).click();
		Thread.sleep(3000);

		driver.findElement(CTopt).click();
		Thread.sleep(3000);

		driver.findElement(Radiologist).click();
		Thread.sleep(3000);

		driver.findElement(Radiologistopt).click();
		Thread.sleep(8000);


		// Locate the scrollable element (based on the element you want to scroll)
		WebElement scrollableElement = driver.findElement(By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-ris-schedule/div[2]/div[2]/div/app-clinical-schedule-calendar/ejs-schedule/div[3]/div/table/tbody/tr[2]/td[2]/div"));
		...
		Thread.sleep(3000);
		driver.findElement(CreateSchedule).click();
		Thread.sleep(3000);

		// Conduct process
		driver.findElement(Conduct).click();
		Thread.sleep(3000);

		driver.findElement(Name_MRN).sendKeys("UNKNOWN-17:12:51:28");
		Thread.sleep(3000);
		...
		driver.findElement(ConductNote).click();
		Thread.sleep(3000);

		driver.findElement(ConductNoteSendKeys).sendKeys("Conduct Notes");
		Thread.sleep(3000);
	
		driver.findElement(SaveExitc).click();
		Thread.sleep(5000);
		
		driver.findElement(EndDateTime).click();
		Thread.sleep(3000);

		driver.findElement(clickicdate).click();
		Thread.sleep(3000);
		...
		driver.findElement(MarkConduct).click();
		Thread.sleep(3000);

		driver.findElement(Yes_2).click();
		Thread.sleep(3000);
		...
		driver.findElement(TextInputSendKeys).sendKeys("Reporting text");
		Thread.sleep(3000);

		driver.findElement(Save1).click();
		Thread.sleep(3000);

		driver.findElement(OrderComplete).click();
		Thread.sleep(3000);
		...
		// Release
		driver.findElement(Release).click();
		Thread.sleep(3000);
		...
		driver.findElement(TestInputSendKeys).sendKeys("Release text");
		Thread.sleep(3000);

		driver.findElement(OrderComplete1).click();
		Thread.sleep(3000);

		driver.findElement(Yes2).click();
		Thread.sleep(3000);

		driver.findElement(Release1).click();
		Thread.sleep(3000);
		//driver.close();
		//Thread.sleep(3000);
		
		// Print Radiology going back to the ER

		// Handling a new window/tab if opened
		String mainWindow1 = driver.getWindowHandle();
		ArrayList<String> tabs1 = new ArrayList<>(driver.getWindowHandles());
		driver.switchTo().window(tabs1.get(0)); // Switch back to the original tab
		Thread.sleep(15000);
		...
		// Handling a new window/tab if opened
		String mainWindow13 = driver.getWindowHandle();
		ArrayList<String> tabs13 = new ArrayList<>(driver.getWindowHandles());
		driver.switchTo().window(tabs13.get(1)); // Switch back to the original tab
		Thread.sleep(14000);
		...
		driver.findElement(Name_MPI).sendKeys("UNKNOWN-16:16:34:42");
		Thread.sleep(3000);
		driver.findElement(Ssearch).click();
		Thread.sleep(3000);
		driver.findElement(Continue).click();
		...
		Robot robot1 = new Robot(); for (int i = 0; i < 6; i++) {
