...
public class LAB_Order_Pages  {
	...
	// Orders (Plan)
	By LabOrders =By.cssSelector("button[id='PLAN_LO']");
	...
	// LAB
	// Validation
	By Chekbox = By.xpath("//app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
	...
	public LAB_Order_Pages (WebDriver driver)
	...
	public void jrs() throws InterruptedException, IOException, AWTException 

	{
		...
		//----Serach Name_MPI and add the primary and secodary survey---//
		Thread.sleep(5000);
		driver.findElement(patientNameMpi).sendKeys("MSON");
		Thread.sleep(3000);
...
/*
		...
		Thread.sleep(1000);
		driver.findElement(name_3).sendKeys("JAKARTO");
		Thread.sleep(1000);
		...
		driver.findElement(Name_MPI).sendKeys("MAVA");
		Thread.sleep(3000);
