...
public class ConsultQ_Print_Orders  {
	...
	By OrderType = By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-print-order-model/div/div/div/div[1]/p-table/div/div/table/thead/tr/th[1]");
	...
	By PrintOrders = By.xpath("//span[contains(text(),'Print Orders')]");
	public ConsultQ_Print_Orders (WebDriver driver)
...

	{
		...
		//----Serach Name_MPI and add the primary and secodary survey---//
		Thread.sleep(5000);
		driver.findElement(patientNameMpi).sendKeys("DSON");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(PrintOrders).click();
		Thread.sleep(3000);
		//driver.findElement(OrderType).click();
		Thread.sleep(3000);
		
		String OrderType1 = driver.findElement(OrderType).getText();
