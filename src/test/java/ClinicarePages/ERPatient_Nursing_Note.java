...
public class ERPatient_Nursing_Note {
	...
	public ERPatient_Nursing_Note (WebDriver driver)
	...
	public void ERPatient_Nursing_Notee() throws InterruptedException, IOException, AWTException 

	{
		...
		driver.findElement(Name_MPI).sendKeys("UNKNOWN-17:12:46:21");
		Thread.sleep(3000);
		...
		driver.findElement(NursingNotes).click();
		Thread.sleep(3000);
		
		
		driver.findElement(NursingNotessend).sendKeys("test");
		Thread.sleep(3000);
		
		driver.findElement(savenursing).click();
		Thread.sleep(10000);
		
		String GetItemADDED = driver.findElement(ItemADDED).getText();
		
		
		String Actual  = GetItemADDED;
		String Expected = GetItemADDED;
		
		Assert.assertEquals(Actual, Expected , "Nursing Notes added successfully");
