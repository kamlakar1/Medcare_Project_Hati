...
public class ER_Registration_Case_Type {
	...
	public ER_Registration_Case_Type (WebDriver driver)
	...
	public void ER_Registration_C() throws InterruptedException, IOException, AWTException 

	{
		...
		driver.findElement(Name_MPI).sendKeys("UNKNOWN-17:12:48:41");
		Thread.sleep(3000);
		driver.findElement(Ssearch).click();
		Thread.sleep(3000);
		//driver.findElement(PrimarySurvey).click();
		
		driver.findElement(AddCaseType).click();
		Thread.sleep(3000);
		
		driver.findElement(SelectBAY).click();
		Thread.sleep(3000);
		
		driver.findElement(BluntTrauma).click();
		Thread.sleep(3000);
		
		driver.findElement(Add).click();
		Thread.sleep(8000);
		
		String getBayDeatils = driver.findElement(CaseType).getText();
		
		String Actual = getBayDeatils;
		String Expected = getBayDeatils;
		Assert.assertEquals(Actual, Expected, "Verified BAY");
