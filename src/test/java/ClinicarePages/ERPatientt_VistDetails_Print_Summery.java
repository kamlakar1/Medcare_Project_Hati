...
public class ERPatientt_VistDetails_Print_Summery {
	...
	By AddCaseType = By.cssSelector("button[ptooltip='Add CaseType']");
	By SelectBAY = By.xpath("//app-er-q/div/div/div/p-dialog[3]/div/div/div[3]/app-er-casetype/div/div/div[1]/p-autocomplete/span/button");
	By BluntTrauma = By.xpath("//span[contains(text(),'Blunt Trauma')]");
	By Add = By.xpath("//span[contains(text(),'Add')]");
	
	By CaseType	 = By.xpath("//app-er-q/div/div/div/p-table/div/div/table/tbody/tr/td[5]/div/span/div/span");
		
	
	// nursing notes
	By NursingNotes = By.xpath("//app-patient-casesheet/div/div[1]/div/p-tabmenu/div/div/div/ul/li[5]/a/span[1]");
	By NursingNotessend = By.xpath("//p-tabview/div/div[2]/p-tabpanel[1]/div/form/div/div[1]/div/div/div[2]/p-editor/div/div[2]/div[1]");
	By savenursing = By.xpath("//p-tabpanel[1]/div/form/div/div[1]/div/div/p-toolbar/div/div[2]/app-lt-post-button/button/span[2]");
	By ItemADDED = By.xpath("//p-tabpanel[1]/div/form/div/div[2]/div/div/div/p-table/div/div/table/tbody/tr[1]/td[1]/div/quill-view-html/div/div");
	
	
	// Past visit details
	By PastVisits = By.xpath("//span[contains(text(),'Past Visits')]");
	By Searchh = By.id("Search");
	By PrintSummary = By.cssSelector("button[icon='pi pi-file-pdf']");
	By GetSubjectiveNotesHistory = By.xpath("//app-past-visit/div/div/div[2]/p-panel/div/div[2]/div/div[1]/div[1]/div[2]/span[2]");
	By Printsummary2 = By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-print-summary/div/div[2]/button/span[2]");
	
	public ERPatientt_VistDetails_Print_Summery (WebDriver driver)
	...
	public void PasvisitPrintsummary() throws InterruptedException, IOException, AWTException 

	{
		...
		driver.findElement(Name_MPI).sendKeys("UNKNOWN-17:12:45:28");
		Thread.sleep(3000);
		...
		//driver.findElement(PrintSummary).click();
		//Thread.sleep(10000);
		Thread.sleep(6000);
		//driver.findElement(Printsummary2).click();
		Thread.sleep(6000);
		
		/*
		String GetItemADDED = driver.getCurrentUrl();
		
		
		String Actual  = GetItemADDED;
		String Expected = GetItemADDED;
		
		Assert.assertEquals(Actual, Expected , "Summary Printed Sucessfully");
