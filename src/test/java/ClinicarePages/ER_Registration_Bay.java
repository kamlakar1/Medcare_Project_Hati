...
public class ER_Registration_Bay {
	...
	By AddBAY = By.cssSelector("Button[ptooltip='Add BAY']");
	By SelectBAY = By.xpath("//app-er-q/div/div/div/p-dialog[2]/div/div/div[3]/app-er-bay/div/div/div[1]/p-autocomplete/span/button");
	By CriticalCareBay = By.xpath("//span[contains(text(),'Critical Care Bay')]");
	By Add = By.xpath("//span[contains(text(),'Add')]");
	
	By getBAYdetails = By.xpath("//app-er-q/div/div/div/p-table/div/div/table/tbody/tr/td[4]/div/span/div/span");
			
	public ER_Registration_Bay (WebDriver driver)
...

	{
		...
		driver.findElement(AddBAY).click();
		Thread.sleep(3000);
		
		driver.findElement(SelectBAY).click();
		Thread.sleep(3000);
		
		driver.findElement(CriticalCareBay).click();
		Thread.sleep(3000);
		
		driver.findElement(Add).click();
		Thread.sleep(8000);
		
		String getBayDeatils = driver.findElement(getBAYdetails).getText();
