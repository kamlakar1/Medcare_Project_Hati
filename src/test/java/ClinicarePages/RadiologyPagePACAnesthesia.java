...
public class RadiologyPagePACAnesthesia  {
	...
	By Consultqqq = By.cssSelector("img[src='https://mykare-qa.hatiintl.com/lt-assets/applications/OPD.png']");
	...
	public RadiologyPagePACAnesthesia (WebDriver driver)
	...
	public void frssius() throws InterruptedException, IOException, AWTException 

	{
		...
		driver.findElement(Name_MRN).sendKeys("DDSSON");
		Thread.sleep(3000);
...
/*
		...
		driver.findElement(mainmenu).click();
		Thread.sleep(12000);
		driver.findElement(Consultqqq).click();
		Thread.sleep(15000);
		//----Serach Name_MPI and add the primary and secodary survey---//

		driver.findElement(Name_MPI).sendKeys("RABERT");
		Thread.sleep(3000);
		driver.findElement(Search_1).click();
		Thread.sleep(3000);
		driver.findElement(Continue).click();
