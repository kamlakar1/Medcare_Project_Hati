...
public class PAtient_Non_OT_Procedure_Print  {
	...
	By PLAN_NONOT = By.cssSelector("button[id='PLAN_NONOT']");
	By mcjehclk = By.xpath("//p-tabpanel[1]/div/p-scrollpanel/div/div[1]/div/form/div/div[1]/div/div/p-table/div/div/table/tbody/tr[1]/td[2]/p-tablecheckbox");
	...
	By NonOTProceudre = By.cssSelector("img[src='https://mykare-qa.hatiintl.com/lt-assets/menu-icons/NONOT.png']");
	...
	By NonOtProcedureReport = By.xpath("//app-patient-casesheet/div/div[2]/div/app-view-result/div/div[1]/p-selectbutton/div/div[4]");
	By MarkConducted = By.xpath("//span[contains(text(),'Mark Conducted')]");
	By Printt = By.xpath("//app-view-result/div/div[2]/app-results/div/div/div/dev/p-table/div/div/table/tbody/tr/td[5]/button");
	...
	public PAtient_Non_OT_Procedure_Print (WebDriver driver)
...

	{
		...
		driver.findElement(patientname).sendKeys("PPPSON");
		Thread.sleep(3000);
		...
		driver.findElement(NonOTProceudre).click();
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(patientNameMpi).sendKeys("PPPSON");
		Thread.sleep(3000);
		driver.findElement(Sercahl).click();
		Thread.sleep(3000);
		driver.findElement(Continue).click();
		...
		Thread.sleep(3000);
		driver.findElement(NonOtProcedureReport).click();
		Thread.sleep(3000);
