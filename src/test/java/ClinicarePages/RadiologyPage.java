...
public class RadiologyPage  {
	...
	By Name_MPI=By.cssSelector("input[formcontrolname='patientNameMpi']");
...

	{
		...
		//----Serach Name_MPI and add the primary and secodary survey---//
		Thread.sleep(5000);
		driver.findElement(patientNameMpi).sendKeys("LSON");
		Thread.sleep(3000);
		...
		driver.findElement(Name_MRN).sendKeys("LSON");
		Thread.sleep(3000);
...
/*
		...
		driver.findElement(Name_MPI).sendKeys("DANESH");
		Thread.sleep(3000);
