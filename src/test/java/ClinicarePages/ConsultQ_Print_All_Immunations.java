...
public class ConsultQ_Print_All_Immunations  {
	...
	By Patinetanme = By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-print-immunisation-order/div/div[1]/div/app-print-patient-details/div[2]/div[1]/div[1]/span[2]");
	...
	By PrintAllImmunisations = By.xpath("//span[contains(text(),'Print All Immunisations')]");
	public ConsultQ_Print_All_Immunations (WebDriver driver)
...

	{
		...
		//----Serach Name_MPI and add the primary and secodary survey---//
		Thread.sleep(5000);
		driver.findElement(patientNameMpi).sendKeys("HSONH");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(PrintAllImmunisations).click();
		Thread.sleep(3000);
