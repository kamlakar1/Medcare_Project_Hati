...
public class ER_Add_Lab_Orders_Lab_Accept_Order  {
	...
	By Frequencyeverymorning1 = By.xpath("//span[contains(text(),'Single Dose')]");
	...
	By LabResult = By.xpath("//app-view-result/div/div[1]/p-selectbutton/div/div[1]/span[1]");
	By GetDetails = By.xpath("//app-results/div/div/div/dev/div[2]/div/ejs-treegrid/div[2]/div[3]/div/table/tbody/tr[1]/td[1]/div/span[3]");
	//By mainmenu=By.cssSelector("mat-icon[ng-reflect-message='Menu']");
	...
	public ER_Add_Lab_Orders_Lab_Accept_Order (WebDriver driver)
	...
	public void jrrs() throws InterruptedException, IOException, AWTException 

	{
		...
		driver.findElement(Name_MPI).sendKeys("UNKNOWN-17:12:49:29");
		Thread.sleep(3000);
...
/*
		...
		Thread.sleep(1000);
		driver.findElement(name_3).sendKeys("ANISHA");
		Thread.sleep(1000);
		...
		//PatientMRN
		Thread.sleep(2000);
		driver.findElement(MRNsearch).sendKeys("");
		...
		driver.switchTo().window(tabs2.get(1)); // Switch back to the original tab
		Thread.sleep(14000);
		...
		driver.findElement(Name_MPI).sendKeys("HISCKLMRN241018955");
		Thread.sleep(3000);
		driver.findElement(Search_1).click();
		Thread.sleep(3000);
		driver.findElement(Continue).click();
		...
		Thread.sleep(3000);
		driver.findElement(LabResult).click();
		Thread.sleep(3000);
		driver.findElement(GetDetails).click();
		Thread.sleep(3000);
