...
public class ConsultQ_Print_All_Med_Orders  {
	...
	By Patinetanme = By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-print-med-orders/div/div[1]/div[1]/app-print-patient-details/div[2]/div[1]/div[1]/span[2]");
	...
	By pipiprint= By.cssSelector("button[icon='pi pi-print']");
	By PrintAllMedOrders = By.xpath("//span[contains(text(),'Print All Med Orders')]");
	
	By MyPending = By.cssSelector("img[src='https://mykare-qa.hatiintl.com/lt-assets/menu-icons/MYPEN.png']");
	public ConsultQ_Print_All_Med_Orders (WebDriver driver)
...

	{
		...
		//----Serach Name_MPI and add the primary and secodary survey---//
		Thread.sleep(5000);
		driver.findElement(patientNameMpi).sendKeys("PPSON");
		Thread.sleep(3000);
		...
		//Thread.sleep(8000);
		driver.findElement(pipiprint).click();
		Thread.sleep(3000);
		driver.findElement(PrintAllMedOrders).click();
		Thread.sleep(3000);
		//driver.findElement(OrderType).click();
		Thread.sleep(3000);
		
		String OrderType1 = driver.findElement(Patinetanme).getText();
		
		String Actaul = OrderType1;
		String Expected = OrderType1;
		
		Assert.assertEquals(Actaul, Expected, "Order has been printed");
