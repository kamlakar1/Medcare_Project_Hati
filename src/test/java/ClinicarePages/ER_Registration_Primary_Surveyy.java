...
public class ER_Registration_Primary_Surveyy {
  ...
  //  By Yes2  = By.xpath("/html/body/app-root/app-main/div/div[2]/div/app-patient-casesheet/div/div[2]/div/app-case-sheet/p-dialog/div/div/div[3]/app-radiology-order/p-dialog/div/div/div[3]/div[2]/div[2]/app-lt-post-button/button/span[2]");
    ...
    public ER_Registration_Primary_Surveyy (WebDriver driver)
	...
	public void errs() throws InterruptedException, IOException, AWTException 

	{
		...
		Thread.sleep(3000);
		driver.findElement(Name_MPI).sendKeys("UNKNOWN-17:12:47:53");
		Thread.sleep(3000);
