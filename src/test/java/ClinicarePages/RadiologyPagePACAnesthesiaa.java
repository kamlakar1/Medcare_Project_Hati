...
public class RadiologyPagePACAnesthesiaa  {
	...
	By RadiologyOrders = By.cssSelector("button[id='PLAN_RO']");
	...
	public RadiologyPagePACAnesthesiaa (WebDriver driver)
	...
	public void frssrs() throws InterruptedException, IOException, AWTException 

	{
		...
		driver.findElement(Name_MPI).sendKeys("FFFSON");
		Thread.sleep(3000);
		...
		driver.findElement(Name_MRN).sendKeys("FFFSON");
		Thread.sleep(3000);
...
/*
		...
		driver.findElement(Name_MPI).sendKeys("ABDUL FAWWAS");
		Thread.sleep(3000);
		driver.findElement(Search_1).click();
		Thread.sleep(3000);
		driver.findElement(Continue).click();
