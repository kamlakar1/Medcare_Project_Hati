...
public class OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Page {
	...
	//SaveButton
	By ChargesSaveButton=By.cssSelector("mat-icon[ng-reflect-message='Save']");
			
	//Confirm
	By ChargesConfirm=By.cssSelector("mat-icon[ng-reflect-message='Yes']");
	...
	//GroupDiscountIcon
		By GroupDiscountIcon=By.cssSelector("button[data-automation-attribute='button-group-discount']");
	...
	//---ChargesCancel---//
		...
		//SelectAll
			By ChargesSelect=By.cssSelector("mat-checkbox[ng-reflect-id='Check All Services']");
			
		//DeleteIcon
			By DeleteIcon=By.cssSelector("img[ng-reflect-message='Delete Charges']");
			
		//ReasonClickFor Delete 
			By ReasonClickforDelete=By.cssSelector("mat-select[ng-reflect-name='first']");
			
		//ReasonSelectForDelete
			
			By ReasonSelectForDelete=By.xpath("//span[contains(text(),'For Consultation')]");
			
		//RemarksForDelete
			By RemarksForDelete=By.cssSelector("textarea[ng-reflect-name='remark']");
	...
	public OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Page (WebDriver driver)
  ...
  public void OPChargewithGorupDiscountAndDeleteChargesforSelf (String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException 
  {
	...
	//Clicking on menu Icon
			...
			Thread.sleep(5000);
			   ...
			   System.out.println("Quick Registration page failed"); 
				...
				FileUtils.copyFile(screenshot, new File(".//ScreenShots//OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Test_QuickRegisterationForm.png")); 
			...
			Thread.sleep(3000);
		      ...
		      FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Test_QuickRegistrationSaved.png"));
			...
			//CreatedMRN
			  ...
			  Thread.sleep(5000);
			   ...
			   System.out.println("Encounter List Screen Not Appear"); 
				...
				FileUtils.copyFile(screenshot2, new File(".//ScreenShots//OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Test_EncounterListScreen.png")); 
	...
	//SideMenuBar
	  ...
	  Thread.sleep(5000);
	   ...
	   System.out.println("OP Charge Screen Not Appear"); 
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Test_OPChargeScreen.png")); 
	...
	//OPChargeSave
	  Thread.sleep(2000);
	  driver.findElement(ChargesSaveButton).click();
	  
	  //Confirm
	  Thread.sleep(2000);
	  driver.findElement(ChargesConfirm).click();
	  ...
	  //GorupDiscount
	  Thread.sleep(3000);
	  driver.findElement(GroupDiscountIcon).click();
	...
	//PercentType
	  ...
	  //DiscountAmount 
	  Thread.sleep(3000);
	  driver.findElement(DiscountAmount).clear();
	  Thread.sleep(2000);
	  driver.findElement(DiscountAmount).sendKeys("5");
	  
	//AddButton
	  Thread.sleep(3000);
	  driver.findElement(AddButtondiscount).click();
	  
	  
	  
	  //DiscountSave 
	  Thread.sleep(2000);
	  driver.findElement(DiscountSave).click();
      ...
      FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Test_ChargesSavewithGroupDiscount.png"));
      Thread.sleep(3000);
    ...
    //SelectAll
	 Thread.sleep(3000);
	  driver.findElement(ChargesSelect).click();
	  ...
	  //ReasonClickForDelete
	  Thread.sleep(3000);
	  driver.findElement(ReasonClickforDelete).click();
	  
	  //ReasonSelectForDelete
	  Thread.sleep(3000);
	  driver.findElement(ReasonSelectForDelete).click();
	  
	  //RemarksForDelete
	  Thread.sleep(3000);
	  driver.findElement(RemarksForDelete).click();
	...
	//Assertion
      ...
      FileUtils.copyFile(screenshot5, new File(".//ScreenShots//OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Test_ChargesSavewithGroupDiscount.png"));
      Thread.sleep(3000);
	  
	  //Condition1
	  
	  String Actual_2 = "Order deleted Successfully";
      String Expected_2 = "Order deleted Successfully";
      Assert.assertEquals(Actual_2, Expected_2, "Patient Charges Deleted and saved");
