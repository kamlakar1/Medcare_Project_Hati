...
public class DocumentManagement_Search_IP_Patient_Upload_Document_Save_Download 
{
	WebDriver driver;
	...
	public void DocumentMgmt_OPD_UploadFIle_Save_Download() throws InterruptedException, IOException
	{
	...
	public DocumentManagement_Search_IP_Patient_Upload_Document_Save_Download(WebDriver driver)
	{
		this.driver=driver;
	}
}
