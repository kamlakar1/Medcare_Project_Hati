...
public class MRD_File_Requested_Volume_Master_Search_patient_Add_volume
{
	...
	public MRD_File_Requested_Volume_Master_Search_patient_Add_volume(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(5000);
        driver.findElement(addvolquntity).sendKeys("1");
        Thread.sleep(5000);
        driver.findElement(RequisetedBy).click();
        Thread.sleep(5000);
        driver.findElement(jevamela).click();
        Thread.sleep(5000);
