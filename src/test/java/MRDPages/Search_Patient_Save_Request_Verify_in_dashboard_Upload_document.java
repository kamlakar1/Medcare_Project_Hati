...
public class Search_Patient_Save_Request_Verify_in_dashboard_Upload_document
{
	...
	By Edit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-report/div[3]/table/tbody/tr/td[18]/a[1]/mat-icon");
	
	By addreoc = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-report/div[3]/div[1]/mat-grid-list[5]/div/mat-grid-tile[3]/div/button/span[1]/mat-icon");
	By saveas = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-report/div[4]/mat-grid-list/div/mat-grid-tile[2]/div/div/button[2]/span[1]/mat-icon");
	
	By print = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-report/div[3]/table/tbody/tr/td[18]/a[2]/mat-icon");
	
	//======================================
	
	By UploadButton = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-report/div[3]/table/tbody/tr/td[21]/a/mat-icon");
	
	By Upload=By.cssSelector("mat-icon[ng-reflect-message='Upload Document']");
	...
	By Savebutttton = By.cssSelector("mat-icon[ng-reflect-message='Save']");
	public Search_Patient_Save_Request_Verify_in_dashboard_Upload_document(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(1000); 
		driver.findElement(upload3).click();
		Thread.sleep(1000); 
		driver.findElement(Savebutttton).click();
		Thread.sleep(1000);
