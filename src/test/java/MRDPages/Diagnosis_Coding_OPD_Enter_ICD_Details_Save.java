...
public class Diagnosis_Coding_OPD_Enter_ICD_Details_Save
{
	...
	By govservent = By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[1]/span");
	...
	By Damage = By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[2]/span");
	...
	By threedays = By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[1]/span");
	...
	By MRNN = By.xpath("/html/body/div[2]/div[2]/div/div/div/div/form/div[2]/div[1]/mat-form-field/div/div[1]/div[3]/input");
	...
	By saveworklist = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request-worklist/div[7]/mat-grid-list/div/mat-grid-tile[2]/div/div/button[2]/span[1]/mat-icon");
	...
	//======================================
	By ICDDetails = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-diagnosis-coding/mat-sidenav-container/mat-sidenav-content/mat-tab-group/div/mat-tab-body[1]/div/div/table/tbody/tr/td[10]/a/mat-icon");
	By heptaopt = By.xpath("//span[contains(text(),'Islam')]");
	By Dignosis = By.cssSelector("input[data-placeholder='Pick one']");
	By finalopt = By.xpath("/html/body/div[4]/div[2]/div/mat-dialog-container/app-diagnosis-icd/div[2]/div[3]/mat-grid-list/div/mat-grid-tile[2]/div/mat-button-toggle-group/mat-button-toggle[2]/button/span");
	By addreco = By.cssSelector("mat-icon[ng-reflect-message='Add']");
	By save = By.cssSelector("button[ng-reflect-message='Save']");
	By MRNs = By.cssSelector("input[ng-reflect-placeholder='Patient MRN ']");
	
	public Diagnosis_Coding_OPD_Enter_ICD_Details_Save(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(5000);
		driver.findElement(MRNs).sendKeys(kk);
		Thread.sleep(5000);
		driver.findElement(sercahghh).click();
		Thread.sleep(5000);
		driver.findElement(ICDDetails).click();
		Thread.sleep(5000);
		driver.findElement(Dignosis).sendKeys("Hepatitis A with hepatic coma");
		Thread.sleep(5000);
		driver.findElement(heptaopt).click();
		Thread.sleep(5000);
		driver.findElement(finalopt).click();
		Thread.sleep(5000);
		driver.findElement(addreco).click();
		Thread.sleep(5000);
