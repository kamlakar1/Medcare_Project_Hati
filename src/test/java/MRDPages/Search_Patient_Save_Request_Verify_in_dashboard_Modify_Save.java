...
public class Search_Patient_Save_Request_Verify_in_dashboard_Modify_Save
{
	...
	By saveas = By.cssSelector("mat-icon[ng-reflect-message='Save']");
	...
	public Search_Patient_Save_Request_Verify_in_dashboard_Modify_Save(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(5000);
        driver.findElement(addreoc).click();
        Thread.sleep(5000);
