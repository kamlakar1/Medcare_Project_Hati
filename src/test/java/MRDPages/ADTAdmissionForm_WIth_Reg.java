...
public class ADTAdmissionForm_WIth_Reg 
{
	...
	By DRSpeciality=By.cssSelector("mat-select[ng-reflect-name='doctorSpeciality']");
	By DRSpecialitySelOpt=By.xpath("//span[contains(text(),'General Medicine')]");
	...
	By ALlSelOpt=By.xpath("//span[contains(text(),'EW_LG_ENT Ward 1')]");
	...
	//New Xpath for bed search 
	//a//mat-icon[contains(text(),'search')]
	//Select Bed
	By BedClick=By.xpath("//span[contains(text(),'Bed00')]");

	//Click on Save Button
	By SaveButtonClick=By.cssSelector("button[type='submit']");


	By BedAddedSucc=By.xpath("//span[contains(text(),'Bed is Successfully Added')]");
	...
	By AddDependent=By.cssSelector("mat-icon[ng-reflect-message='Add new kin']");

	//Permanent Address
	//Address
	By AddressClick=By.cssSelector("input[ng-reflect-name='addressPrimary']");
	...
	By AdmissionCreated=By.xpath("//span[contains(text(),'Admission created Successfully')]");
	...
	public void ADT_Admission_Form(String LengthOfStayPar,String AdmittingDiagPar,String AddNotesPar,String PatientNotesPar,String AdmissionRemarksPar,String BillEstimationPar,String ReferralRemarksPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException
	{
		...
		Thread.sleep(2000);
		driver.findElement(DRSpeciality).click();
		Thread.sleep(2000);
		driver.findElement(DRSpecialitySelOpt).click();
		...
		//.........Validation message checking for bed...........//

		Thread.sleep(2000);
		WebElement selectR1=driver.findElement(BedAddedSucc);
		String SRActual1=selectR1.getText();
		System.out.println("message : "+SRActual1);
		String expected1="Bed is Successfully Added";
		Assert.assertEquals(SRActual1,expected1,"Bed is Successfully Added");

		//ScreenShot5
		File screenshot5 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot5,new File(".//ScreenShot//BedAddedSuccessfully.png"));
		...
		Thread.sleep(2000);
		driver.findElement(AddDependent).click();
		...
		//.........Validation checking for Save admission form.......//

		Thread.sleep(2000);
		WebElement selectR2=driver.findElement(AdmissionCreated);
		String SRActual2=selectR2.getText();
		System.out.println("message : "+SRActual2);
		String expected2="Admission created Successfully";
		Assert.assertEquals(SRActual2,expected2,"Admission created Successfully");

		File screenshot7 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot7,new File(".//ScreenShot//AdmissionCreated.png"));
		...
		/*//.........Validation checking for Status Updated.......//

		Thread.sleep(2000);
		WebElement selectR3=driver.findElement(StatusUpdated);
		String SRActual3=selectR3.getText();
		System.out.println("message : "+SRActual3);
		String expected3="Status Updated";
		Assert.assertEquals(SRActual3,expected3,"Status Updated");*/
