...
public class DocumentManagement_Search_OP_Patient_Upload_Document_Save 
{
		WebDriver driver;
	...
	public void DocumentMgmt_OPD_UploadFIle() throws InterruptedException, IOException
	{
	...
	public DocumentManagement_Search_OP_Patient_Upload_Document_Save(WebDriver driver)
	{
		this.driver=driver;
	}
}
