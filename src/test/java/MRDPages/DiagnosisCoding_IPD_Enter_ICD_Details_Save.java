...
public class DiagnosisCoding_IPD_Enter_ICD_Details_Save 
{
		WebDriver driver;
	...
	By IPDTab=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-diagnosis-coding/mat-sidenav-container/mat-sidenav-content/mat-tab-group/mat-tab-header/div/div/div/div[2]");
	...
	public void DiagnosisCoding_IPD_Enter_ICD_Details() throws InterruptedException, IOException
	{
		...
		Thread.sleep(4000);
		driver.findElement(IPDTab).click();
	...
	public DiagnosisCoding_IPD_Enter_ICD_Details_Save(WebDriver driver)
	{
		this.driver=driver;
	}
}
