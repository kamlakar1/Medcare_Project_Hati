...
public class MRD_File_Requested_Cancel
{
	...
	By Requestnotreq = By.xpath("//span[contains(text(),'Request Not Required')]");
	By Svae = By.xpath("/html/body/div[6]/div[2]/div/mat-dialog-container/app-cancel/div/div[3]/div/button/span[1]/mat-icon");
	...
	public MRD_File_Requested_Cancel(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(5000);
		driver.findElement(volliset).click();
		Thread.sleep(5000);
