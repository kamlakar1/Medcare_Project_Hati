...
public class Medical_Board_Request_Worklist_Edit_Submit_Print_View_details
{
...
By ReportType = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request/div[2]/div/mat-grid-list[1]/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]/mat-select");
	...
	By tariff = By.xpath("//span[contains(text(),'Doctor')]");
	...
	By view = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request-worklist/div[3]/table/tbody/tr/td[16]/a/mat-icon");
	//======================================


	public Medical_Board_Request_Worklist_Edit_Submit_Print_View_details(WebDriver driver)
	{
		this.driver=driver;
	}
