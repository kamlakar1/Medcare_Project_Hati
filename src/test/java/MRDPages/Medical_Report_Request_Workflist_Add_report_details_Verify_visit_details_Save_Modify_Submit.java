...
public class Medical_Report_Request_Workflist_Add_report_details_Verify_visit_details_Save_Modify_Submit
{
	...
	By Reportrequest = By.id("70108");
	

	
	By viewdetails = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-report-worklist/div[3]/table/tbody/tr[2]/td[14]/a/mat-icon");	
	
	By VisitDetails = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-details-medical-report-worklist/mat-tab-group/mat-tab-header/div/div/div/div[2]");
	By Edit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-report-worklist/div[3]/table/tbody/tr[2]/td[13]/a[1]/mat-icon");
	
	By Reportremark = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-report-worklist/mat-tab-group/div/mat-tab-body[1]/div/div/div[2]/mat-grid-list[2]/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]/input");
	By saveandsubmit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-report-worklist/div[3]/mat-grid-list/div/mat-grid-tile[2]/div/div/button[2]/span[1]/mat-icon");
	
	By duedtaereson = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-report-worklist/mat-tab-group/div/mat-tab-body[1]/div/div/div[2]/div[2]/mat-grid-list/div/mat-grid-tile[2]/div/mat-form-field/div/div[1]/div[3]/mat-select/div/div[1]/span");
	
	By damage =  By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[2]/span");
	//======================================
	
	
	public Medical_Report_Request_Workflist_Add_report_details_Verify_visit_details_Save_Modify_Submit(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(5000);
        driver.findElement(Reportremark).sendKeys("good");
        Thread.sleep(5000);
        driver.findElement(duedtaereson).click();
        Thread.sleep(5000);
