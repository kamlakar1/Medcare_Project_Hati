...
public class View_Details_Medical_Report_Request_Workflist_Add_report_details_Verify_visit_details_Save
{
	...
	public View_Details_Medical_Report_Request_Workflist_Add_report_details_Verify_visit_details_Save(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys("HISCKLMRN24411718");
		Thread.sleep(5000);
		driver.findElement(sercahghh).click();
        Thread.sleep(5000);
        JavascriptExecutor js = (JavascriptExecutor) driver;
        WebElement  remark = driver.findElement(By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-report-worklist/div[3]/table/thead/tr/th[15]"));
        js.executeScript("arguments[0].scrollIntoView();",remark);
        Thread.sleep(5000);
        driver.findElement(viewdetails).click();
        Thread.sleep(5000);
        driver.findElement(VisitDetails).click();
