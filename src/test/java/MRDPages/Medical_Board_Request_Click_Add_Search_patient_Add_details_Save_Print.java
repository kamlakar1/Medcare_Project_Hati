...
public class Medical_Board_Request_Click_Add_Search_patient_Add_details_Save_Print
{
	...
	public Medical_Board_Request_Click_Add_Search_patient_Add_details_Save_Print(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(6000);
        driver.findElement(printttt).click();
        Thread.sleep(5000);
