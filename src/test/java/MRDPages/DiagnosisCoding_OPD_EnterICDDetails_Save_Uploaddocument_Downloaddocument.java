...
public class DiagnosisCoding_OPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument 
{
		WebDriver driver;
	...
	public DiagnosisCoding_OPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument(WebDriver driver)
	{
		this.driver=driver;
	}
}
