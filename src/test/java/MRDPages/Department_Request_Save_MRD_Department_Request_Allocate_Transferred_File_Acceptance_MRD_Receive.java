...
public class Department_Request_Save_MRD_Department_Request_Allocate_Transferred_File_Acceptance_MRD_Receive
{
	...
	By Emergencyopt = By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[1]/span");
	By Reason = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-department-rqeuest/div[2]/div/div/mat-grid-list[3]/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]/mat-select");
	By returnreq = By.xpath("//span[contains(text(),'Return Required')]");
	...
	By JevalaOPT = By.xpath("//span[contains(text(),'KUMARESAN')]");
	...
	By generalmedicin = By.xpath("//span[contains(text(),'General Medicine')]");
	...
	By firstfloor = By.xpath("//span[contains(text(),'First Floor')]");
	...
	By checkboxxxx = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-mrd-request/mat-tab-group/div/mat-tab-body[2]/div/div/table/tbody/tr[1]/td[1]/mat-checkbox");

	By Filemamngemt = By.id("70001");

	//By mmrrnn = By.xpath("/html/body/div[2]/div[2]/div/div/div/div/form/div[2]/div[1]/mat-form-field/div/div[1]/div[3]/input");
	By mmrrnn = By.cssSelector("input[ng-reflect-placeholder='Patient MRN']");
	By departmentreq= By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-mrd-request/mat-tab-group/mat-tab-header/div/div/div/div[2]");
	//======================================
	...
	By addvolquntity_1 = By.xpath("/html/body/div[5]/div[2]/div/mat-dialog-container/app-add-volume/div[2]/mat-grid-list[1]/div/mat-grid-tile/div/mat-form-field/div/div[1]/div[3]/input");
	public Department_Request_Save_MRD_Department_Request_Allocate_Transferred_File_Acceptance_MRD_Receive(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		driver.findElement(Departmentreq).click();
		Thread.sleep(5000);

		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(mmrrnn).sendKeys(kk);
		Thread.sleep(5000);
		driver.findElement(sercahghh).click();
		Thread.sleep(5000);

		driver.findElement(Visite_Type ).click();
		Thread.sleep(5000);
		driver.findElement(Emergencyopt).click();
		Thread.sleep(5000);
		driver.findElement(Reason).click();
		Thread.sleep(5000);
		driver.findElement(returnreq).click();
		Thread.sleep(5000);
		driver.findElement(RequestedBy).click();
		Thread.sleep(5000);
		driver.findElement(JevalaOPT).click();
		Thread.sleep(5000);
		driver.findElement(To_department).click();
		Thread.sleep(5000);
		driver.findElement(generalmedicin).click();
		Thread.sleep(5000);
		driver.findElement(Requstedlocation).click();
		Thread.sleep(5000);
		driver.findElement(firstfloor).click();
		Thread.sleep(5000);
		driver.findElement(adddd).click();
		Thread.sleep(5000);
		driver.findElement(checkkk).click();
		Thread.sleep(5000);
		...
		WebElement overforopdslide0=driver.findElement(SideBarMenu);
		actt.moveToElement(overforopdslide0).perform();
		Thread.sleep(5000);
		driver.findElement(Filemamngemt).click();
		Thread.sleep(5000);
		...
		driver.findElement(departmentreq).click();
		Thread.sleep(5000);
		driver.findElement(checkboxxxx).click();
		Thread.sleep(5000);
		...
		Thread.sleep(5000);
		driver.findElement(volslistcheckbox).click();
		Thread.sleep(5000);
		driver.findElement(voladdd).click();
		Thread.sleep(5000);

		 */
		driver.findElement(Allocate).click();
		Thread.sleep(5000);
		driver.findElement(Yessss).click();
		Thread.sleep(5000);
