...
public class DiagnosisCoding_OPD_Uploaddocument_Save 
{
		WebDriver driver;
	...
	public void DiagnosisCoding_OPD_UploadFIle_Save() throws InterruptedException, IOException
	{
	...
	public DiagnosisCoding_OPD_Uploaddocument_Save(WebDriver driver)
	{
		this.driver=driver;
	}
}
