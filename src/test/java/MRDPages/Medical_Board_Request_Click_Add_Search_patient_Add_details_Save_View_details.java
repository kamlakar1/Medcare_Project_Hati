...
public class Medical_Board_Request_Click_Add_Search_patient_Add_details_Save_View_details
{
...
By mrnnn = By.cssSelector("input[data-placeholder='Patient MRN']");
	...
	public Medical_Board_Request_Click_Add_Search_patient_Add_details_Save_View_details(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(5000);
        driver.findElement(viewdetialss).click();
        Thread.sleep(5000);
