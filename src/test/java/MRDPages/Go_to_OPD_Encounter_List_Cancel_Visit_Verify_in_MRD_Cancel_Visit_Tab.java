...
public class Go_to_OPD_Encounter_List_Cancel_Visit_Verify_in_MRD_Cancel_Visit_Tab
{
	...
	By Registeartionn = By.id("2004");
	By Encounterlist = By.id("2006");
	By mrnm = By.xpath("/html/body/div[3]/div[2]/div/div/div/div/form/div[2]/div[2]/mat-form-field/div/div[1]/div[3]/input");
	By Cancellm= By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-patient-encounter-list/div[1]/mat-grid-list/div/mat-grid-tile[1]/div/div/button[8]/span[1]/img");
	By reson = By.xpath("/html/body/div[3]/div[2]/div/mat-dialog-container/app-confirm-remarks/div/form/div[2]/mat-form-field[1]/div/div[1]/div[3]/mat-select");
	By encountercalcel = By.xpath("/html/body/div[3]/div[4]/div/div/div/mat-option[2]/span");
	By Yressss  = By.xpath("/html/body/div[3]/div[2]/div/mat-dialog-container/app-confirm-remarks/div/form/div[3]/div/button[1]/span[1]/mat-icon");
	By reqopt = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-mrd-request/mat-grid-list/div/mat-grid-tile[6]/div/mat-form-field/div/div[1]/div[3]/a/mat-select");
	By Transafer = By.xpath("/html/body/div[3]/div[2]/div/div/div/mat-option[3]/span");
	By CancelVist = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-mrd-request/mat-tab-group/mat-tab-header/div/div/div/div[3]");
	
	public Go_to_OPD_Encounter_List_Cancel_Visit_Verify_in_MRD_Cancel_Visit_Tab(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(5000);
		driver.findElement(Registeartionn).click();
		Thread.sleep(5000);
		driver.findElement(Encounterlist).click();
		Thread.sleep(5000);
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(mrnm).sendKeys("");
		Thread.sleep(5000);
		driver.findElement(sercahghh).sendKeys("");
		Thread.sleep(5000);
		driver.findElement(Cancellm).click();
		Thread.sleep(5000);
		driver.findElement(reson).click();
		Thread.sleep(5000);
		driver.findElement(Yressss).click();
		Thread.sleep(5000);
		driver.findElement(mainmenu).click();
		Thread.sleep(5000);
		//BillIcon
		...
		driver.findElement(reqopt).click();
		Thread.sleep(5000);
		driver.findElement(Transafer).click();
		Thread.sleep(5000);
        driver.findElement(CancelVist).click();
        Thread.sleep(5000);
