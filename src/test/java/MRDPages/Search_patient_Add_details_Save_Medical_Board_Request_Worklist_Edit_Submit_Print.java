...
public class Search_patient_Add_details_Save_Medical_Board_Request_Worklist_Edit_Submit_Print
{
	...
	By tariff = By.xpath("/html/body/div[5]/div[2]/div/div/div/mat-option[2]/span");
	...
	By printtttt = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request-worklist/div[3]/table/tbody/tr/td[15]/a[2]/mat-icon");
	//======================================
	
	
	public Search_patient_Add_details_Save_Medical_Board_Request_Worklist_Edit_Submit_Print(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys("HISCKLMRN24411804");
		Thread.sleep(5000);
		driver.findElement(sercahghh).click();
		Thread.sleep(5000);
		driver.findElement(printtttt).click();
		Thread.sleep(5000);
		/*
		driver.findElement(Typeee).click();
		Thread.sleep(5000);
		...
		driver.findElement(saveworklist).click();
		Thread.sleep(5000);
