...
public class DocumentManagement_Search_OP_Patient_Upload_Document_Save_Delete 
{
		WebDriver driver;
	...
	By SampleRow=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-document-upload-management/mat-sidenav-container/mat-sidenav-content/mat-tab-group[1]/div/mat-tab-body/div/div/table/tbody/mat-row");
	...
	By Delete=By.cssSelector("mat-icon[ng-reflect-message='Delete Document']");
	By SelectReason=By.cssSelector("mat-select[ng-reflect-placeholder='Select reason']");
	By SelectReasonSelOPt=By.xpath("//span[contains(text(),'File Not Required')]");
	By ReasonSave=By.cssSelector("mat-icon[ng-reflect-message='Cancel']");
	public void DocumentMgmt_OPD_UploadFIle_Delete() throws InterruptedException, IOException
	{
		...
		WebElement DeleteFile = wait.until(ExpectedConditions.elementToBeClickable(Delete)); 
		DeleteFile.click();
		
		Thread.sleep(3000);
		WebElement ReasonSelect = wait.until(ExpectedConditions.elementToBeClickable(SelectReason)); 
		ReasonSelect.click();
		
		Thread.sleep(3000);
		WebElement ReasonSelectOPT = wait.until(ExpectedConditions.elementToBeClickable(SelectReasonSelOPt)); 
		ReasonSelectOPT.click();
		
		Thread.sleep(3000);
		WebElement SaveReason = wait.until(ExpectedConditions.elementToBeClickable(ReasonSave)); 
		SaveReason.click();
	...
	public DocumentManagement_Search_OP_Patient_Upload_Document_Save_Delete(WebDriver driver)
	{
		this.driver=driver;
	}
}
