...
public class Medical_Board_Request_Click_Details_Dispatch_View_report
{
	...
	By DispatchMode = By.xpath("/html/body/div[5]/div[2]/div/mat-dialog-container/app-dispatch-details/div[2]/mat-grid-list[5]/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]/mat-select");
	By Testing = By.xpath("//span[contains(text(),'Testing')]");
	By Svaedispatch = By.cssSelector("mat-icon[ng-reflect-message='Save']");
	//======================================


	public Medical_Board_Request_Click_Details_Dispatch_View_report(WebDriver driver)
	{
		this.driver=driver;
	}
