...
public class Search_patient_Add_details_Save_Medical_Board_Request_Worklist_Edit_Submit
{
	...
	public Search_patient_Add_details_Save_Medical_Board_Request_Worklist_Edit_Submit(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(5000);
		driver.findElement(editworklist).click();
		Thread.sleep(5000);
