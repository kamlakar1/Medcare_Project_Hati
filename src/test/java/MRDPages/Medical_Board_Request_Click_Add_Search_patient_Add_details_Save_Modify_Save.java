...
public class Medical_Board_Request_Click_Add_Search_patient_Add_details_Save_Modify_Save
{
	...
	By viewdetialss = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[3]/table/tbody/tr[1]/td[16]/a/mat-icon");
	By Editt = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[3]/table/tbody/tr[2]/td[15]/a[1]/mat-icon");
	By ReturnRequired = By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[4]/span");
	By savemodify = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request/div[4]/mat-grid-list/div/mat-grid-tile[2]/div/div/button[2]/span[1]/mat-icon");
	By Resonforrequred_2 = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request/div[3]/div/mat-grid-list[1]/div/mat-grid-tile[3]/div/mat-form-field/div/div[1]/div[3]/mat-select");
	
	
	By Requestedbyget = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[3]/table/tbody/tr[4]/td[10]");
	//======================================
	
	
	public Medical_Board_Request_Click_Add_Search_patient_Add_details_Save_Modify_Save(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys("HISCKLMRN24411729");
		Thread.sleep(5000);
        ...
        Thread.sleep(5000);
		driver.findElement(MRNN).sendKeys("HISCKLMRN24411729");
		Thread.sleep(5000);
		driver.findElement(sercahghh).click();
		Thread.sleep(5000);
        driver.findElement(ReportType).click();
        Thread.sleep(5000);
        driver.findElement(govservent).click();
        Thread.sleep(5000);
        driver.findElement(Requestedby).sendKeys("Azhar H");
        Thread.sleep(5000);
        driver.findElement(Resonforreq).click();
        Thread.sleep(5000);
        driver.findElement(Damage).click();
        Thread.sleep(5000);
        driver.findElement(DueDuration).click();
        Thread.sleep(5000);
        driver.findElement(threedays).click();
        Thread.sleep(5000);
        driver.findElement(savedudate).click();
        Thread.sleep(5000);
        driver.findElement(Yessss).click();
        Thread.sleep(5000);
        JavascriptExecutor js = (JavascriptExecutor) driver;
        WebElement  Viewdetails = driver.findElement(By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[3]/table/tbody/tr[1]/td[16]/a/mat-icon"));
        js.executeScript("arguments[0].scrollIntoView();",Viewdetails);
        Thread.sleep(6000);
        driver.findElement(Editt).click();
        Thread.sleep(5000);
        driver.findElement(Resonforrequred_2).click();
        Thread.sleep(5000);
        driver.findElement(ReturnRequired).click();
        Thread.sleep(5000);
        driver.findElement(savemodify).click();
        Thread.sleep(5000);
        driver.findElement(Yessss).click();
        Thread.sleep(5000);
        ...
        Thread.sleep(5000);
        String getReqby = driver.findElement(Requestedbyget).getText();
        String Actual_1 = getReqby;
		String Expected_1 = "Return Required";
		Thread.sleep(5000);
		Assert.assertEquals(Actual_1, Expected_1, "Modified successfully");
		Thread.sleep(5000);
