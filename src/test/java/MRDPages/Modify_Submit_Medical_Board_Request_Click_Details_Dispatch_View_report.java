...
public class Modify_Submit_Medical_Board_Request_Click_Details_Dispatch_View_report
{
	...
	By printtt = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[3]/table/tbody/tr[1]/td[15]/a[2]/mat-icon");
	...
	By MedicalReport = By.id("70010");
	By Reportrequest = By.id("70109");
	...
	By Addbutton = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[2]/button[2]/span[1]/mat-icon");
	By ReportType = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request/div[2]/div/mat-grid-list[1]/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]/mat-select");
	By govservent = By.xpath("//span[contains(text(),'Government servant')]");
	By Requestedby = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request/div[2]/div/mat-grid-list[1]/div/mat-grid-tile[2]/div/mat-form-field/div/div[1]/div[3]/input");
	By Resonforreq = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request/div[2]/div/mat-grid-list[1]/div/mat-grid-tile[3]/div/mat-form-field/div/div[1]/div[3]/mat-select");
	By Damage = By.xpath("//span[contains(text(),'Return Required')]");
	By DueDuration = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request/div[2]/div/mat-grid-list[1]/div/mat-grid-tile[4]/div/mat-form-field/div/div[1]/div[3]/mat-select");
	By threedays = By.xpath("//span[contains(text(),'10 days')]");
	By savedudate = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request/div[3]/mat-grid-list/div/mat-grid-tile[2]/div/div/button[2]/span[1]/mat-icon");
	By MRNN = By.cssSelector("input[ng-reflect-name='mrn']");
	By printttt = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[3]/table/tbody/tr[2]/td[15]/a[2]/mat-icon");
	By editworklist = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request-worklist/div[3]/table/tbody/tr/td[15]/a[1]/mat-icon");
	By Typeee = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request-worklist/div[4]/div[2]/div[2]/mat-grid-list/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]/mat-select");
	By tariff = By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[1]/span");
	By saveworklist = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[3]/table/thead/tr/th[16]");

	By saveandsubmit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-addnew-medical-board-request-worklist/div[7]/mat-grid-list/div/mat-grid-tile[2]/div/div/button[3]/span[1]/mat-icon");
	By view = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[3]/table/tbody/tr[1]/td[16]/a/mat-icon");
	By Dispatch = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-details-medical-board-request/div[3]/mat-grid-list/div/mat-grid-tile[1]/div/button[1]/span[1]/mat-icon");
	By DispatchMode = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-dispatch-details/div[2]/mat-grid-list[5]/div/mat-grid-tile[1]/div/mat-form-field/div/div[1]/div[3]/mat-select");
	By Testing = By.xpath("//span[contains(text(),'Testing')]");
	By Courier = By.xpath("//span[contains(text(),'Courier')]");
	By Svaedispatch = By.cssSelector("mat-icon[ng-reflect-message='Save']");
	
	By detailss =By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-board-request/div[3]/table/tbody/tr/td[16]/a/mat-icon");
	//======================================
	...
	public Modify_Submit_Medical_Board_Request_Click_Details_Dispatch_View_report(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys("HISCKL230700543");
		Thread.sleep(5000);
		driver.findElement(sercahghh).click();
		Thread.sleep(5000);
		
		WebElement element = driver.findElement(saveworklist);
		...
		Thread.sleep(5000);
		driver.findElement(DispatchMode).click();
		Thread.sleep(5000);
		driver.findElement(Testing).click();
		Thread.sleep(5000);
		driver.findElement(Svaedispatch).click();
		Thread.sleep(5000);
	//	driver.findElement(view).click();
		...
		Thread.sleep(5000);	
		 ...
		 Robot robot1 = new Robot(); for (int i = 0; i < 5; i++) {
				robot1.keyPress(KeyEvent.VK_CONTROL); robot.keyPress(KeyEvent.VK_SUBTRACT);
