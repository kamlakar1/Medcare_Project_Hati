...
By mrnnn = By.cssSelector("input[data-placeholder='Patient MRN']");
	...
	By viewdetails = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-medical-report-worklist/div[3]/table/tbody/tr/td[14]/a/mat-icon");	
	...
	public Medical_Report_Request_Workflist_Add_report_details_Verify_visit_details_Submit(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
        ...
        Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys("HISCKLMRN24411743");
		Thread.sleep(5000);
