...
public class Encounter_List_Advanced_Search_By_MRN 
{
	...
	{
		OPDpages.Encounter_List_Screen_Advanced_Search_BY_MRN advanced=new OPDpages.Encounter_List_Screen_Advanced_Search_BY_MRN(driver);
	...
	public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	{
		...
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","Encounter_List_Advanced_Search_By_MRN -"+dateFormat.format(date),false);
		recorder.start();
