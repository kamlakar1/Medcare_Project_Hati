...
public class OPD_Reg_With_OLD_IC 
{
	 WebDriver driver ;
	...
	public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	{
		...
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","OPD_Reg_With_OLD_IC -"+dateFormat.format(date),false);
		recorder.start();
