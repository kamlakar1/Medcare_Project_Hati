...
public class OPD_Reg_ID_NEW_IC_With_VIP_Patient 
{
	 WebDriver driver;
...
public void startBrowser() throws ATUTestRecorderException, InterruptedException 
{
	...
	Date date = new Date();
	recorder = new ATUTestRecorder(".//Videos//","OPD_Reg_ID_NEW_IC_With_VIP_Patient -"+dateFormat.format(date),false);
	recorder.start();
