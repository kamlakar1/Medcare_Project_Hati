...
import OPDpages.Quick_Registration_For_Existing_Patient_with_NewIC;
import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
import io.github.bonigarcia.wdm.WebDriverManager;

public class Quick_Registration_Existing_Patient_with_NewIC_Test 
{
	 WebDriver driver ;
	...
	public void TC_02_Verify_That_User_Is_Able_To_Do_Quick_Registration_NewIC(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar) throws InterruptedException, IOException
	{
		Quick_Registration_For_Existing_Patient_with_NewIC QuickReg=new Quick_Registration_For_Existing_Patient_with_NewIC(driver);
		QuickReg.Quick_Registration_With_Existing_With_NewIC(QuickPrimaryIdNumberPar,QuickExparyDatePar,QuickDateOfBirthPar,QuickMobileNumberPar,QuickEncounterRemarksPar,QuickAddNotesPar,QuickEncounterNotesPar,QuickPatientNotesPar,QuickReferralRemarksPar);
		Thread.sleep(10000);
	}
	...
	public void beforeTest() throws InterruptedException, ATUTestRecorderException {
		...
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","Quick_Registration_Existing_Patient_with_NewIC_Test -"+dateFormat.format(date),false);
		recorder.start();
