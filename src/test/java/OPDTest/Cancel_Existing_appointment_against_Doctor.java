...
import OPDpages.Cancel_Existing_Appointment_doctor;
import OPDpages.Cancel_existing_appointment_against_doctor_Quick_Registration;
...
public void TC_03_Verify_that_user_is_able_to_book_the_Existing_appointment__against_doctor_to_cancel_appointment(String AppointmenttypeA, String consultationA, String specialityA, String EmailA, String WorkcontctA, String HomecontactA, String RemarksA)throws InterruptedException, AWTException, IOException {
	Cancel_Existing_Appointment_doctor BookExitingAppointment = new Cancel_Existing_Appointment_doctor(driver);
...
public void TC_04_Verify_that_Existing_appointment_is_cancelled_succsessfull_against_doctor(String RemarksPar) throws InterruptedException, AWTException, IOException { 
	...
	public void beforeTest() throws InterruptedException, ATUTestRecorderException {
		...
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","Cancel_Existing_appointment_against_Doctor-"+dateFormat.format(date),false);
		recorder.start();
