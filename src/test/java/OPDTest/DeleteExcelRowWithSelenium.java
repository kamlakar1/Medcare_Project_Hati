...
public class DeleteExcelRowWithSelenium {
	...
	public  double TkaePatientName;

	//public static  String TakePatientName = kk;
	
	//public static void main(String[] args) {
	// Set the path to your Excel file
	String excelFilePath = "C:\\Users\\Kamlakar\\git\\Medcare_Automation_Framework\\MedcareFramrwork_id-backend\\MRDMRN.xlsx.xlsx";
	{
		...
		try (FileInputStream fis = new FileInputStream(excelFilePath);
			...
			if (row != null) {
				...
				while (cellIterator.hasNext()) {
					...
					TkaePatientName = cell.getNumericCellValue();
