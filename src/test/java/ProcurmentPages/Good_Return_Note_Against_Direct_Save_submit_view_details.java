...
public class Good_Return_Note_Against_Direct_Save_submit_view_details {
	...
	By Save = By.cssSelector("button[ng-reflect-message='Save & Submit']");
	By 	Yes = By.cssSelector("button[ng-reflect-message='Yes']");
	public Good_Return_Note_Against_Direct_Save_submit_view_details (WebDriver driver)
	...
	public void Good_Return_Note_Agaifunc() throws InterruptedException, IOException 
	{
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Good_Return_Note_Against_Direct_Save_submit_view_details.png")); 
		Thread.sleep(1000);
