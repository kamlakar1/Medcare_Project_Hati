...
public class Good_Return_Note_Against_GRN_Save_view_details {
	...
	By Item_name = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-details-goodreturnnote/div[1]/table/tbody/tr/td[2]");
    ...
    By GRN = By.xpath("//span[contains(text(),'GRN')]");
	...
	By ReturnRequiredre = By.xpath("//span[contains(text(),' Damaged')]");
	...
	By fromdatee = By.cssSelector("input[ng-reflect-placeholder='From date']");
	By Todate = By.cssSelector("input[ng-reflect-placeholder='To date']");
	
	By serachgrn = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-against-grn/div/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/a/mat-icon");

	
	By selectrecord  = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-against-grn/div/div[2]/div[1]/mat-table/mat-row[1]/mat-cell[1]");
	By slectcheckbox =By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-against-grn/div/div[2]/div[2]/mat-table/mat-header-row/mat-header-cell[1]/mat-checkbox");
	
	By lastadditem = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-against-grn/div/div[3]/div/button/span[1]/mat-icon");
	
	public Good_Return_Note_Against_GRN_Save_view_details (WebDriver driver)
	...
	public void Good_Return_Note_Against_GRNfunc() throws InterruptedException, IOException, AWTException 
	{
		...
		Thread.sleep(3000);
		driver.findElement(fromdatee).click();
		Thread.sleep(1000);
		WebElement toClear = driver.findElement(fromdatee);
		toClear.sendKeys(Keys.CONTROL + "a");
		toClear.sendKeys(Keys.DELETE);
		Thread.sleep(1000);
		driver.findElement(serachgrn).click();
		Thread.sleep(1000);
		driver.findElement(selectrecord).click();
		Thread.sleep(1000);
		driver.findElement(slectcheckbox).click();
		Thread.sleep(1000);
		driver.findElement(lastadditem).click();
		//Thread.sleep(1000);
	...
	//	driver.findElement(SelectReason).click();
	   ...
	   // driver.findElement(ReturnRequired).click();
		...
		Thread.sleep(1000);
		driver.findElement(ReturnRequiredre).click();
		Thread.sleep(1000);
	...
	//	driver.findElement(recordccheckbox).click();
	    ...
	    Thread.sleep(3000);
	    String IssueListindvrify = driver.findElement(Item_name).getText();
