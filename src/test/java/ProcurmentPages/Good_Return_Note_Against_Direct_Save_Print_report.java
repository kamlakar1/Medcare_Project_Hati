...
public class Good_Return_Note_Against_Direct_Save_Print_report {
	...
	public Good_Return_Note_Against_Direct_Save_Print_report (WebDriver driver)
	...
	public void Good_Return_Note_Agaifunc() throws InterruptedException, IOException, AWTException 
	{
	...
	//	driver.findElement(recordccheckbox).click();
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Good_Return_Note_Against_Direct_Save_Print_report.png")); 
		Thread.sleep(1000);
