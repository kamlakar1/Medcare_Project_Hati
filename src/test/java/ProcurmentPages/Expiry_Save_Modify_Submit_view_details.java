...
public class Expiry_Save_Modify_Submit_view_details {
	...
	By Returnno = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-details-goodreturnnote/div[1]/table/tbody/tr/td[2]");
	...
	By edit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-goodreturnnote/div[2]/div[2]/table/tbody/tr[1]/td[15]/a[1]/mat-icon");
	...
	By AddItemlistcheckbox = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-additem-nearbyexpiry/div/div[2]/div/mat-table/mat-row[4]/mat-cell[1]/mat-checkbox");
	...
	public Expiry_Save_Modify_Submit_view_details (WebDriver driver)
	...
	public void Good_Return_Note_Agaifunnn() throws InterruptedException, IOException, AWTException 
	{
	...
	*/
	...
	//	driver.findElement(recordccheckbox).click();
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Good_Return_Note_Against_Direct_Save_Modify_Submit_view_details.png")); 
		Thread.sleep(1000);
