...
public class Good_Return_Note_Against_Expiry_Save_cancel {
	...
	public Good_Return_Note_Against_Expiry_Save_cancel (WebDriver driver)
	...
	public void Good_Return_Note_Against_Direct_Save_cancelfuncfunc() throws InterruptedException, IOException, AWTException 
	{
	...
	//	driver.findElement(recordccheckbox).click();
		...
		Thread.sleep(1000);
		driver.findElement(Not_resquired).click();
		Thread.sleep(1000);
