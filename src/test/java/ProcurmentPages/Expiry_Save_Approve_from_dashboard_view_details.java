...
public class Expiry_Save_Approve_from_dashboard_view_details {
	...
	public Expiry_Save_Approve_from_dashboard_view_details (WebDriver driver)
	...
	public void Expiry_Save_Approve_from_dashboard_viewfuncc() throws InterruptedException, IOException, AWTException 
	{
	...
	*/
	...
	//	driver.findElement(recordccheckbox).click();
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Expiry_Save_Approve_from_dashboard_view_details.png")); 
		Thread.sleep(1000);
