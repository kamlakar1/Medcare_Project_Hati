...
public class Good_Return_Note_Against_Direct_Save_Modify_Submit_view_details {
	...
	By ReturnRequired = By.xpath("//span[contains(text(),' Not Required ')]");
	...
	public Good_Return_Note_Against_Direct_Save_Modify_Submit_view_details (WebDriver driver)
	...
	public void Good_Return_Note_Agaifun() throws InterruptedException, IOException, AWTException 
	{
