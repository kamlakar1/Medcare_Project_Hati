...
public class Good_Return_Note_Against_Expiry_Save_view_details {
	...
	public Good_Return_Note_Against_Expiry_Save_view_details (WebDriver driver)
	...
	public void Good_Return_Note_Against_Difunc() throws InterruptedException, IOException, AWTException 
	{
	...
	//	driver.findElement(recordccheckbox).click();
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Good_Return_Note_Against_Direct_Save_cancel.png")); 
		Thread.sleep(1000);
