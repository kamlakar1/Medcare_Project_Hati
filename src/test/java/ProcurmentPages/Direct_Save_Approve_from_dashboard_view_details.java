...
public class Direct_Save_Approve_from_dashboard_view_details {
	...
	public Direct_Save_Approve_from_dashboard_view_details (WebDriver driver)
	...
	public void Direct_Save_Approve_frfunc() throws InterruptedException, IOException, AWTException 
	{
	...
	//	driver.findElement(recordccheckbox).click();
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Direct_Save_Approve_from_dashboard_view_details.png")); 
		Thread.sleep(1000);
