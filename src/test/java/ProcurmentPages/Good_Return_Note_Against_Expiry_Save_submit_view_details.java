...
public class Good_Return_Note_Against_Expiry_Save_submit_view_details {
	...
	public Good_Return_Note_Against_Expiry_Save_submit_view_details (WebDriver driver)
	...
	public void Good_Return_Note_Againstfuncc() throws InterruptedException, IOException, AWTException 
	{
	...
	//	driver.findElement(recordccheckbox).click();
		...
		Assert.assertEquals(ActualReturnno, ExpectedReturnno, "Record has been cancelled");
		Thread.sleep(1000);
		File screenshot_10 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Good_Return_Note_Against_Expiry_Save_submit_view_details.png")); 
		Thread.sleep(1000);
