...
public class Good_Return_Note_Against_GRN_Save_submit_view_details {
	...
	public Good_Return_Note_Against_GRN_Save_submit_view_details (WebDriver driver)
	...
	public void Good_Return_Note_Against_funcfunc() throws InterruptedException, IOException, AWTException 
	{
	...
	//	driver.findElement(recordccheckbox).click();
		...
		FileUtils.copyFile(screenshot_10, new File(".//ScreenShots//Good_Return_Note_Against_GRN_Save_submit_view_details.png")); 
		Thread.sleep(1000);
