...
public class DisposalRequestApproval_Approved_Full_PrintReport 
{
	WebDriver driver;
	...
	public void DisposalRequestApproval_Approved_PrintReport() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public DisposalRequestApproval_Approved_Full_PrintReport(WebDriver driver)
	{
		this.driver=driver;
	}
}
