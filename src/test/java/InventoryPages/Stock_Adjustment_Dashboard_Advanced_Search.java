...
public class Stock_Adjustment_Dashboard_Advanced_Search 
{
	WebDriver driver;
	...
	public void Stock_Adjustment_Dashboard_AdvancedSearch() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Stock_Adjustment_Dashboard_Advanced_Search(WebDriver driver)
	{
		this.driver=driver;
	}
}
