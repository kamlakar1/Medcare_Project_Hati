...
public class BatchChange_AddItem_saveAndsubmit_Details 
{
	WebDriver driver;
	...
	//Expiray Date
		...
		public void Batchchange_AddItem_SaveAndSubmit() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Assert.assertEquals(SRActual2,expected2,"Validation message Should Batch Modification Saved Successfully");
	...
	public BatchChange_AddItem_saveAndsubmit_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
