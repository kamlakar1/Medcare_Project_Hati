...
public class DisposalRequest_Against_Item_Save_ApproveFromDashboard_Details 
{
	WebDriver driver;
	...
	By CheckClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-disposalrequest/div[3]/div/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
	...
	By DisposalApproveSaveSucc=By.xpath("//span[contains(text(),'Record Approved Successfully')]");
	
	public void Disposal_Request_Against_Item_Save_Approve_Details() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	/*	Thread.sleep(1000);
		...
		Thread.sleep(2000);
		WebElement selectR2=driver.findElement(DisposalApproveSaveSucc);
		String SRActual2=selectR2.getText();
		System.out.println("message : "+SRActual2);
		String expected2="Record Approved Successfully";
		Assert.assertEquals(SRActual2,expected2,"Validation message Should be Record Approved Successfully");
		

		File screenshot2 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//DisposalRequest_Against_Item_Save_ApproveFromDashboard_Details.png")); 

	}
	public DisposalRequest_Against_Item_Save_ApproveFromDashboard_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
