...
public class Material_Consumption_Add_AddItem_Save_details 
{
	WebDriver driver;
	...
	public void MaterialConsumption_AddItem_Save() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Material_Consumption_Add_AddItem_Save_details(WebDriver driver)
	{
		this.driver=driver;
	}
}
