...
public class Stock_Adjustment_Add_Item_Write_Off_Save_View_Details 
{
	WebDriver driver;
	...
	public void Stock_Adjustment_AddItem_For_Write_Off() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Stock_Adjustment_Add_Item_Write_Off_Save_View_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
