...
public class Batch_Change_Approval_Approve_View_details 
{
	WebDriver driver;
	...
	By ViewDeatailClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-batchchangeapproval/div[1]/div/mat-table/mat-row/mat-cell[10]/a/mat-icon");
	
	By GetTextNewBatch=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-details-batchchangeapproval/div/div[1]/mat-table/mat-row/mat-cell[9]");
	public void Batchchange_SaveAndSubmit_ApproveFromDashBoard_ViewDetails() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(3000);
		driver.findElement(ViewDeatailClick).click();
		
		Thread.sleep(3000);
		WebElement NewBatch=driver.findElement(GetTextNewBatch);
		String GetNewBatch=NewBatch.getText();
		System.out.println("message : "+GetNewBatch);
		
		Thread.sleep(2000);
		WebElement selectR4=driver.findElement(GetTextNewBatch);
		String SRActual4=selectR4.getText();
		System.out.println("message : "+SRActual4);
		String expected4="NEWBATCH22";
		Assert.assertEquals(SRActual4,expected4,"New Batch no should be equal");
		
		File screenshot2 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Batch_Change_Approval_Approve_View_details.png")); 

	}
	public Batch_Change_Approval_Approve_View_details(WebDriver driver)
	{
		this.driver=driver;
	}
}
