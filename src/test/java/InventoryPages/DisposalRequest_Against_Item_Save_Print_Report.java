...
public class DisposalRequest_Against_Item_Save_Print_Report 
{
	WebDriver driver;
	...
	public void Disposal_Request_Against_Item_Save_PrintReport() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public DisposalRequest_Against_Item_Save_Print_Report(WebDriver driver)
	{
		this.driver=driver;
	}
}
