...
public class DisposalRequest_Against_Item_Save_Cancel 
{
	WebDriver driver;
	...
	public void Disposal_Request_Against_Item_Save_Cancel() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public DisposalRequest_Against_Item_Save_Cancel(WebDriver driver)
	{
		this.driver=driver;
	}
}
