...
public class DisposalWorklist_Disposed_Method_Dustbin_Save_Print 
{
	WebDriver driver;
	...
	By PrintReport=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-disposalworklist/div[3]/div/mat-table/mat-row[1]/mat-cell[14]/a");
public void DisposalWorklist_DustBin_Save_PrintReport() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public DisposalWorklist_Disposed_Method_Dustbin_Save_Print(WebDriver driver)
	{
		this.driver=driver;
	}
}
