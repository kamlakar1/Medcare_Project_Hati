...
public class DisposalRequest_Against_Expired_save_Modify_SaveAndSubmit_details 
{
	WebDriver driver;
	...
	public DisposalRequest_Against_Expired_save_Modify_SaveAndSubmit_details(WebDriver driver)
	{
		this.driver=driver;
	}
}
