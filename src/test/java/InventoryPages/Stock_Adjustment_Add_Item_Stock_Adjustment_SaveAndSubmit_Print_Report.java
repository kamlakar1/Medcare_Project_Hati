...
public class Stock_Adjustment_Add_Item_Stock_Adjustment_SaveAndSubmit_Print_Report 
{
	WebDriver driver;
	...
	//View deatails
	By PrintClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-stockadjustment/div[3]/div/mat-table/mat-row[1]/mat-cell[10]/a[2]/mat-icon");
	
	
	public void Stock_Adjustment_AddItem_For_StockAdjustment_Save_Print() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Stock_Adjustment_Add_Item_Stock_Adjustment_SaveAndSubmit_Print_Report(WebDriver driver)
	{
		this.driver=driver;
	}
}
