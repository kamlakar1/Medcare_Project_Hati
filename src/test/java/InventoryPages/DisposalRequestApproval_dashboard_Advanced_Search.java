...
public class DisposalRequestApproval_dashboard_Advanced_Search 
{
	WebDriver driver;
	...
	By StatusSelOpt=By.xpath("//mat-option//span[contains(text(),'Pending')]");
	
	//Store Select
	By SelectStoreClick=By.cssSelector("mat-select[ng-reflect-placeholder='Select Store']");
	By SelectStoreSelOpt=By.xpath("//span[contains(text(),'OP Store 1')]");
	//Click on search button
	By SearchCLick2=By.cssSelector("button[type='submit']");

	public void DisposalRequestApproval_Advanced_Search() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//DisposalRequestApproval_dashboard_Advanced_Search.png")); 

	}
	public DisposalRequestApproval_dashboard_Advanced_Search(WebDriver driver)
	{
		this.driver=driver;
	}
}
