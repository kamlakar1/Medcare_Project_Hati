...
public class Opening_Balance_Add_item_Enter_item_details_Save_Print_Report 
{
	WebDriver driver;
	...
	By PrintButton=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-openingbalance/div[3]/mat-table/mat-row[1]/mat-cell[8]/a[2]/mat-icon");

	
	public void User_Can_Create_Opening_Balance_Save_Print_Report(String IteamGroupPar,String IteamCategoryPar,String IteamCodePar,String IteamNamePar,String BatchNoPar,String ExpirayDatePar,String QuantityPar) throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Opening_Balance_Add_item_Enter_item_details_Save_Print_Report.png")); 
	}
	public Opening_Balance_Add_item_Enter_item_details_Save_Print_Report(WebDriver driver)
	{
		this.driver=driver;
	}
}
