...
public class DisposalWorklist_Disposed_Method_Burn_Save 
{
	WebDriver driver;
	...
	By DisposalMethodSelOpt=By.xpath("//span[contains(text(),'Burned')]");
...
public void DisposalWorklist_Burn_Save() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public DisposalWorklist_Disposed_Method_Burn_Save(WebDriver driver)
	{
		this.driver=driver;
	}
}
