...
public class Material_Consumption_Approvall_approved_partially_details 
{
	WebDriver driver;
	...
	By DetailClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialconsumptionapproval/div[2]/div/mat-table/mat-row[1]/mat-cell[11]/a");
	By CheckEdit=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-details-materialconsumptionapproval/div[2]/div[1]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
	By AcceptQTYClick1=By.cssSelector("input[ng-reflect-type='number']");
	...
	By ApproveSuc=By.xpath("//span[contains(text(),'Material Consumption Approved Saved Successfully')]");

	public void MaterialConsumptionApproval_Save_Approve_Partially() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(DetailClick).click();
		
		Thread.sleep(2000);
		driver.findElement(CheckEdit).click();
		
		Thread.sleep(2000);
        WebElement toClear = driver.findElement(AcceptQTYClick1);
        toClear.sendKeys(Keys.CONTROL + "a");
        toClear.sendKeys(Keys.DELETE);
        
        Thread.sleep(2000);
		driver.findElement(AcceptQTYClick1).sendKeys("3");
		...
		String expected1="Material Consumption Approved Saved Successfully";
		Assert.assertEquals(SRActual1,expected1,"Validation message Should be Please select reason");

		File screenshot2 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Material_Consumption_Approvall_approvedFull_Details.png")); 

	}
	public Material_Consumption_Approvall_approved_partially_details(WebDriver driver)
	{
		this.driver=driver;
	}
}
