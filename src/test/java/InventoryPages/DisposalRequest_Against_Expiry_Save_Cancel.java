...
public class DisposalRequest_Against_Expiry_Save_Cancel 
{
	WebDriver driver;
	...
	//Item Check box 
	By CheckBoxClick=By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-additem-nearbyexpiry/div/div[2]/div/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
	//add button click
	...
	//Cancel button
	By CancelButton=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-disposalrequest/div[3]/div/mat-table/mat-row[1]/mat-cell[12]/a[3]");
	...
	By CancelSucc=By.xpath("//span[contains(text(),'Disposal request cancelled')]");

	public void Disposal_Request_Against_Expiry_Save_Cancel() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		String expected1="Disposal request cancelled";
		Assert.assertEquals(SRActual1,expected1,"Validation message Should be Disposal Request Cancelled");
	...
	public DisposalRequest_Against_Expiry_Save_Cancel(WebDriver driver)
	{
		this.driver=driver;
	}
}
