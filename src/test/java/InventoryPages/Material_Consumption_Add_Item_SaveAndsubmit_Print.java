...
public class Material_Consumption_Add_Item_SaveAndsubmit_Print 
{
	WebDriver driver;
	...
	By PrintBtnCLick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialconsumption/div[3]/div/mat-table/mat-row/mat-cell[10]/a[2]");
	public void MaterialConsumption_AddItem_SaveAndSubmit_Print() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Material_Consumption_Add_Item_SaveAndsubmit_details.png")); 

	}
	public Material_Consumption_Add_Item_SaveAndsubmit_Print(WebDriver driver)
	{
		this.driver=driver;
	}
}
