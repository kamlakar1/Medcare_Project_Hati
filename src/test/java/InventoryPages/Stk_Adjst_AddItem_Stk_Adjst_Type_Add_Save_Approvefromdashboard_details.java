...
public class Stk_Adjst_AddItem_Stk_Adjst_Type_Add_Save_Approvefromdashboard_details 
{
	WebDriver driver;
	...
	//View deatails
	By CheckBoxClick2=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-stockadjustment/div[3]/div/mat-table/mat-row[1]/td/mat-checkbox");
	//Approve
	...
	public void Stock_Adjustment_AddItem_For_Stock_adjustment_Save_ApproveFromDashboard() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(CheckBoxClick2).click();
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Stock_Adjustment_Add_Item_Write_Off_Save_Approve_from_dashboard_View_details.png")); 

	}
	public Stk_Adjst_AddItem_Stk_Adjst_Type_Add_Save_Approvefromdashboard_details(WebDriver driver)
	{
		this.driver=driver;
	}
}
