...
public class Disposal_request_dashboard_Advanced_Search 
{
	WebDriver driver;
	...
	By StatusSelOpt=By.xpath("//span[contains(text(),'New')]");
	...
	public void Disposal_Request_Advanced_Search() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Disposal_request_dashboard_Advanced_Search.png")); 

	}
	public Disposal_request_dashboard_Advanced_Search(WebDriver driver)
	{
		this.driver=driver;
	}
}
