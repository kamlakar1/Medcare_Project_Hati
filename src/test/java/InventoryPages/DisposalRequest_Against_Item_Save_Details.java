...
public class DisposalRequest_Against_Item_Save_Details 
{
	WebDriver driver;
	...
	public void Disposal_Request_Against_Item_Save_Details() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public DisposalRequest_Against_Item_Save_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
