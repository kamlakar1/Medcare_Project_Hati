...
public class Stock_Adjustment_Add_Item_Stock_Adjustment_Save_And_Submit_view_details 
{
	WebDriver driver;
	...
	public void Stock_Adjustment_AddItem_For_Stock_Adjustment_SaveANDSubmit() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Stock_Adjustment_Save_And_Submit.png")); 

	}
	public Stock_Adjustment_Add_Item_Stock_Adjustment_Save_And_Submit_view_details(WebDriver driver)
	{
		this.driver=driver;
	}
}
