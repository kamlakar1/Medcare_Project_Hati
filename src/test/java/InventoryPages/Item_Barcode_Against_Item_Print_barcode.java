...
public class Item_Barcode_Against_Item_Print_barcode 
{
	WebDriver driver;
...
//Selecting store
	...
	public void User_Can_Create_Opening_Balance_Print_Barcode(String IteamGroupPar,String IteamCategoryPar,String IteamCodePar,String IteamNamePar,String BatchNoPar,String ExpirayDatePar,String QuantityPar) throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Item_Barcode_Against_Item_Print_barcode.png")); 

	}
	public Item_Barcode_Against_Item_Print_barcode(WebDriver driver)
	{
		this.driver=driver;
	}
}
