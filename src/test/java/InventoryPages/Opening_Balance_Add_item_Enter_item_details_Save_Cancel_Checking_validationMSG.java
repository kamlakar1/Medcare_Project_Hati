...
public class Opening_Balance_Add_item_Enter_item_details_Save_Cancel_Checking_validationMSG 
{
	WebDriver driver;
	...
	By CancelButton=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-openingbalance/div[3]/mat-table/mat-row[1]/mat-cell[8]/a[3]");

	//Cancelreason drop down
	By CancelReasonClick=By.cssSelector("mat-select[ng-reflect-placeholder='Select Reason']");
	By CancelReasonSelOpt=By.xpath("//span[contains(text(),'Not Required')]");
	By CancelSave=By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-cancel/div/div[3]/div/button");
	
	By SelectReason=By.xpath("//span[contains(text(),'Please select reason')]");
	public void User_Can_Create_Opening_Balance_Save_Cancle_Checking_ValidationMSG(String IteamGroupPar,String IteamCategoryPar,String IteamCodePar,String IteamNamePar,String BatchNoPar,String ExpirayDatePar,String QuantityPar) throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		WebElement selectR=driver.findElement(SelectReason);
		String SRActual=selectR.getText();
		System.out.println("message : "+SRActual);
		String expected="Please select reason";
		Assert.assertEquals(SRActual,expected,"Validation message Should be Please select reason");
	
		Thread.sleep(2000);
		File screenshot2 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Opening_Balance_Add_item_Enter_item_details_Save_Cancel_Checking_validationMSG.png")); 
		Thread.sleep(2000);
	}
	public Opening_Balance_Add_item_Enter_item_details_Save_Cancel_Checking_validationMSG(WebDriver driver)
	{
		this.driver=driver;
	}
}
