...
public class DisposalRequestApproval_Approved_Partially_PrintReport 
{
	WebDriver driver;
	...
	By ReasonClick=By.cssSelector("mat-select[ng-reflect-message='Select Reason']");
	By ReasonSelOpt=By.xpath("//span[contains(text(),'Not Required')]");
	public void DisposalRequestApproval_ApprovedPartially_PrintReport() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public DisposalRequestApproval_Approved_Partially_PrintReport(WebDriver driver)
	{
		this.driver=driver;
	}
}
