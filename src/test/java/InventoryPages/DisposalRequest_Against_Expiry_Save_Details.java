...
public class DisposalRequest_Against_Expiry_Save_Details 
{
	WebDriver driver;
	...
	By RequestingStoreSelOpt=By.xpath("//span[contains(text(),'KL OP Pharmacy')]");
	//Stock Type
	...
	public void Disposal_Request_Against_Expiry_Save_Details() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		driver.findElement(DisposedQty).sendKeys("2");
	...
	public DisposalRequest_Against_Expiry_Save_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
