...
public class BatchChange_AddItem_Save_PrintReport 
{
	WebDriver driver;
	...
	By PrintReportButton=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-batchchange/div[2]/div/table/tbody/tr[1]/td[9]/a[2]");
	

	public void Batchchange_AddItem_Save_PrintReport() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(3000);
		driver.findElement(PrintReportButton).click();

		File screenshot2 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//BatchChange_AddItem_Save_PrintReport.png")); 

	}
	public BatchChange_AddItem_Save_PrintReport(WebDriver driver)
	{
		this.driver=driver;
	}
}
