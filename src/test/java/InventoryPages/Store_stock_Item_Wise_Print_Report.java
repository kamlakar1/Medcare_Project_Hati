...
public class Store_stock_Item_Wise_Print_Report 
{
	WebDriver driver;
	...
	public void Store_Stock_Item_Wise_print_Report() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Store_stock_Item_Wise_Print_Report(WebDriver driver)
	{
		this.driver=driver;
	}
}
