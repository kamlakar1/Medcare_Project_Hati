...
public class Stk_Adjust_Add_Item_Adjustment_Type_Add_Save_Modify_SaveAndSubmit_Details 
{
	WebDriver driver;
	...
	//Adjustment Type
		...
		By AdjustmentSelOpt=By.xpath(" //span[contains(text(),'Addition')]");
	...
	public void Stock_Adjustment_AddItem_For_Stock_Adjustment_Save_Edit() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Stock_Adjustment_Add_Item_Write_Off_Save_View_Details.png")); 

	}
	public Stk_Adjust_Add_Item_Adjustment_Type_Add_Save_Modify_SaveAndSubmit_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
