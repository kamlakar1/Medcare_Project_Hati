...
public class Stk_Adjust_WriteOff_SaveAndSubmit_Stk_Adjust_Approval_ApproveFull_Print 
{
	WebDriver driver;
	...
	//View deatails
	By PrintReport=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-stockadjustmentapproval/div[2]/div/mat-table/mat-row[1]/mat-cell[10]/a/mat-icon");
	public void Stock_Adjustment_Approval_ApproveALl_PrintReport() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Stk_Adjust_WriteOff_SaveAndSubmit_Stk_Adjust_Approval_ApproveFull_Print.png")); 

	}
	public Stk_Adjust_WriteOff_SaveAndSubmit_Stk_Adjust_Approval_ApproveFull_Print(WebDriver driver)
	{
		this.driver=driver;
	}
}
