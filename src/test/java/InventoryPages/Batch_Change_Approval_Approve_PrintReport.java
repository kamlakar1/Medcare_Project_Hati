...
public class Batch_Change_Approval_Approve_PrintReport 
{
	WebDriver driver;
	...
	By PrintReportClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-batchchangeapproval/div[1]/div/mat-table/mat-row[1]/mat-cell[9]/a/mat-icon");
	...
	public void Batchchange_SaveAndSubmit_ApproveFromDashBoard_PrintReport() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(PrintReportClick).click();
		
		File screenshot2 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Batch_Change_Approval_Approve_PrintReport")); 

	}
	public Batch_Change_Approval_Approve_PrintReport(WebDriver driver)
	{
		this.driver=driver;
	}
}
