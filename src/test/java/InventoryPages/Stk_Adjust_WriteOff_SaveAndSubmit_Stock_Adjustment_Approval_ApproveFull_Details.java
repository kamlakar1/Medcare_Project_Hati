...
public class Stk_Adjust_WriteOff_SaveAndSubmit_Stock_Adjustment_Approval_ApproveFull_Details 
{
	WebDriver driver;
	...
	//View deatails
	By ViewDEatailsClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-stockadjustment/div[3]/div/mat-table/mat-row[1]/mat-cell[11]/a/mat-icon");
	public void Stock_Adjustment_Approval_ApproveALl() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Stk_Adjust_WriteOff_SaveAndSubmit_Stock_Adjustment_Approval_ApproveFull_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
