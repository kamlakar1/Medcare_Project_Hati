...
public class DisposalRequest_Against_Expiry_SaveAndSubmit_Details 
{
	WebDriver driver;
	...
	public void Disposal_Request_Against_Expiry_SaveAndSubmit_Details() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		driver.findElement(DisposedQty).sendKeys("1");
	...
	public DisposalRequest_Against_Expiry_SaveAndSubmit_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
