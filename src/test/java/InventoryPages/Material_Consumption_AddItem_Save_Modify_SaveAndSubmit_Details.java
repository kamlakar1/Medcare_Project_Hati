...
public class Material_Consumption_AddItem_Save_Modify_SaveAndSubmit_Details 
{
	WebDriver driver;
	...
	//Edit Button
	By EditBtnClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialconsumption/div[3]/div/mat-table/mat-row/mat-cell[10]/a[1]/mat-icon");


	//View deatails
	By ViewDEatailsClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-materialconsumption/div[3]/div/mat-table/mat-row/mat-cell[11]/a/mat-icon");
	//Save and submit
	...
	By SaveAndSubmitSucc=By.xpath("//span[contains(text(),'Material Consumption Updated Successfully')]");
	public void MaterialConsumption_AddItem_Edit_SaveAndSubmit() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(EditBtnClick).click();

		Thread.sleep(3000);
		WebElement toClear = driver.findElement(ConsumedQTYClick);
		toClear.sendKeys(Keys.CONTROL + "a");
		toClear.sendKeys(Keys.DELETE);

		Thread.sleep(2000);
		driver.findElement(ConsumedQTYClick).sendKeys("4");
		...
		String expected="Material Consumption Updated Successfully";
	...
	public Material_Consumption_AddItem_Save_Modify_SaveAndSubmit_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
