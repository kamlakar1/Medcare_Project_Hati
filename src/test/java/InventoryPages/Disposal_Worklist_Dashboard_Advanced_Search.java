...
public class Disposal_Worklist_Dashboard_Advanced_Search 
{
	WebDriver driver;
	...
	public void DisposalWorkList_Advanced_Search() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Disposal_Worklist_Dashboard_Advanced_Search(WebDriver driver)
	{
		this.driver=driver;
	}
}
