...
public class Stock_Adjustment_Add_Item_Write_Off_Save_Approve_from_dashboard_View_details 
{
	WebDriver driver;
	...
	public void Stock_Adjustment_AddItem_For_Write_Off_Save_ApproveFromDashboard() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Stock_Adjustment_Add_Item_Write_Off_Save_Approve_from_dashboard_View_details(WebDriver driver)
	{
		this.driver=driver;
	}
}
