...
public class Material_Consumption_Dashboard_Advanced_Search 
{
	WebDriver driver;
	...
	public void MaterialConsumption_Dashboard_AdvancedSearch() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Material_Consumption_Dashboard_Advanced_Search.png")); 

	}
	public Material_Consumption_Dashboard_Advanced_Search(WebDriver driver)
	{
		this.driver=driver;
	}
}
