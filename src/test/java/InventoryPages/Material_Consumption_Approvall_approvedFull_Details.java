...
public class Material_Consumption_Approvall_approvedFull_Details 
{
	WebDriver driver;
	...
	public void MaterialConsumptionApproval_Save_ApproveAll() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Material_Consumption_Approvall_approvedFull_Details(WebDriver driver)
	{
		this.driver=driver;
	}
}
