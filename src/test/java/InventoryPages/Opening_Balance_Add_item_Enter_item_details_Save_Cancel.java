...
public class Opening_Balance_Add_item_Enter_item_details_Save_Cancel 
{
	WebDriver driver;
	...
	public void User_Can_Create_Opening_Balance_Save_CancelBalance(String IteamGroupPar,String IteamCategoryPar,String IteamCodePar,String IteamNamePar,String BatchNoPar,String ExpirayDatePar,String QuantityPar) throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		WebElement CancelSt=driver.findElement(CancelStatus);
		String CancelST2=CancelSt.getText();
		System.out.println("message : "+CancelST2);
		String expected="Cancelled";
		Assert.assertEquals(CancelST2,expected,"Status not showing cancelled");
		System.out.println("Status showing Cancelled");
		
		File screenshot2 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//OpeningBalanceVerified.png")); 
	}
	public Opening_Balance_Add_item_Enter_item_details_Save_Cancel(WebDriver driver)
	{
		this.driver=driver;
	}
}
