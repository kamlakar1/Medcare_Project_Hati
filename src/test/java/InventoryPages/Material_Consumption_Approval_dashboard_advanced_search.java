...
public class Material_Consumption_Approval_dashboard_advanced_search 
{
	WebDriver driver;
	...
	public void MaterialConsumptionApproval_Dashboard_AdvancedSearch() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Material_Consumption_Approval_dashboard_advanced_search .png")); 

	}
	public Material_Consumption_Approval_dashboard_advanced_search(WebDriver driver)
	{
		this.driver=driver;
	}
}
