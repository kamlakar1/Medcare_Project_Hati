...
public class Stk_Adjust_Add_Item_Adjust_Type_Add_SaveAndSubmit_ApproveFull_Store_Register 
{
	WebDriver driver;
	...
	//Stock Type
		...
		By StockSelOpt=By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[2]/span");
	//Add item
	...
	//Adjustment Type
		By AdjustmentTypeClick=By.cssSelector("mat-select[ng-reflect-placeholder='Select Type']");
		By AdjustmentSelOpt=By.xpath(" //span[contains(text(),'Minus')]");
	...
	//View deatails
	By EditClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dashboard-stockadjustment/div[3]/div/mat-table/mat-row[1]/mat-cell[10]/a[1]/mat-icon");
	//Save and submit
		...
		//Approve
			...
			//Yes Click
			By ApproveYesClick=By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-confirmation/div/form/div[3]/div/button[1]/span[1]/mat-icon");
		//View deatails
	public void Stock_Adjustment_AddItem_For_Stock_Adjustment_Minus_ApproveAll() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(AdjustmentTypeClick).click();
		Thread.sleep(2000);
		driver.findElement(AdjustmentSelOpt).click();
		...
		Thread.sleep(2000);
        WebElement toClear = driver.findElement(AdjustmentQTYClick);
        toClear.sendKeys(Keys.CONTROL + "a");
        toClear.sendKeys(Keys.DELETE);
        
		Thread.sleep(2000);
		driver.findElement(AdjustmentQTYClick).sendKeys("4");*/
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Stk_Adjust_Add_Item_Adjust_Type_Add_SaveAndSubmit_ApproveFull_Store_Register.png")); 

	}
	public Stk_Adjust_Add_Item_Adjust_Type_Add_SaveAndSubmit_ApproveFull_Store_Register(WebDriver driver)
	{
		this.driver=driver;
	}
}
