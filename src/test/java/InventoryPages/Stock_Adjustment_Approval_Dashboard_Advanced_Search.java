...
public class Stock_Adjustment_Approval_Dashboard_Advanced_Search 
{
	WebDriver driver;
	...
	public void Stock_Adjustment_Approval_Dashboard_AdvancedSearch() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot2, new File(".//ScreenShot//Stock_Adjustment_Approval_Dashboard_Advanced_Search .png")); 

	}
	public Stock_Adjustment_Approval_Dashboard_Advanced_Search(WebDriver driver)
	{
		this.driver=driver;
	}
}
