...
public class Batch_change_dashboard_Advanced_Search 
{
	WebDriver driver;
	...
	public void Batchchange_Advanced_Search() throws InterruptedException, IOException 
	{
		Thread.sleep(2000);
	...
	public Batch_change_dashboard_Advanced_Search(WebDriver driver)
	{
		this.driver=driver;
	}
}
