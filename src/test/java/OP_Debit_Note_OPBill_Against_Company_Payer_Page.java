...
public class OP_Debit_Note_OPBill_Against_Company_Payer_Page {
...
//---DebitNote---//
		...
		public OP_Debit_Note_OPBill_Against_Company_Payer_Page (WebDriver driver)
  ...
  public void OPBillDebitNoteagainstPayer(String PrimaryIdNumberPar,String ExparyDatePar,String SecondaryIdNumberPar,String SecondaryExparyDatePar,String FullNamePar,String DateOfBirthPar,String MotherNamePar,String PatientNotesPar,String ResidentialAddressPar,String PostCodePar,String MobileNumberPar,String Emailpar,String PersonalFaxpar,String WorkFaxpar,String WorkContactNopar,String HomeContactNopar,String PolicyNoPar, String HolderNamePar, String CustomerNamePar, String GLRefNOPar, String ExpiryDatePar, String GLAmountPar, String CoverageAmountPar, String ContactNamePar, String DesignationPar, String ContactNoPar, String GLRemarksPar, String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException 
  {
	 ...
	 //---GLApproval---//
			      ...
			      FileUtils.copyFile(screenshot1, new File(".\\ScreenShots\\OP_DebitNote_OPBill_Save_Against_Company_Payer_Test_GLApproval Saved.png"));
		...
		//SideMenuBar
		  ...
		  Thread.sleep(5000);
		   ...
		   System.out.println("OP Charge Screen Not Appear"); 
			...
			FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OP_DebitNote_OPBill_Save_Against_Company_Payer_Test_OPChargeScreen.png")); 
		...
		//ServiceSelect
	      ...
	      FileUtils.copyFile(screenshot5, new File(".//ScreenShots//OP_DebitNote_OPBill_Save_Against_Company_Payer_Test_ChargesSave2.png"));
	      Thread.sleep(3000);
		 ...
		 //Confirm2
		  ...
		  //Assertion1
			Thread.sleep(3000);
		      ...
		      FileUtils.copyFile(screenshot6, new File(".//ScreenShots//OP_DebitNote_OPBill_Save_Against_Company_Payer_Test_DebitNoteGenerated.png"));
