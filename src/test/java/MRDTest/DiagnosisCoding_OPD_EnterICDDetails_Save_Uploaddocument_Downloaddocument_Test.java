...
public class DiagnosisCoding_OPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument_Test 
{
	...
	public void TC_01_Verify_Login(String Uesrid) throws InterruptedException, IOException 
	{
	 ...
	 {
		 DiagnosisCoding_OPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument charge=new DiagnosisCoding_OPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument(driver);
		 charge.DiagnosisCoding_OPD_UploadFIle_Download();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		//WebDriverManager.chromedriver().setup();
				recorder = new ATUTestRecorder(".//Videos//","DiagnosisCoding_OPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument_Test-"+dateFormat.format(date),false);
				recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DiagnosisCoding_OPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
