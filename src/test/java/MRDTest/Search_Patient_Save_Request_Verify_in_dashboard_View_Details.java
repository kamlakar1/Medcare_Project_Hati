...
public void TC_01_verify_That_User_Is_Able_To_Login_MedcareApplication(String Uesrid) throws InterruptedException, IOException
{
 ...
 @Test
  ...
  {
	MRDPages.Search_Patient_Save_Request_Verify_in_dashboard_View_Details vv=new MRDPages.Search_Patient_Save_Request_Verify_in_dashboard_View_Details(driver);
	  vv.OPD_REGISTRATION();	  
}
 ...
 @BeforeTest
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","Search_Patient_Save_Request_Verify_in_dashboard_View_Details -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Search_Patient_Save_Request_Verify_in_dashboard_View_Details"+ dateFormat.format(date)));
		}
	}
