...
public class DocumentManagement_Search_OP_Patient_Upload_Document_Save_Test 
{
	...
	public void TC_01_Verify_Login(String Uesrid) throws InterruptedException, IOException 
	{
	 ...
	 {
		 DocumentManagement_Search_OP_Patient_Upload_Document_Save charge=new DocumentManagement_Search_OP_Patient_Upload_Document_Save(driver);
		 charge.DocumentMgmt_OPD_UploadFIle();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		//WebDriverManager.chromedriver().setup();
				recorder = new ATUTestRecorder(".//Videos//","DocumentManagement_Search_OP_Patient_Upload_Document_Save_Test-"+dateFormat.format(date),false);
				recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DocumentManagement_Search_OP_Patient_Upload_Document_Save_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
