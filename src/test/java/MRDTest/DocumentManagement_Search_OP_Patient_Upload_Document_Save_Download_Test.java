...
public class DocumentManagement_Search_OP_Patient_Upload_Document_Save_Download_Test 
{
	...
	public void TC_01_Verify_Login(String Uesrid) throws InterruptedException, IOException 
	{
	 ...
	 @Test(priority=3)
	 public void TC_03_Verify_That_User_DiagnosisCoding_OPD_UploadDoc_DownloadDoc() throws InterruptedException, IOException
	 {
		 DocumentManagement_Search_OP_Patient_Upload_Document_Save_Download charge=new DocumentManagement_Search_OP_Patient_Upload_Document_Save_Download(driver);
		 charge.DocumentMgmt_OPD_UploadFIle_Download();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		//WebDriverManager.chromedriver().setup();
				recorder = new ATUTestRecorder(".//Videos//","DocumentManagement_Search_OP_Patient_Upload_Document_Save_Download_Test-"+dateFormat.format(date),false);
				recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DocumentManagement_Search_OP_Patient_Upload_Document_Save_Download_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
