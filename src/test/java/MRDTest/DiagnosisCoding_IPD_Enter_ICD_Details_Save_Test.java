...
import MRDPages.DiagnosisCoding_IPD_Enter_ICD_Details_Save;
import MRDPages.DiagnosisCoding_OPD_Enter_ICD_Details_Save;
import Pages.Login;

import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
public class DiagnosisCoding_IPD_Enter_ICD_Details_Save_Test 
{
	...
	public void TC_04_Verify_User_Can_Fill_ADT_Admission_Form(String LengthOfStayPar,String AdmittingDiagPar,String AddNotesPar,String PatientNotesPar,String AdmissionRemarksPar,String BillEstimationPar,String ReferralRemarksPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException
	{
	 ...
	 @Test(priority=5)
	 public void TC_05_Verify_That_User_DiagnosisCoding_IPD_Enter_ICD_Details_Save() throws InterruptedException, IOException
	 {
		 DiagnosisCoding_IPD_Enter_ICD_Details_Save charge=new DiagnosisCoding_IPD_Enter_ICD_Details_Save(driver);
		 charge.DiagnosisCoding_IPD_Enter_ICD_Details();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		//WebDriverManager.chromedriver().setup();
				recorder = new ATUTestRecorder(".//Videos//","DiagnosisCoding_IPD_Enter_ICD_Details_Save_Test-"+dateFormat.format(date),false);
				recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DiagnosisCoding_IPD_Enter_ICD_Details_Save_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
