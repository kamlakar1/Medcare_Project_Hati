...
public void TC_01_verify_That_User_Is_Able_To_Login_MedcareApplication(String Uesrid) throws InterruptedException, IOException
{
 ...
 @Test
  ...
  public void TC_02_MRD_File_Requested_Cancel() throws InterruptedException, IOException, AWTException 
  {
	MRDPages.MRD_File_Requested_Cancel vv=new MRDPages.MRD_File_Requested_Cancel(driver);
 ...
 @BeforeTest
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","MRD_File_Requested_Cancel -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//MRD_File_Requested_Cancel"+ dateFormat.format(date)));
		}
	}
