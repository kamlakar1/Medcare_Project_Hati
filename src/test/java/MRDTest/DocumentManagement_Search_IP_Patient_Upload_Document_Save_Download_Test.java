...
import MRDPages.DocumentManagement_Search_IP_Patient_Upload_Document_Save_Download;
import Pages.Login;

import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
public class DocumentManagement_Search_IP_Patient_Upload_Document_Save_Download_Test 
{
	...
	public void TC_04_Verify_User_Can_Fill_ADT_Admission_Form(String LengthOfStayPar,String AdmittingDiagPar,String AddNotesPar,String PatientNotesPar,String AdmissionRemarksPar,String BillEstimationPar,String ReferralRemarksPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException
	{
	 ...
	 @Test(priority=5)
	 public void TC_05_Verify_That_User_DiagnosisCoding_OPD_UploadDoc_Save() throws InterruptedException, IOException
	 {
		 DocumentManagement_Search_IP_Patient_Upload_Document_Save_Download charge=new DocumentManagement_Search_IP_Patient_Upload_Document_Save_Download(driver);
		 charge.DocumentMgmt_OPD_UploadFIle_Save_Download();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		//WebDriverManager.chromedriver().setup();
				recorder = new ATUTestRecorder(".//Videos//","DocumentManagement_Search_IP_Patient_Upload_Document_Save_Download_Test-"+dateFormat.format(date),false);
				recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DocumentManagement_Search_IP_Patient_Upload_Document_Save_Download_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
