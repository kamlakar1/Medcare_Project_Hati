...
import MRDPages.DiagnosisCoding_OPD_Ente_ICDDetails_Save_Uploaddocument_Deletedoc_Upload_Save;
...
public class DiagnosisCoding_OPD_Ente_ICDDetails_Save_Uploaddocument_Deletedoc_Upload_Save_Test 
{
	...
	public void TC_01_Verify_Login(String Uesrid) throws InterruptedException, IOException 
	{
	 ...
	 @Test(priority=3)
	 public void TC_03_Verify_That_User_DiagnosisCoding_OPD_UploadDoc_DeleteDocument() throws InterruptedException, IOException
	 {
		 DiagnosisCoding_OPD_Ente_ICDDetails_Save_Uploaddocument_Deletedoc_Upload_Save charge=new DiagnosisCoding_OPD_Ente_ICDDetails_Save_Uploaddocument_Deletedoc_Upload_Save(driver);
		 charge.DiagnosisCoding_OPD_UploadFIle_DeleteFile();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		//WebDriverManager.chromedriver().setup();
				recorder = new ATUTestRecorder(".//Videos//","DiagnosisCoding_OPD_Ente_ICDDetails_Save_Uploaddocument_Deletedoc_Upload_Save_Test-"+dateFormat.format(date),false);
				recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DiagnosisCoding_OPD_Ente_ICDDetails_Save_Uploaddocument_Deletedoc_Upload_Save_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
