...
public class DiagnosisCoding_IPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument_Test 
{
	...
	public void TC_04_Verify_User_Can_Fill_ADT_Admission_Form(String LengthOfStayPar,String AdmittingDiagPar,String AddNotesPar,String PatientNotesPar,String AdmissionRemarksPar,String BillEstimationPar,String ReferralRemarksPar,String NamePar,String IdentificationNOPar,String PhoneNumberPar,String AddressPar,String ZipCodePar) throws InterruptedException, IOException
	{
	 ...
	 {
		 DiagnosisCoding_IPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument charge=new DiagnosisCoding_IPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument(driver);
		 charge.DiagnosisCoding_IPD_UploadFIle_Download();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		//WebDriverManager.chromedriver().setup();
				recorder = new ATUTestRecorder(".//Videos//","DiagnosisCoding_IPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument_Test-"+dateFormat.format(date),false);
				recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DiagnosisCoding_IPD_EnterICDDetails_Save_Uploaddocument_Downloaddocument_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
