...
public class OP_Existing_IP_Admisison_MRN_File_Requested_Volume_Master_Search_patient_Add_volume 
{
...
public void TC_01_verify_That_User_Is_Able_To_Login_MedcareApplication(String Uesrid) throws InterruptedException, IOException
{
 ...
 @Test
  ...
  public void TC_02_OP_Existing_IP_Admisison_MRN_File_Requested_Volume_Master_Search_patient_Add_volume() throws InterruptedException, IOException, AWTException 
  {
 ...
 @BeforeTest
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","OP_Existing_IP_Admisison_MRN_File_Requested_Volume_Master_Search_patient_Add_volume -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//OP_Existing_IP_Admisison_MRN_File_Requested_Volume_Master_Search_patient_Add_volume"+ dateFormat.format(date)));
		}
	}
