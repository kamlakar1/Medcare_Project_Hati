...
import MRDPages.DiagnosisCoding_OPD_Uploaddocument_Save;
import MRDPages.DiagnosisCoding_OPD_Enter_ICD_Details_Save;
import Pages.Login;

import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
public class DiagnosisCoding_OPD_Uploaddocument_Save_Test 
{
	...
	public void TC_01_Verify_Login(String Uesrid) throws InterruptedException, IOException 
	{
	 ...
	 @Test(priority=3)
	 public void TC_03_Verify_That_User_DiagnosisCoding_OPD_UploadDoc_Save() throws InterruptedException, IOException
	 {
		 DiagnosisCoding_OPD_Uploaddocument_Save charge=new DiagnosisCoding_OPD_Uploaddocument_Save(driver);
		 charge.DiagnosisCoding_OPD_UploadFIle_Save();
	 }
	@BeforeTest
	public void beforeTest() throws InterruptedException, ATUTestRecorderException 
	{
		//WebDriverManager.chromedriver().setup();
				recorder = new ATUTestRecorder(".//Videos//","DiagnosisCoding_OPD_EnterICDDetails_Save_Uploaddocument_Save_Test-"+dateFormat.format(date),false);
				recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_DiagnosisCoding_OPD_EnterICDDetails_Save_Uploaddocument_Save_Test"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
