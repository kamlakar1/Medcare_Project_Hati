...
public class Debit_Note_Add_Charges_Save_Delete_Charges {
	...
	public Debit_Note_Add_Charges_Save_Delete_Charges (WebDriver driver)
	...
	public void Debit_Note_Add_Charges_Save_Delete_Chargesfunc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Debit_Note_Add_Charges_Save_Delete_Charges.png"));
		Thread.sleep(5000);
		driver.findElement(Reason).click();
		Thread.sleep(5000);
		File screenshot09 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		String timestamp09= new SimpleDateFormat("yyyy_MM_dd__hh_mm_ss").format(new Date());
		FileUtils.copyFile(screenshot09, new File(".//ScreenShots//Debit_Note_Add_Charges_Save_Delete_Charges_select_reason.png"));
		Thread.sleep(3000);
		driver.findElement(For_Radiotherapy).click();
		Thread.sleep(1000);
		driver.findElement(Yes).click();
		Thread.sleep(3000);
		String Actual_1 = "Order deleted successfully";
		String Expected_1 = "Order deleted successfully";
		Assert.assertEquals(Actual_1, Expected_1, "Order deleted successfully");
		...
		FileUtils.copyFile(screenshot032, new File(".//ScreenShots//Debit_Note_Add_Charges_Save_Delete_Charges_Order_deleted_successfully.png"));
