...
public class OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN {
	...
	By Click_On_record =By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[2]/div/div[2]/div/table/tbody/tr[1]");

	By Cancel_DN =By.cssSelector("a[ng-reflect-message='Cancel DN']");



	By Cancel =By.cssSelector("a[ng-reflect-message='Cancel Bill']");

	By Reason = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-cancel-reason-dialog/div/form/div[2]/mat-form-field[1]/div/div[1]/div[3]/mat-select");
	By ReasonOPT =By.xpath("//span[contains(text(),'For Radiotherapy')]");

	By Remark = By.cssSelector("textarea[ng-reflect-name='remark']");

	By Yes = By.cssSelector("mat-icon[ng-reflect-message='Yes']");

	By ReceiptList = By.cssSelector("div[aria-posinset='3']");
	
	By record = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[3]/div/div[2]/div/table/tbody/tr[1]");
	
	By cancelReceipt = By.cssSelector("a[ng-reflect-message='Cancel Receipt']");
	
	
	public OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN (WebDriver driver)
	...
	public void OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_View_Detailsfunc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN_ChargesSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot04, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN.png"));
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot05, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN.png"));
		...
		Thread.sleep(4000);
		driver.findElement(PartialAmount).sendKeys("1090.00");
*/
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN.png"));
		Thread.sleep(3000);
		...
		Thread.sleep(1000);
		driver.findElement(ReceiptList).click();
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN_receipt_cancel.png")); 
		Thread.sleep(1000);
		
		driver.findElement(Reason).click();
		Thread.sleep(1000);
		driver.findElement(ReasonOPT).click();
		Thread.sleep(1000);
		driver.findElement(Yes).click();
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		driver.findElement(Click_On_record).click();
		Thread.sleep(1000);
		driver.findElement(Cancel_DN).click();
		//	Thread.sleep(1000);
		...
		driver.findElement(ReasonOPT).click();
		Thread.sleep(1000);
		driver.findElement(Remark).click();
		Thread.sleep(1000);
		driver.findElement(Yes).click();
		File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_Cancel_DN.png")); 
		Thread.sleep(1000);
