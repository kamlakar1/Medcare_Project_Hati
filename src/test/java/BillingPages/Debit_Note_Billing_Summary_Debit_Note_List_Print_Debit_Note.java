...
public class Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note {
	...
	By Debit_not_List_Print =By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[2]/div/div[2]/div/table/tbody/tr[1]/td[19]/mat-icon");

	By 	Do_You_Want_Print =By.cssSelector("mat-icon[ng-reflect-message='Yes']");
	
	public Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note (WebDriver driver)
	...
	public void Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Notefunc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Failed_Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Failed_Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Failed_Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note_Settled_ChargesSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Failed_Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note_save.png"));
		Thread.sleep(3000);
...
*/
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Failed_Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note.png")); 
		...
		Thread.sleep(2000);
		driver.findElement(Debit_not_List_Print).click();
		Thread.sleep(2000);
		driver.findElement(Do_You_Want_Print).click();
		Thread.sleep(2000);
		//driver.findElement(yess).click();
		File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note.png")); 	
		Thread.sleep(2000);
