...
public class Credit_Note_Against_Service_Single_service_Full_settlement {
	...
	public Credit_Note_Against_Service_Single_service_Full_settlement (WebDriver driver)
...

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//New_Registration_Encounter_creation_OP_Bill_Add_Partial_charges_Final_Bill_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//New_Registration_Encounter_creation_OP_Bill_Add_Partial_charges_EncounterListScreen.png")); 
		...
		Thread.sleep(4000);
		driver.findElement(PartialAmount).sendKeys("320.00");
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//New_Registration_Encounter_creation_OP_Bill_Add_Partial_charges_Final_Bill.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//New_Registration_Encounter_creation_OP_Bill_Add_Partial_charges_Final_Bill_Summary.png")); 
		...
		FileUtils.copyFile(screenshot7, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service_search_mrn.png")); 
		...
		FileUtils.copyFile(screenshot_8, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service.png")); 
		Thread.sleep(2000);
	}
