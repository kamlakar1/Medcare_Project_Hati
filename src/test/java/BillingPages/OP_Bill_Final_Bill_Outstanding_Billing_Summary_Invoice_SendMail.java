...
public class OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMail {
    ...
    By viewbill =By.cssSelector("a[ng-reflect-message='View Bill']");
    
    By sendEmail = By.cssSelector("mat-icon[ng-reflect-message='Send Mail']");
    
	public OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMail (WebDriver driver)
	...
	public void OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMailfunc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMail_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMail_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMailSave.png"));
		Thread.sleep(3000);
...
*/
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMail.png"));
		Thread.sleep(3000);
	...
	//	Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMail.png")); 
		Thread.sleep(1000);
