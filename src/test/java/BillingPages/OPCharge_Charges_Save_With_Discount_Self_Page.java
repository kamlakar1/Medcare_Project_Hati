...
public class OPCharge_Charges_Save_With_Discount_Self_Page 
{
	...
	public OPCharge_Charges_Save_With_Discount_Self_Page (WebDriver driver)
  ...
  public void OPChargewithdDiscountforSelf (String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException 
  {
	...
	//Clicking on menu Icon
			...
			Thread.sleep(5000);
			   ...
			   System.out.println("Quick Registration page failed"); 
				...
				FileUtils.copyFile(screenshot, new File(".//ScreenShots//OPCharge_Charges_Save_With_Discount_Self_Test_QuickRegisterationForm.png")); 
			...
			driver.findElement(Saveclick).click();
			 ...
			 Thread.sleep(1000);
		      ...
		      FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OPCharge_Charges_Save_With_Discount_Self_Test_Quick Registration created.png"));
		      Thread.sleep(3000);
			  
			  //Condition
			  
			  String Actual_1 = "Are you sure want to submit?";
		      String Expected_1 = "Are you sure want to submit?";
		      Assert.assertEquals(Actual_1, Expected_1, "Quick Registration created for OP Charge");
			...
			//CreatedMRN
			  ...
			  Thread.sleep(5000);
			   ...
			   System.out.println("Encounter List Screen Not Appear"); 
				...
				FileUtils.copyFile(screenshot2, new File(".//ScreenShots//OPCharge_Charges_Save_With_Discount_Self_Test_EncounterListScreen.png")); 
	...
	//SideMenuBar
	  ...
	  Thread.sleep(5000);
	   ...
	   System.out.println("OP Charge Screen Not Appear"); 
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OPCharge_Charges_Save_With_Discount_Self_Test_OPChargeScreen.png")); 
	...
	//ServiceSelect
      ...
      FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OPCharge_Charges_Save_With_Discount_Self_Test_ChargesSavewithDiscount.png"));
      Thread.sleep(3000);
      ...
      Assert.assertEquals(Actual_2, Expected_3, "Patient Charges Saved and applied");
	 ...
	 /* //FinalBill
	  ...
	  Thread.sleep(5000);
		String windowHandle23 = driver.getWindowHandle();

		//Get the list of window handles

		ArrayList<Object> tabs6 = new ArrayList<Object> (driver.getWindowHandles());
		Thread.sleep(2000);
      ...
      FileUtils.copyFile(screenshot5, new File(".//ScreenShots//OPCharge_Charges_Save_With_Discount_Self_Test_DisocuntApplied.png"));
