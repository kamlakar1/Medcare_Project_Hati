...
public class OP_Charge_Conversion_PayerToSelf_Page {
...
WebDriver driver=null;
	...
	//----ChargeConversion---//
			...
			//ToPayerSelect
			By ToPayerSelect=By.xpath("//mat-option//span[contains(text(),'Self')]");
			...
			public OP_Charge_Conversion_PayerToSelf_Page (WebDriver driver)
  ...
  public void ChargeConversionPayerToSelf(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par) throws InterruptedException, IOException 
			...
			//Clicking on menu Icon
					...
					Thread.sleep(5000);
					   ...
					   System.out.println("Quick Registration page failed"); 
						...
						FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_Charge_Conversion_PayerToSelf_Test_QuickRegisterationForm.png")); 
				...
				//CreatedMRN
				  ...
				  Thread.sleep(5000);
				   ...
				   System.out.println("Encounter List Screen Not Appear"); 
					...
					FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Charge_Conversion_PayerToSelf_Test_EncounterListScreen.png")); 
