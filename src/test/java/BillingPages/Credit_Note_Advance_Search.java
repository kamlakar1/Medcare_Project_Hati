...
public class Credit_Note_Advance_Search {
	...
	public Credit_Note_Advance_Search (WebDriver driver)
	...
	public void Credit_Note_Advance_Searchfunc() throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot032, new File(".//ScreenShots//Credit_Note_Advance_Search_search_BY_MRN.png"));
	...
	//	driver.findElement(AdvanceSearch).click();
		...
		FileUtils.copyFile(screenshot098, new File(".//ScreenShots//Credit_Note_Advance_Search_search_BY_name.png"));
		Thread.sleep(2000);
