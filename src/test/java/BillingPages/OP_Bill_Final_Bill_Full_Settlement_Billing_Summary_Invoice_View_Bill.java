...
public class OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_Bill {
	...
	public OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_Bill (WebDriver driver)
	...
	public void OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_Billfunc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_Bill_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_Bill_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_BillSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_Bill.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_Bill.png")); 
