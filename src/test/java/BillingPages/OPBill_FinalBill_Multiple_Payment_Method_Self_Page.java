...
public class OPBill_FinalBill_Multiple_Payment_Method_Self_Page {
...
//---OPBill---//
		...
		//AmountField
		By AmountField=By.cssSelector("input[ng-reflect-name='amount']");
		...
		//PaymentTypeClick
		By PaymentTypeClick=By.cssSelector("mat-select[data-automation-attribute='select-payment-mode']");
		...
		//DebitAmount 
		By DebitAmount=By.cssSelector("input[ng-reflect-name='amount']");
		
		//DebitNumber
		By DebitNumber=By.cssSelector("input[ng-reflect-name='accountNumber']");
		...
		//ApproveCode
		By ApproveCode=By.cssSelector("input[ng-reflect-name='approvalCode']");
		...
		//ChequeAmount
		By ChequeAmount=By.cssSelector("input[ng-reflect-name='amount']");
		
		//ChequeNumber
		By ChequeNumber=By.cssSelector("input[ng-reflect-name='accountNumber']");
		
		//ChequeBankClick
		By ChequeBankClick=By.cssSelector("mat-select[ng-reflect-name='bank']");
		
		//ChequeBankSelect
		By ChequeBankSelect=By.xpath("//span[contains(text(),'RHB Bank')]");
		
		//ChequeBranch
		By ChequeBranchClick=By.cssSelector("mat-select[ng-reflect-name='branch']");
		
		//ChequeBranchSelect
		By ChequeBranchSelect=By.xpath("//span[contains(text(),'Maybank')]");
		
		//ChequeDate
		By ChequeDate=By.cssSelector("input[ng-reflect-name='acb']");
		...
		public OPBill_FinalBill_Multiple_Payment_Method_Self_Page (WebDriver driver)
  ...
  public void OPBillMultipleFullSettlement (String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException 
		...
		//Clicking on menu Icon
				...
				Thread.sleep(5000);
				   ...
				   System.out.println("Quick Registration page failed"); 
					...
					FileUtils.copyFile(screenshot, new File(".//ScreenShots//OPBill_FinalBill_Self_Test_QuickRegisterationForm.png")); 
				...
				driver.findElement(Saveconfirm).click();
				 ...
				 //Assertion1
			      ...
			      FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OPBill_FinalBill_Multiple_Payment_Method_Self_Test_RegistrationSaved.png"));
				...
				//CreatedMRN
				  ...
				  Thread.sleep(5000);
				   ...
				   System.out.println("Encounter List Screen Not Appear"); 
					...
					FileUtils.copyFile(screenshot2, new File(".//ScreenShots//OPBill_FinalBill_Multiple_Payment_Method_Self_Page.png")); 
...
//---OPBill---//
	...
	//ServiceSelect
      ...
      FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OPBill_FinalBill_Multiple_Payment_Method_Self_Page_OPChargesSave.png"));
      Thread.sleep(3000);
	...
	//DebitAmount
	  Thread.sleep(2000);
	  driver.findElement(DebitAmount).sendKeys("300");
	  
	//DebitNumber
	  Thread.sleep(2000);
	  driver.findElement(DebitNumber).sendKeys("284899389");
	...
	//ApproveCode
	  Thread.sleep(2000);
	  driver.findElement(ApproveCode).sendKeys("38748998");
	...
	//ChequeAmount
	  Thread.sleep(2000);
	  driver.findElement(ChequeAmount).sendKeys("490");
	  
	//ChequeNumber
	  Thread.sleep(2000);
	  driver.findElement(ChequeNumber).sendKeys("2873839898");
	  
	 //ChequeBankClick
	  Thread.sleep(2000);
	  driver.findElement(ChequeBankClick).click();
	  Thread.sleep(2000);
	  driver.findElement(ChequeBankSelect).click();
	  
	  //ChequeBranch
	  Thread.sleep(2000);
	  driver.findElement(ChequeBranchClick).click();
	  Thread.sleep(2000);
	  driver.findElement(ChequeBranchSelect).click();
	  
	  //ChequeDate
	  Thread.sleep(2000);
	  driver.findElement(ChequeDate).sendKeys("01/01/2025");
	  
	  //BatchNo
	  Thread.sleep(2000);
	  driver.findElement(BatchNo).sendKeys("897389309");
      ...
      FileUtils.copyFile(screenshot24, new File(".//ScreenShots//OPBill_FinalBill_Multiple_Payment_Method_Self_Page_Collected.png"));
      Thread.sleep(3000);
