...
public class New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice {
	...
	public New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice (WebDriver driver)
...

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice_ChargesSave.png"));
		Thread.sleep(3000);
...
*/
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice.png"));
		Thread.sleep(3000);
...
*/
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice_Bill_Summary.png")); 
