...
public class Debit_Note_Final_Bill_Partial_Settlement {
	...
	By Billing=By.xpath("/html/body/div[2]/div[2]/div/div/div/div/div[1]/div[1]/div[3]/div/img");
	By Opdbill = By.id("32");
	...
	By Add_service = By.cssSelector("button[ng-reflect-message='Add Service']");
