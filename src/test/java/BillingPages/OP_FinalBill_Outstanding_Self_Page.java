...
public class OP_FinalBill_Outstanding_Self_Page {
...
//----OPBill----//
	...
	public OP_FinalBill_Outstanding_Self_Page (WebDriver driver)
	{
		this.driver=driver;
			
	}
		
	public void OPFinalBillOutstandingSelf(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException
	{
		//---QuickRegistration---//
		...
		//---OPBill---//
						...
						//ReceivedFrom 
					      ...
					      FileUtils.copyFile(screenshot5, new File(".//ScreenShots//OP_FinalBill_Outstanding_Self_Test_OP Final Bill Generated As Outstanding.png"));
					      Thread.sleep(3000);
						  ...
						  String windowHandle2 = driver.getWindowHandle();
							...
							driver.findElement(CheckIn).click();
								...
								FileUtils.copyFile(screenshot6, new File(".//ScreenShots//OP_FinalBill_Outstanding_Self_Test_BillingSummary.png")); 
