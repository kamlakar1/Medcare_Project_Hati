...
public class Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Cancel_CN {
    ...
    By selectrecord = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[4]/div/div[2]/table/tbody/tr[1]");
	
    By Cancel_CN = By.cssSelector("a[ng-reflect-message='Cancel CN']");
    
    By selectReason =By.xpath("/html/body/div[3]/div[2]/div/mat-dialog-container/app-cancel-reason-dialog/div/form/div[2]/mat-form-field[1]/div/div[1]/div[3]/mat-select/div/div[1]/span");
    
    By SelectReasonss=By.xpath("//span[contains(text(),'For Follow Up')]");
    public Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Cancel_CN(WebDriver driver)
	...
	public void Credit_Note_Billing_Summary_Credit_Note_list_Cancel_CN(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Cancel_CN_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Cancel_CN_EncounterListScreen.png")); 
...
*/		//OPChargeSave
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Cancel_CN_ChargesSave.png"));
		Thread.sleep(3000);
...
/*
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Cancel_CN.png"));
		Thread.sleep(3000);
...
*/
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Cancel_CN.png")); 
		Thread.sleep(3000);
		driver.findElement(Credit_Note_op).click();
		Thread.sleep(2000);
		driver.findElement(selectrecord).click();
		Thread.sleep(2000);
		driver.findElement(Cancel_CN).click();
		Thread.sleep(3000);
		driver.findElement(selectReason).click();
		Thread.sleep(3000);
		driver.findElement(SelectReasonss).click();
		Thread.sleep(1000);
		driver.findElement(Yess).click();
		Thread.sleep(1000);
		File screenshot_8 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot_8, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Cancel_CN.png")); 
		Thread.sleep(2000);
