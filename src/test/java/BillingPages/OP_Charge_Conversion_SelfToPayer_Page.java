...
public class OP_Charge_Conversion_SelfToPayer_Page {
...
//----QuickRegistration---//
	...
	//Add Payer Button
		...
		//Payer Type Click
		By PayerTypeClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-sample-patient-registration/div[2]/div[1]/div[2]/table/tbody/tr[1]/td[2]/mat-select/div/div[1]");
		By PayerTypeSelOpt=By.xpath("//span[contains(text(),'Insurance (PAYTYPE002)')]");

		//Payer
		By PayerCLick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-sample-patient-registration/div[2]/div[1]/div[2]/table/tbody/tr[1]/td[3]/mat-select/div/div[1]");
		By PayerSelOpt=By.xpath("//span[contains(text(),'AIA Berhad (PAYER002)')]");

		//Tariff2
		By Tariff22Click=By.cssSelector("mat-select[data-automation-attribute='encounterTariff0']");
	...
	//BillingIcon 
			...
			//Payer
			By Payer=By.cssSelector("mat-select[ng-reflect-placeholder='Select Payer']");
			
			//PayerSelect 
			By PayerSelect=By.xpath("//mat-option/span[contains(text(),'Self')]");
			...
			//BillDisppar
			By BillDisappear=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/ng-sidebar/aside/app-sidebar/app-menu/ul/li[2]/a");
	...
	//----ChargeConversion---//
			...
			//FromPayerSelect
			By FromPayerSelect=By.xpath("//mat-option//span[contains(text(),'Self')]");
			
			//ToPayerClick
			By ToPayerClick=By.cssSelector("mat-select[placeholder='Select To Payer']");
			
			//ToPayerSelect
			By ToPayerSelect=By.xpath("//mat-option//span[contains(text(),'AIA Berhad')]");
			...
			public OP_Charge_Conversion_SelfToPayer_Page (WebDriver driver)
  ...
  public void ChargeConversionSelfToPayer(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par) throws InterruptedException, IOException 
		...
		//Clicking on menu Icon
				...
				Thread.sleep(5000);
				   ...
				   System.out.println("Quick Registration page failed"); 
					...
					FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_Charge_Conversion_SelfToPayer_Test_QuickRegisterationForm.png")); 
			...
			//CreatedMRN
			  ...
			  Thread.sleep(5000);
			   ...
			   System.out.println("Encounter List Screen Not Appear"); 
				...
				FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Charge_Conversion_SelfToPayer_Test_EncounterListScreen.png")); 
