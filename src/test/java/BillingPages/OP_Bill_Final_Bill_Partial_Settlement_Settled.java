...
public class OP_Bill_Final_Bill_Partial_Settlement_Settled {
	...
	public OP_Bill_Final_Bill_Partial_Settlement_Settled (WebDriver driver)
...

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_Bill_Final_Bill_Partial_Settlement_Settled_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Bill_Final_Bill_Partial_Settlement_Settled_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//OP_Bill_Final_Bill_Partial_Settlement_Settled_ChargesSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_history.png"));
		Thread.sleep(3000);
...
*/
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_Bill_Final_Bill_Partial_Settlement_Settled.png")); 
		...
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OP_Bill_Final_Bill_Partial_Settlement_Payment_details.png")); 	
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot5, new File(".//ScreenShots//OP_Bill_Final_Bill_Partial_Settlement_Payment_details_save.png")); 	
		Thread.sleep(1000);
	}
}
