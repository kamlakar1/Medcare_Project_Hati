...
public class Credit_Note_Against_Service_Single_service_Partial_settlement {
	...
	public Credit_Note_Against_Service_Single_service_Partial_settlement (WebDriver driver)
...

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service_Partial_settlement_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service_Partial_settlement_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service_Partial_settlement_Add_Partial_Charges_Save.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service_Partial_settlement_charges_Final_Bill.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service_Partial_settlement_charges_Final_Bill_Summary.png")); 
		...
		FileUtils.copyFile(screenshot7, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service_Partial_settlement_mrn.png")); 
		...
		FileUtils.copyFile(screenshot9, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service.png")); 
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot_8, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service_Partial_settlement.png")); 
		Thread.sleep(2000);
	}

	/*

	public void Credit_Note_Against_Service_Single_service_Full_settlementfunc() throws InterruptedException, IOException {
		/*
		//Clicking on menu Icon
				Thread.sleep(3000);
				Actions act = new Actions(driver);
		...
		File screenshot3 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service_search_mrn.png")); 
		...
		File screenshot7 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot7, new File(".//ScreenShots//Credit_Note_Against_Service_Single_service.png")); 
		Thread.sleep(2000);
