...
public class Top_Up_Deposit_100_Page {
	...
	//ThirdFilter
	By ThirdFilter=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-deposit-topup/div[1]/mat-button-toggle-group/mat-button-toggle[4]");
	
	
	
	public Top_Up_Deposit_100_Page (WebDriver driver)
  ...
  public void TopUpDeposit75To100() throws InterruptedException 
  {
	  ...
	  //Menu
		...
		//FirstFilter
		Thread.sleep(20000);
		driver.findElement(ThirdFilter).click();
