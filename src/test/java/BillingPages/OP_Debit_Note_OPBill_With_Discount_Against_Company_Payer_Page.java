...
public class OP_Debit_Note_OPBill_With_Discount_Against_Company_Payer_Page {
...
//---Encounter---//
	...
	//Encounter Type
			...
			//PayerAdd
			By PayerAddButton=By.cssSelector("mat-icon[ng-reflect-message='Add Payer']");
			
			//PayerTypeClick
			By PayerTypeClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-patient-registration/div[2]/mat-tab-group/div/mat-tab-body[1]/div/div/div[2]/table/tbody/tr[1]/td[2]/mat-select/div/div[1]");
			
			//PayerTypeSel
			By PayerTypeSel=By.xpath("//span[contains(text(),'Insurance (PAYTYPE002)')]");
			
			//PayerClick
			By PayerClick=By.cssSelector("div[id='mat-select-value-593']");
			
			//PayerSelect
			By PayerSelect=By.xpath("//span[contains(text(),'AIA Berhad (PAYER002)')]");
			
			//Tariff
			By Tariff=By.cssSelector("div[id='mat-select-value-595']");
			
			//TariffSel
			By TariffSel=By.xpath("//span[contains(text(),'Hospital Tariff')]");
...
//---GLStatus---//
	...
	//----OPBill---//
		...
		//OPCharge
		By OPChargescreen=By.cssSelector("a[ng-reflect-router-link='bill,opbill']");
...
//---DebitNote---//
		...
		//DebitNoteIcon
		By DebitNoteIcon=By.cssSelector("a[ng-reflect-router-link='bill,debit-note']");
		
		//Advance
		By DebitnoteAdvance=By.cssSelector("mat-icon[ng-reflect-message='Collapse']");
		...
		//SelectAll
				...
				By DiscountCategoryClick=By.cssSelector("mat-select[id='mat-select-110']");
		...
		//SaveButton
		By DebitSaveButton=By.cssSelector("mat-icon[ng-reflect-message='Save']");
		...
		public OP_Debit_Note_OPBill_With_Discount_Against_Company_Payer_Page (WebDriver driver)
  ...
  public void OPBillDebitNotewithdiscountagainstPayer(String PrimaryIdNumberPar,String ExparyDatePar,String SecondaryIdNumberPar,String SecondaryExparyDatePar,String FullNamePar,String DateOfBirthPar,String MotherNamePar,String PatientNotesPar,String ResidentialAddressPar,String PostCodePar,String MobileNumberPar,String Emailpar,String PersonalFaxpar,String WorkFaxpar,String WorkContactNopar,String HomeContactNopar,String PolicyNoPar, String HolderNamePar, String CustomerNamePar, String GLRefNOPar, String ExpiryDatePar, String GLAmountPar, String CoverageAmountPar, String ContactNamePar, String DesignationPar, String ContactNoPar, String GLRemarksPar, String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException 
  {
	...
	//----Encounter---//
		...
		//selecting Tariff	 
				...
				//PayerAdd
				Thread.sleep(2000);
				driver.findElement(PayerAddButton).click();
	 ...
	 //---GLApproval---//
				  ...
				  driver.findElement(GLSave).click();
				     ...
				     FileUtils.copyFile(screenshot3,new File(".//ScreenShots//OP_DebitNote_OPBill_With_Discount_Against_Company_Payer_Test_GLApproval.png"));
				     Thread.sleep(3000);
			      ...
			      FileUtils.copyFile(screenshot1, new File(".\\ScreenShots\\OP_DebitNote_OPBill_With_Discount_Against_Company_Payer_Test.GLApproval Saved.png"));
		  ...
		  WebElement mainMenu2=driver.findElement(mainmenu);
		  act1.moveToElement(mainMenu2).build().perform();
		  act1.click(mainMenu2).perform();
		...
		//SideMenuBar
		  ...
		  Thread.sleep(5000);
		   ...
		   System.out.println("OP Charge Screen Not Appear"); 
			...
			FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OP_DebitNote_OPCharges_Save_Against_Company_Payer_Test_OPChargeScreen.png")); 
		...
		//ServiceSelect
	      ...
	      FileUtils.copyFile(screenshot5, new File(".//ScreenShots//OP_DebitNote_OPCharges_Save_Against_Company_Payer_Test_ChargesSave2.png"));
	      Thread.sleep(3000);
	...
	//--DebitNote--//
		...
		//DebitNoteIcon
			Thread.sleep(3000);
			driver.findElement(DebitNoteIcon).click();
			
		//Advance
			Thread.sleep(2000);
			driver.findElement(DebitnoteAdvance).click();
		 ...
		 //Confirm2
		  ...
		  //Assertion1
			Thread.sleep(3000);
		      ...
		      Assert.assertEquals(URL2, "https://medcare-productqa.hatiintl.com/#/Dashboard/pdfViewer" );
		      ...
		      FileUtils.copyFile(screenshot6, new File(".//ScreenShots//OP_DebitNote_OPCharges_Save_Against_Company_Payer_Test_QuickRegistrationSaved.png"));
