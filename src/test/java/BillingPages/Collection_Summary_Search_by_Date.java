...
public class Collection_Summary_Search_by_Date {
	...
	public Collection_Summary_Search_by_Date (WebDriver driver)
	...
	public void Collection_Summary_Search_by_Datefunc() throws InterruptedException, IOException, AWTException 

	{
		...
		//ExpiryDate
				WebElement toClear_2 = driver.findElement(from_date);
				toClear_2.sendKeys(Keys.CONTROL + "a");
				toClear_2.sendKeys(Keys.DELETE);
		
	//	driver.findElement(from_date).clear();
		Thread.sleep(2000);
	//	driver.findElement(from_date).sendKeys();
		...
		WebElement dateInput1 = driver.findElement(from_date); // Replace with the actual ID or locator of the input field
		dateInput1.sendKeys(currentDate1);
		Thread.sleep(2000);
		driver.findElement(To_date).click();
		Thread.sleep(2000);
		//ExpiryDate
		WebElement toClear_3 = driver.findElement(To_date);
		toClear_3.sendKeys(Keys.CONTROL + "a");
		toClear_3.sendKeys(Keys.DELETE);
		Thread.sleep(2000);
		//driver.findElement(To_date).sendKeys();
		SimpleDateFormat dateFormat2 = new SimpleDateFormat("dd-MM-yy");
		String currentDate11 = dateFormat.format(new Date());
		// Find the input field where you want to enter the current date and send keys
		WebElement dateInput11 = driver.findElement(To_date); // Replace with the actual ID or locator of the input field
		dateInput1.sendKeys(currentDate11);
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot28, new File(".//ScreenShots//Collection_Summary_Search_by_Date_Final_Bill.png"));
		Thread.sleep(3000);
