...
public class OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Cancel_Bill {
    ...
    public OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Cancel_Bill (WebDriver driver)
...

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Cancel_Bill_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Cancel_Bill_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Cancel_Bill_Save.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Cancel_Bill.png"));
		Thread.sleep(3000);
		...
		Thread.sleep(1000);
		driver.findElement(Remark).sendKeys("Cancelling the reord");
		Thread.sleep(1000);
		driver.findElement(Yes).click();
		Thread.sleep(1000);
		File screenshot3 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Cancel_Bill.png")); 
		Thread.sleep(1000);
