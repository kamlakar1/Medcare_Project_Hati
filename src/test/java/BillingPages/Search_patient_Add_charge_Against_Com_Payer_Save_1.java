...
public class Search_patient_Add_charge_Against_Com_Payer_Save_1 
{

	WebDriver driver=null; 
	public Search_patient_Add_charge_Against_Com_Payer_Save_1(WebDriver driver) 
	{
		this.driver=driver;
