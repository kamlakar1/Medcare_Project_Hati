...
public class OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Settle {
    ...
    By sendEmial = By.cssSelector("mat-icon[ng-reflect-message='Send Mail']");
    
	public OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Settle (WebDriver driver)
...

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Settle_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Settle_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SettleSave.png"));
		Thread.sleep(3000);
   ...
   */
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Settle.png"));
		Thread.sleep(3000);
		...
		Thread.sleep(1000);
		driver.findElement(sendEmial).click();
		Thread.sleep(1000);
		File screenshot3 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_Settle.png")); 
		Thread.sleep(1000);
