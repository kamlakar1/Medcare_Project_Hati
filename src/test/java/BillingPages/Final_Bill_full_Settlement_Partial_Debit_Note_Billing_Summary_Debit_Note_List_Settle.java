...
public class Final_Bill_full_Settlement_Partial_Debit_Note_Billing_Summary_Debit_Note_List_Settle {
	...
	public Final_Bill_full_Settlement_Partial_Debit_Note_Billing_Summary_Debit_Note_List_Settle (WebDriver driver)
	...
	public void Debit_Note_Billing_Summary_Debit_Note_List_Settlefunc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Debit_Note_Billing_Summary_Debit_Note_List_Settle_Settled_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Debit_Note_Billing_Summary_Debit_Note_List_SettleSettled_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Debit_Note_Billing_Summary_Debit_Note_List_SettleSettled_ChargesSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Debit_Note_Billing_Summary_Debit_Note_List_Settle.png"));
		Thread.sleep(3000);
...
*/
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Debit_Note_Billing_Summary_Debit_Note_List_Settle_Settled.png")); 
		...
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Debit_Note_Billing_Summary_Debit_Note_List_Settle.png")); 	
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot5, new File(".//ScreenShots//Failed_Final_Bill_full_Settlement_Partial_Debit_Note_Billing_Summary_Debit_Note_List_Settle.png")); 	
		Thread.sleep(1000);
	}
}
