...
public class OP_Write_Off_Request_FinalBill_Outstanding_Insurance_Submit_Cancel_Page {
...
//----OPBill----//
	...
	//--Cancel--//
				...
				//CancelIcon
				By CancelIcon=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-write-off-dashboard/div[2]/table/tbody/tr[1]/td[11]/a[3]/mat-icon");		
				
				//CancelReasonClick
				By CancelReasonClick=By.cssSelector("mat-select[ng-reflect-name='first']");
				
				//CanceReasonSel
				By cancelReasonSel=By.xpath("//span[contains(text(),'For Follow Up')]");
				
				//CancelRemarks
				By cancelRemarks=By.cssSelector("textarea[ng-reflect-name='remark']");
				
				//CancelConfirm
				By CancelConfirm=By.cssSelector("mat-icon[ng-reflect-message='Yes']");
	...
	public OP_Write_Off_Request_FinalBill_Outstanding_Insurance_Submit_Cancel_Page (WebDriver driver)
	{
		this.driver=driver;
			
	}
		
	public void OPWriteOffRequestSubmitInsuranceCancel(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar,String CancelRemarksPar) throws InterruptedException, IOException
	{
		//---QuickRegistration---//
		...
		//---OPBill---//
						...
						//ReceivedFrom 
						  ...
						  String windowHandle2 = driver.getWindowHandle();
							...
							//CanceReasonSel
							Thread.sleep(2000);
							driver.findElement(cancelReasonSel).click();
							...
							//CancelConfirm
							Thread.sleep(4000);
							driver.findElement(CancelConfirm).click();
