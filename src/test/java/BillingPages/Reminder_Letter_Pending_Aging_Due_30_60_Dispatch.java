...
public class Reminder_Letter_Pending_Aging_Due_30_60_Dispatch {

	WebDriver driver;
	public Reminder_Letter_Pending_Aging_Due_30_60_Dispatch(WebDriver driver) {
	...
	By agedue = By.cssSelector("mat-select[ng-reflect-placeholder='Select Aging Due']");
	By Aging_due_30_60 = By.xpath("//span[contains(text(),'30-60')]");
	...
	//span[contains(text(),'30-60')]
	
	


	public void Reminder_Letter_Pending_Aging_Due_30_60_Dispatch_func() throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(2000);
		String Actual_1 = "No patients found matching this search";
		String Expected_1 = "No patients found matching this search";
		Assert.assertEquals(Actual_1, Expected_1, "Patient not found");
		Assert.fail(Expected_1);
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(agedue).click();
		Thread.sleep(2000);
		driver.findElement(Aging_due_30_60).click();
		...
		Thread.sleep(2000);
		String Actual_5 = "30-60";
		String Expected_5 = "30-60";
