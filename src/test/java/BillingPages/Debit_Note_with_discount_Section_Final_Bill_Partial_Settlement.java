...
public class Debit_Note_with_discount_Section_Final_Bill_Partial_Settlement {
	...
	public Debit_Note_with_discount_Section_Final_Bill_Partial_Settlement (WebDriver driver)
	...
	public void Debit_Note_Final_Bill_Partial_Settlementfuncc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Debit_Note_with_discount_Section_Final_Bill_Partial_Settlement_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Debit_Note_with_discount_Section_Final_Bill_Partial_Settlement_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Debit_Note_with_discount_Section_Final_Bill_Partial_Settlement_Add_Partial_ChargesSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Debit_Note_with_discount_Section_Final_Bill_Partial_Settlement_charges_Final_Bill.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Debit_Note_with_discount_Section_Final_Bill_Partial_SettlementFinal_Bill_Summary.png")); 
