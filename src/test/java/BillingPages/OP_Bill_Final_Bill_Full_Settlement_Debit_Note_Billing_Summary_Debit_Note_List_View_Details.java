...
public class OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_View_Details {
	...
	By View_Details =By.cssSelector("a[ng-reflect-message='View Details']");


	public OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_View_Details (WebDriver driver)
...

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_View_Details_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_View_Details_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_View_Details_ChargesSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot04, new File(".//ScreenShots//Debit_Note_with_Grid_discount_Final_Bill_Full_Settlement_Debit_card.png"));
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_View_Details.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Debit_Note_Billing_Summary_Debit_Note_List_View_Details.png")); 
		Thread.sleep(1000);
