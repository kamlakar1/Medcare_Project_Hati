...
public class Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt {
	...
	By Click_On_record =By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[1]/div/div[2]/div/table/tbody/tr");

	By Settle = By.cssSelector("a[ng-reflect-message='Settle']");

	By checkboxx = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[1]/div/div[2]/div/table/tbody/tr/td[1]/mat-checkbox");

	By yess=By.cssSelector("mat-icon[ng-reflect-message='Yes']");

	By Add_Payment_Details = By.cssSelector("mat-icon[ng-reflect-message='Add Payment Details']");

	By save_details =By.cssSelector("mat-icon[ng-reflect-message='Save Payment Details']");

	By yesss = By.cssSelector("mat-icon[ng-reflect-message='Yes']");

	By Select_Record_to_cancel = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[3]/div/div[2]/div/table/tbody/tr[1]");
	
	By Click_on_can_menu =By.cssSelector("a[ng-reflect-message='Cancel Receipt']");
	
	By ReasonDrop = By.xpath("/html/body/div[3]/div[2]/div/mat-dialog-container/app-cancel-reason-dialog/div/form/div[2]/mat-form-field[1]/div/div[1]/div[3]");
	
	By canreason =By.xpath("//span[contains(text(),' For Radiotherapy ')]");
	By Yesy = By.xpath("/html/body/div[3]/div[2]/div/mat-dialog-container/app-cancel-reason-dialog/div/form/div[3]/div/button[2]");
	
	By Receipt_List=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/mat-tab-header/div/div/div/div[3]");
	public Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt (WebDriver driver)
	...
	public void Receipt_List_Cancel_receiptfuc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt_ChargesSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt.png"));
		Thread.sleep(3000);
		...
		Thread.sleep(5000);
		String windowHandle22 = driver.getWindowHandle();

		//Get the list of window handles

		ArrayList<Object> tabs22 = new ArrayList<Object> (driver.getWindowHandles());
		Thread.sleep(2000);
		driver.switchTo().window((String) tabs22.get(0));
...
*/
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt.png")); 

		Thread.sleep(2000);
		driver.findElement(Receipt_List).click();
		Thread.sleep(2000);
		File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt.png")); 	
		Thread.sleep(2000);
		driver.findElement(Select_Record_to_cancel).click();
		Thread.sleep(2000);
		driver.findElement(Click_on_can_menu).click();
		Thread.sleep(2000);
		driver.findElement(ReasonDrop).click();
		Thread.sleep(2000);
		File screenshot5 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot5, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt_select_can_reason.png")); 	
		Thread.sleep(1000);
		driver.findElement(canreason).click();
		Thread.sleep(2000);
		driver.findElement(Yesy).click();
		Thread.sleep(2000);
		File screenshot6 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot6, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Cancel_receipt_save.png")); 	
		Thread.sleep(1000);
	}
}
