...
public class Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle {
	...
	//OPBill
	By OPBill=By.cssSelector("a[ng-reflect-router-link='bill,debit-note']");
	...
	By DebitNotesList = By.cssSelector("div[aria-posinset='4']");
	...
	By checkboxx = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[2]/div/div[2]/div/table/tbody/tr[1]/td[1]/mat-checkbox");
	...
	public Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle (WebDriver driver)
	...
	public void Credit_Note_Billing_Summary_Credit_Note_list_Settle(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle_ChargesSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle.png"));
		Thread.sleep(3000);
...
*/
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle.png")); 
		...
		Thread.sleep(2000);
		driver.findElement(Settle).click();
		Thread.sleep(2000);
		driver.findElement(yess).click();
		File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle.png")); 	
		Thread.sleep(2000);
		driver.findElement(Add_Payment_Details).click();
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot5, new File(".//ScreenShots//Failed_Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle.png")); 	
		Thread.sleep(1000);
	}
}
