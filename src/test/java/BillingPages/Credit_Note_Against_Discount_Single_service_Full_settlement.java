...
public class Credit_Note_Against_Discount_Single_service_Full_settlement {
	...
	public Credit_Note_Against_Discount_Single_service_Full_settlement(WebDriver driver)
	...
	public void Credit_Note_Against_Discount_Single_service_Full_settlementfunc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Credit_Note_Against_Discount_Single_service_Full_settlement_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Credit_Note_Against_Discount_Single_service_Full_settlement_EncounterListScreen.png")); 
...
*/		//OPChargeSave
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Credit_Note_Against_Discount_Single_service_Full_settlement_ChargesSave.png"));
		Thread.sleep(3000);
		...
		Thread.sleep(4000);
		driver.findElement(PartialAmount).sendKeys("318.00");
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Credit_Note_Against_Discount_Single_service_Full_settlement_Final_Bill.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Credit_Note_Against_Discount_Single_service_Full_settlement_charges_Final_Bill_Summary.png")); 
		...
		FileUtils.copyFile(screenshot7, new File(".//ScreenShots//Credit_Note_Against_Discount_Single_service_Full_settlement_search_mrn.png")); 
		...
		FileUtils.copyFile(screenshot9, new File(".//ScreenShots//Credit_Note_Against_Discount_Single_service_Full_settlement.png")); 
		Thread.sleep(1000);
	...
	//	driver.findElement(CheckBox_2).click();
		...
		FileUtils.copyFile(screenshot_8, new File(".//ScreenShots//Credit_Note_Against_Discount_Single_service_Full_settlement.png")); 
		Thread.sleep(2000);
	}
