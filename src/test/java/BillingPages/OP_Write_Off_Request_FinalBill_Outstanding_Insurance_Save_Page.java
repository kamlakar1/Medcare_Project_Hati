...
public class OP_Write_Off_Request_FinalBill_Outstanding_Insurance_Save_Page {
	...
	//----QuickRegistration---//
		...
		//Payer Type Click
		By InsPayerTypeClick=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-sample-patient-registration/div[2]/div[1]/div[2]/table/tbody/tr[1]/td[2]");
		By PayerTypeSelOpt=By.xpath("//span[contains(text(),'Insurance (PAYTYPE002)')]");

		//Payer
		By InsPayerCLick=By.xpath("//*[@id='mat-select-value-73']"); 
		By PayerSelOpt=By.xpath("//span[contains(text(), 'Allianz Life Insurance Malaysia Berhad (PAYER003)')]");

		//Tariff2
		By Tariff22Click=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-sample-patient-registration/div[2]/div[1]/div[2]/table/tbody/tr[1]/td[4]");
...
//----OPBill----//
	...
	//--WriteOffRequest--//
				...
				//PayerSele
				By PayerSele=By.xpath("//span[contains(text(),'AIA Berhad')]");
				...
				//RequestSave 
				By RequestSave=By.cssSelector("mat-icon[ng-reflect-message='Save']");
				
				//SaveConfirm
				By WriteOffSaveConfirm=By.cssSelector("mat-icon[ng-reflect-message='Yes']");
	...
	public OP_Write_Off_Request_FinalBill_Outstanding_Insurance_Save_Page (WebDriver driver)
	{
		this.driver=driver;
			
	}
		
	public void OPWriteOffRequestSaveInsurance(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickFullNamePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException
	{
		//---QuickRegistration---//
			...
			//Clicking on menu Icon
					...
					Thread.sleep(5000);
					   ...
					   System.out.println("Quick Registration page failed"); 
						...
						FileUtils.copyFile(screenshot, new File(".//ScreenShots//OP_FinalBill_Outstanding_Self_Test_QuickRegisterationForm.png")); 
					...
					//Payer Type Click
					Thread.sleep(3000);
					driver.findElement(InsPayerTypeClick).click();
					Thread.sleep(3000);
					...
					Thread.sleep(3000);
				      ...
				      FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_FinalBill_Outstanding_Self_Test_QuickRegistrationSaved.png"));
					...
					//CreatedMRN
					  ...
					  Thread.sleep(5000);
					   ...
					   System.out.println("Encounter List Screen Not Appear"); 
						...
						FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_FinalBill_Outstanding_Self_Test_EncounterListScreen.png")); 
		...
		//---OPBill---//
						...
						//ServiceSelect
					      ...
					      FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OP_FinalBill_Outstanding_Self_Test_ChargesSave2.png"));
					      Thread.sleep(3000);
						...
						//ReceivedFrom 
					      ...
					      FileUtils.copyFile(screenshot5, new File(".//ScreenShots//OP_Write_Off_FinalBill_Outstanding_Self_Test_OP Final Bill Generated As Outstanding.png"));
					      Thread.sleep(3000);
						  ...
						  String windowHandle2 = driver.getWindowHandle();
							...
							//Assertion
							 Thread.sleep(1000);
						      ...
						      String timestamp6= new SimpleDateFormat("yyyy_MM_dd__hh_mm_ss").format(new Date());
						      FileUtils.copyFile(screenshot6, new File(".//ScreenShots//OP_Write_Off_FinalBill_Outstanding_Self_Test.Write Off Request Saved.png"));
						      Thread.sleep(3000);
							  
							  //Condition
							  String Actual_3 = "Do you want to proceed?";
						      String Expected_3 = "Do you want to proceed?";
						      Assert.assertEquals(Actual_3, Expected_3, "Write Off Request Saved");

							
							//WriteOffSaveConfirm
							Thread.sleep(2000);
							driver.findElement(WriteOffSaveConfirm).click();
