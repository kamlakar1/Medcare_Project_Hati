...
public class Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Print_receipt {
	...
	By Yesy = By.cssSelector("mat-icon[ng-reflect-message='Yes']");
	...
	By  Officailreport = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[3]/div/div[2]/div/table/tbody/tr[1]/td[13]/mat-icon");
	public Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Print_receipt (WebDriver driver)
	...
	public void Receipt_List_Print_receiptfunc(String QuickPrimaryIdNumberPar,String QuickExparyDatePar,String QuickDateOfBirthPar,String QuickMobileNumberPar,String QuickEncounterRemarksPar,String QuickAddNotesPar,String QuickEncounterNotesPar,String QuickPatientNotesPar,String QuickReferralRemarksPar,String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException, AWTException 

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Print_receipt_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Print_receipt_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Print_receipt.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Print_receipt.png"));
		Thread.sleep(3000);
...
*/
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Print_receipt.png")); 

		Thread.sleep(2000);
		driver.findElement(Receipt_List).click();
		Thread.sleep(2000);
		File screenshot4 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Print_receipt.png")); 	
		Thread.sleep(2000);
		driver.findElement(Select_Record_to_cancel).click();
		Thread.sleep(2000);
		driver.findElement(Officailreport).click();
		Thread.sleep(2000);
		driver.findElement(Yesy).click();
		Thread.sleep(2000);
		File screenshot6 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(screenshot6, new File(".//ScreenShots//Final_Bill_Full_Settlement_Billing_Summary_Receipt_List_Print_receipt.png")); 	
		Thread.sleep(1000);
	}
}
