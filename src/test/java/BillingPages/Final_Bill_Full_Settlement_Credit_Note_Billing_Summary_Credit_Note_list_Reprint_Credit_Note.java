...
public class Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note {
	...
	By Collapse_1=By.cssSelector("mat-icon[ng-reflect-message='Collapse']");
    ...
    By selectCheckbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-creditnote/app-patient-search/div/div/div/table/tbody/tr[2]/td[1]/div/mat-radio-button/label/span[1]");
    By Credit_note = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/div/mat-tab-body[4]/div/div[2]/table/tbody/tr/td[14]/mat-icon");
    By Credit_Note_op = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-billing-summary/div[2]/mat-tab-group/mat-tab-header/div/div/div/div[4]");
    By yesss = By.cssSelector("mat-icon[ng-reflect-message='Yes']");
    public Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note (WebDriver driver)
...

	{
		...
		FileUtils.copyFile(screenshot, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note_QuickRegisterationForm.png")); 
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note_Save.png"));
		Thread.sleep(3000);
		...
		Thread.sleep(4000);
		driver.findElement(PartialAmount).sendKeys("300.00");
		...
		FileUtils.copyFile(screenshot24, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Notecharges_Final_Bill.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note.png")); 
		...
		FileUtils.copyFile(screenshot7, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note_mrn.png")); 
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot9, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note.png")); 
		Thread.sleep(1000);
		...
		FileUtils.copyFile(screenshot_8, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note.png")); 
		Thread.sleep(2000);
		
		
		Thread.sleep(2000);
		WebElement HoverSideBarr=driver.findElement(SideBarMenu);
		act.moveToElement(HoverSideBarr).build().perform();
		...
		//BillingSummary 
				...
				//BillSearchClick
				Thread.sleep(3000);
				driver.findElement(Collapse_1).click();
				...
				driver.findElement(BillMRNSearch).click();
				Thread.sleep(3000);
				driver.findElement(Credit_Note_op).click();
				Thread.sleep(3000);
				driver.findElement(Credit_note).click();
				Thread.sleep(3000);

				File screenshot_9 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(screenshot_9, new File(".//ScreenShots//Final_Bill_Full_Settlement_Credit_Note_Billing_Summary_Credit_Note_list_Reprint_Credit_Note.png")); 
				Thread.sleep(2000);
