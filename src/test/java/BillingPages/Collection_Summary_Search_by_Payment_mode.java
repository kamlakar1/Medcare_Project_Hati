...
public class Collection_Summary_Search_by_Payment_mode {
	...
	By SSearch = By.xpath("//a//mat-icon[contains(text(),'search')]");
   	...
   	public Collection_Summary_Search_by_Payment_mode (WebDriver driver)
	...
	public void Collection_Summary_Search_by_Paymet_modefunc() throws InterruptedException, IOException, AWTException 

	{
		...
		Thread.sleep(2000);
		driver.findElement(Debit_cart).click();
		Thread.sleep(2000);
		...
		FileUtils.copyFile(screenshot28, new File(".//ScreenShots//Collection_Summary_Search_by_Payment_Mode.png"));
		Thread.sleep(3000);
