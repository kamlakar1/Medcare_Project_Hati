...
public class OP_Debit_Note_Against_Company_Payer_Page {
...
//Tab 1 Address and contact Details
	...
	By RegRelationSelOpt=By.xpath("//span[contains(text(),'Wife')]");
	//Email
...
//---GLStatus---//
	...
	//---DebitNote---//
		...
		//Advance
		By DebitnoteAdvance=By.cssSelector("mat-icon[ng-reflect-message='Expand']");
		...
		public OP_Debit_Note_Against_Company_Payer_Page (WebDriver driver)
  ...
  public void DebitNoteagainstPayer(String PrimaryIdNumberPar,String ExparyDatePar,String SecondaryIdNumberPar,String SecondaryExparyDatePar,String FullNamePar,String DateOfBirthPar,String MotherNamePar,String PatientNotesPar,String ResidentialAddressPar,String PostCodePar,String MobileNumberPar,String Emailpar,String PersonalFaxpar,String WorkFaxpar,String WorkContactNopar,String HomeContactNopar,String PolicyNoPar, String HolderNamePar, String CustomerNamePar, String GLRefNOPar, String ExpiryDatePar, String GLAmountPar, String CoverageAmountPar, String ContactNamePar, String DesignationPar, String ContactNoPar, String GLRemarksPar, String ServiceNamePar,String ServiceName2Par,String ReceivedFromPar,String IdentificationNoPar,String RemarksPar) throws InterruptedException, IOException 
  {
	//---Registration---//
			...
			//Clicking on menu Icon
					...
					Thread.sleep(1000);
					driver.findElement(RegRelationSelOpt).click();
		 ...
		 //---GLApproval---//
					  ...
					  driver.findElement(GLSave).click();
					     ...
					     FileUtils.copyFile(screenshot3,new File(".//ScreenShots//OP_DebitNote_Save_Against_Company_Payer_Test.GLApproval.png"));
					     Thread.sleep(3000);
				      ...
				      FileUtils.copyFile(screenshot1, new File(".\\ScreenShots\\OP_DebitNote_Save_Against_Company_Payer_Test.GLApproval Saved.png"));
...
//---DebitNote---//
		...
		//SideMenuBar
		 ...
		 //DebitNoteIcon
		  ...
		  Thread.sleep(5000);
		   ...
		   {
		   System.out.println("Debit Note Screen Appear"); 
		   } else 
		   {
		   System.out.println("Debit Note Screen Not Appear"); 
		   }
			...
			FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OP_DebitNote_Save_Against_Company_Payer_Test_OPChargeScreen.png")); 
		...
		//ServiceSelect
	      ...
	      FileUtils.copyFile(screenshot5, new File(".//ScreenShots//OP_DebitNote_Save_Against_Company_Payer_Test_ChargesSave2.png"));
	      Thread.sleep(3000);
		  
		  //Condition
		  
		  String Actual_3 = "Order updated Successfully";
	      String Expected_3 = "Order updated Successfully";
	      Assert.assertEquals(Actual_3, Expected_3, "Patient Charges Saved and applied");
