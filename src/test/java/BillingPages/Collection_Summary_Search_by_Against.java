...
public class Collection_Summary_Search_by_Against {
	...
	By Select_Payment_Mode =By.xpath("//span[contains(text(),'Select Payment Mode')]");
	
	By Debit_cart = By.xpath("//mat-option//span[contains(text(),'Debit Card')]");
   	
	By SSearch = By.xpath("//a//mat-icon[contains(text(),'search')]");
	
	By Against = By.xpath("//span[contains(text(),'Against')]");
	
	By Bill =By.xpath("	//mat-option//span[contains(text(),'Bill')]");

   	
   	public Collection_Summary_Search_by_Against (WebDriver driver)
	...
	public void Collection_Summary_Search_by_Againstfunc() throws InterruptedException, IOException, AWTException 

	{
		...
		//ExpiryDate
		WebElement toClear_2 = driver.findElement(To_date);
		...
		FileUtils.copyFile(screenshot28, new File(".//ScreenShots//Collection_Summary_Search_by_Against.png"));
		Thread.sleep(3000);
