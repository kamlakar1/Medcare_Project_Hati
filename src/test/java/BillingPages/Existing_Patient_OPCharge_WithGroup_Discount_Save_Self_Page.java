...
public class Existing_Patient_OPCharge_WithGroup_Discount_Save_Self_Page {
...
//----OPCharge---//
	...
	public Existing_Patient_OPCharge_WithGroup_Discount_Save_Self_Page (WebDriver driver)
  ...
  public void ExistingPatientOPChargeWithGroupDiscount (String PrimaryIdNumber12,String ExparyDatePar,String SecondaryIdNumber12,String SecondaryExparyDatePar,String FullNamePar,String DateOfBirthPar,String MotherNamePar,String BirthPlacePar,String PatientNotes,String ResidentialAddressPar,String PostCodePar,String MobileNumberPar,String Emailpar,String PersonalFaxpar,String WorkFaxpar,String WorkContactNopar,String HomeContactNopar,String EmploymentNoPar,String WorkFromPar,String ContactNumberPar,String ResAddPar,String PostCodePar12,String EncounterRemarksPar,String ServiceNamePar,String ServiceName2Par) throws InterruptedException, IOException 
  {
		...
		//Condition1
				Thread.sleep(4000);
				   ...
				   Thread.sleep(1000);
					...
					FileUtils.copyFile(screenshot, new File(".//ScreenShots//Existing_Patient_OPCharge_WithGroup_Discount_Save_Self_Test_RegistrationPage.png")); 
		...
		driver.findElement(SaveConfirm).click();		
			...
			Thread.sleep(3000);
		      ...
		      FileUtils.copyFile(screenshot1, new File(".//ScreenShots//Existing_Patient_OPCharge_WithGroup_Discount_Save_Self_Test_Registration Created.png"));
  ...
  //--2ndEncounter--//
			...
			Thread.sleep(3000);
		      ...
		      FileUtils.copyFile(screenshot2, new File(".//ScreenShots//Existing_Patient_OPCharge_WithGroup_Discount_Save_Self_Test_2ndEncounter Created.png"));
	...
	//SideMenuBar
	  ...
	  Thread.sleep(5000);
	   ...
	   System.out.println("OP Charge Screen Not Appear"); 
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//Existing_Patient_OPCharge_WithGroup_Discount_Save_Self_Test_OPChargeScreen.png")); 
...
//---Discount---//
	...
	//AddButton
      ...
      FileUtils.copyFile(screenshot4, new File(".//ScreenShots//Existing_Patient_OPCharge_WithGroup_Discount_Save_Self_Test_ChargesSave2.png"));
      Thread.sleep(3000);
