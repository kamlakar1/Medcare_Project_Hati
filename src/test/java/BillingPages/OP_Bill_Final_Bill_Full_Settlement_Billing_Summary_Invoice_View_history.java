...
public class OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_history {
    ...
    By History =By.cssSelector("mat-icon[ng-reflect-message='History']");
    
	public OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_history (WebDriver driver)
...

	{
		...
		FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_history_EncounterListScreen.png")); 
		...
		FileUtils.copyFile(screenshot23, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_history_BillSave.png"));
		Thread.sleep(3000);
		...
		FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OP_Bill_Final_Bill_Full_Settlement_Billing_Summary_Invoice_View_history.png")); 
