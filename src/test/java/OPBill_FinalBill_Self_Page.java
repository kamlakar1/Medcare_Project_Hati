...
public class OPBill_FinalBill_Self_Page {
	...
	By Saveconfirm=By.cssSelector("mat-icon[ng-reflect-message='Yes']");
		...
		public OPBill_FinalBill_Self_Page (WebDriver driver)
		...
		//Clicking on menu Icon
				...
				driver.findElement(Saveconfirm).click();
				 ...
				 //Assertion1
			      ...
			      FileUtils.copyFile(screenshot1, new File(".//ScreenShots//OPBill_FinalBill_Self_Test_QuickRegistrationSaved.png"));
				...
				//CreatedMRN
				  ...
				  Thread.sleep(5000);
				   ...
				   System.out.println("Encounter List Screen Not Appear"); 
					...
					FileUtils.copyFile(screenshot2, new File(".//ScreenShots//OPBill_FinalBill_Self_Test_EncounterListScreen.png")); 
...
//---OPBill---//
	...
	//ServiceSelect
      ...
      FileUtils.copyFile(screenshot3, new File(".//ScreenShots//OPBill_FinalBill_Self_Test_OPChargesSave.png"));
      Thread.sleep(3000);
      ...
      FileUtils.copyFile(screenshot24, new File(".//ScreenShots//OPBill_FinalBill_Self_Test_OP Final Bill Payement Collected.png"));
      Thread.sleep(3000);
		...
		driver.findElement(BillMRNSearch).click();
		  ...
		  Thread.sleep(5000);
		   ...
		   System.out.println("Billing Summary Screen Not Appear"); 
			...
			FileUtils.copyFile(screenshot4, new File(".//ScreenShots//OPBill_FinalBill_Self_Test_BillingSummary.png")); 
