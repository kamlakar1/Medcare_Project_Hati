...
public class OP_GLApproval_Status_Pending_Page {
...
//ContactInformation 
		...
		public OP_GLApproval_Status_Pending_Page (WebDriver driver)
  ...
  
  {
	...
	//GL Effective date
		...
		//GLExpiry date
		Thread.sleep(2000);
		WebElement toClear1 = driver.findElement(ExpiryDate);
		toClear.sendKeys(Keys.CONTROL + "a");
		toClear.sendKeys(Keys.DELETE);
		Thread.sleep(2000);
		driver.findElement(ExpiryDate).sendKeys(dateFormat.format(currentDate1));
      ...
      FileUtils.copyFile(screenshot1, new File("C:\\Users\\SDGT Guest\\eclipse-workspace\\MavelTest\\ScreenShots\\GLApproval Saved.png"));
