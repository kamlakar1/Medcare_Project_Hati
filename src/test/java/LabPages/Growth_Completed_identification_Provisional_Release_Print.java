...
public class  Growth_Completed_identification_Provisional_Release_Print
{
	...
	By receiversubmit = By.xpath("button[ng-reflect-message='Receive Sample']");
	By receivesample = By.cssSelector("button[ng-reflect-message='Receive Sample']");
	By Pathology = By.id("22663");
	By sampleprocessing = By.id("22663");
	...
	By Panel = By.cssSelector("mat-select[ng-reflect-placeholder='Panel']");
	...
	public Growth_Completed_identification_Provisional_Release_Print(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	//	driver.findElement(status).click();
		...
		Growth119.click();
	//	driver.findElement(nogroth).click();
		WebElement status17 = wait.until(ExpectedConditions.elementToBeClickable(status));
		status17.click();
	//	driver.findElement(status).click();
	...
	//	driver.findElement(Expand).click();
		...
		sercahghh182.click();
		WebElement sercahghh138 = wait.until(ExpectedConditions.elementToBeClickable(edit));
		sercahghh138.click();
		...
		WebElement Panel1 = wait.until(ExpectedConditions.elementToBeClickable(Panel));
		Panel1.click();
