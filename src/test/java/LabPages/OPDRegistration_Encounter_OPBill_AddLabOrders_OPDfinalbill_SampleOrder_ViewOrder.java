...
public class OPDRegistration_Encounter_OPBill_AddLabOrders_OPDfinalbill_SampleOrder_ViewOrder 
{
	WebDriver driver;
	...
	By ServiceNameSelOpt=By.xpath("//span[contains(text(),'Full Blood Count (FBC)')]");
...
By ConfirmNoCheckOut=By.cssSelector("mat-icon[ng-reflect-message='No']");
By Menu2=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/app-header/nav/mat-icon[2]");
By LabMenu=By.xpath("//*[@id='mat-menu-panel-11']/div/div/div[1]/div[1]/div[4]/div/img");
...
//Clicking on advanced search
	...
	public void OPD_OP_FinalBill_LabFlow() throws InterruptedException, IOException
	{
		...
		Thread.sleep(2000);
		driver.findElement(ServiceNameClick).sendKeys("Full Blood Count (FBC)");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(ConfirmNoCheckOut).click();
		
		Thread.sleep(2000);
		Actions act2 = new Actions(driver);
		Thread.sleep(8000);
		WebElement ele1=driver.findElement(Menu2);
		act2.moveToElement(ele1).build().perform();
		act2.click(ele1).perform();

		Thread.sleep(2000);
		driver.findElement(LabMenu).click();
	...
	public OPDRegistration_Encounter_OPBill_AddLabOrders_OPDfinalbill_SampleOrder_ViewOrder(WebDriver driver)
	{
		this.driver=driver;
	}
}
