...
public class Outsource_Advanced_search
{
	...
	By sampleno = By.cssSelector("input[ng-reflect-placeholder='Sample No']");
	By sercahghh = By.cssSelector("button[ng-reflect-message='Search']");
	By getmrn = By.xpath("//mat-table/mat-row[1]/mat-cell[3]");
	By outsourcing = By.cssSelector("a[ng-reflect-router-link='outsourced']");
    By Outsourcelist = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-outsourced/div[3]/div/mat-tab-group/mat-tab-header/div/div/div/div[2]");
	By GetMrn = By.xpath("//mat-table/mat-row[1]/mat-cell[3]");
    public Outsource_Advanced_search(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(5000);
		driver.findElement(outsourcing).click();
		Thread.sleep(5000);
		String vv = driver.findElement(GetMrn).getText();
      //  driver.findElement(Outsourcelist).click();
        Thread.sleep(5000);
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(sampleno).sendKeys(vv);
		Thread.sleep(5000);
