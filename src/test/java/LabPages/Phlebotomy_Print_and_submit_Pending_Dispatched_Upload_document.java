...
public class Phlebotomy_Print_and_submit_Pending_Dispatched_Upload_document
{
	...
	By Upload = By.xpath("/html/body/div[6]/div[2]/div/div/div/button[1]/mat-icon");
	...
	By PatientName = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dispatching/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[4]/span[2]");
	public Phlebotomy_Print_and_submit_Pending_Dispatched_Upload_document(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(5000);
		String bb = driver.findElement(PatientName).getText();
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys(bb);
		Thread.sleep(5000);
