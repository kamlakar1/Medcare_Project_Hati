...
public class Media_Observation_Growth_Completed_Save_Result_Entry_Hold
{
    ...
    By getmrnn = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry/div[3]/mat-table/mat-row/mat-cell[2]");
  ...
  //Race
  		...
  		By mainmmenu= By.cssSelector("mat-icon[ng-reflect-message='Menu']");
  		...
  		By sampletracking = By.cssSelector("a[ng-reflect-router-link='phlebotomy']");
  		//Area
  		...
  		By des_3 = By.xpath("/html/body/div[2]/div[2]/div/div/div/mat-option[1]");
  		...
  		By savesampleidenti = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/section/div/div/div[3]/button");
  		By SaveResultentry = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/section/div/div/div[3]/button");
  		...
  		By name = By.cssSelector("input[ng-reflect-placeholder='Patient Name']");
  		By name_3 = By.cssSelector("input[ng-reflect-placeholder='Patient MRN']");

  		By ResultEntryApprova = By.cssSelector("a[ng-reflect-router-link='microbiology,result-entry-appr']");
  		By Checkboxkj = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry-approval/app-micro-result-entry/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By 	hold = By.cssSelector("button[ng-reflect-message='Hold']");
  		By holdsave = By.cssSelector("mat-icon[ng-reflect-message='Hold']");
  		By checkboxxx = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By unhold = By.cssSelector("button[ng-reflect-message='Unhold']");
  		By Unholdsave = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-sample-processing-dialog/div/div/form/div[2]/div/button[1]/span[1]/mat-icon");
  		By editunhod = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry/div[3]/mat-table/mat-row/mat-cell[15]/mat-icon");
  		By savesamplle = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/section/div/div/div[4]/button");
  		By resultverifaication = By.cssSelector("a[ng-reflect-router-link='microbiology,result-entry-vari']");
  		By resultverifiedt = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-mirco-result-verification/app-micro-result-entry/div[3]/mat-table/mat-row/mat-cell[15]/mat-icon");
  		By SubmitSample = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/section/div/div/div[3]/button");
  		public enter_media_observation_identificationsave(WebDriver driver)
  		{
  			this.driver=driver;
  		}
  		...
  		By OPD3=By.xpath("/html/body/div[3]/div[2]/div/div/div/div/div[1]/div[1]/div[1]/div");

  		By GetMMRN = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry-approval/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[2]");
  		By ResultEntryVerification = By.cssSelector("a[ng-reflect-router-link='microbiology,result-entry-vari']");
  		By EditResultverification = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-mirco-result-verification/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[15]");
  		By SaveSubbmit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/section/div/div/div[3]/button");
  		By ResultApproval = By.cssSelector("a[ng-reflect-router-link='microbiology,result-entry-appr']");
  		By Editresultapprov = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry-approval/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[15]");
  		By Savesugbmit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/section/div/div/div[3]/button");

  		By StorageDiscarrd = By.id("226652");
  		By PendingAllocation = By.id("226152");
  		By SelectCheckbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-pending-allocation/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
  		By Allocate = By.cssSelector("mat-icon[ng-reflect-message='Allocate']");
  		By AssineLocation = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-send-allocation/div/div[3]/div/mat-table/mat-row/td/mat-radio-button/label/span[1]");
  		By Confirmm = By.cssSelector("mat-icon[ng-reflect-message='Confirm']");

  		By StorageStock = By.id("226153");
  		By selectCheckboxx = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-storage-stock/div[2]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
  		By SendOut = By.cssSelector("button[ng-reflect-message='Send Out']");
  		By Type = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-send-out/div/div/div[2]/mat-form-field[1]/div/div[1]/div[3]/mat-select");
  		By InhouseTransfer = By.xpath("//span[contains(text(),' In House Trasfer ')]");
  		By Location = By.cssSelector("input[ng-reflect-name='remark']");
  		By IssuedOn = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-send-out/div/div/div[2]/mat-form-field[2]/div/div[1]/div[3]/input");
  		By IssuedBy = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-send-out/div/div/div[2]/mat-form-field[3]/div/div[1]/div[3]/mat-select");
  		By SelectIssuedBy = By.xpath("//span[contains(text(),' DR Salina Yusof ')]");
  		By IssuedTo = By.cssSelector("input[ng-reflect-name='nameIssuedTo']");
  		By Svaeet = By.cssSelector("mat-icon[ng-reflect-message='Save']");
  		By PendingReceive = By.id("226154");
  		By Clickoncheckboxsd = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-pending-receive/div[2]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
  		By BackTostorage = By.cssSelector("button[ng-reflect-message='Back to Storage']");
  		By Clickoncircle = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-send-allocation/div/div[3]/div/mat-table/mat-row/td/mat-radio-button/label/span[1]");
  		By ReceivedBy = By.cssSelector("mat-select[ng-reflect-name='first']");
  		By Recevedopt = By.xpath("//span[contains(text(),' DR Salina Yusof  ')]");
  		By confirmyt = By.cssSelector("mat-icon[ng-reflect-message='Confirm']");
  		//By Checkboxd = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-pending-receive/div[2]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
  		By ReceivedList = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-pending-receive/div[2]/div/mat-tab-group/mat-tab-header/div/div/div/div[2]");

  		By PatientName = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-pending-receive/div[2]/div/mat-tab-group/div/mat-tab-body[2]/div/div/mat-table/mat-row[1]/mat-cell[3]");




  		By SampleNo = By.cssSelector("input[ng-reflect-name='sampleNumber']");



  		By DiscardSample = By.id("226156");
  		By Clickonchecbodsx = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-sample-discard/div[2]/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
  		By MarkDiscard = By.cssSelector("	button[ng-reflect-message='Mark Discard']");
  		By DiscardType = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-mark-discard/div/div[2]/mat-form-field[1]/div/div[1]/div[3]/mat-select");
  		By Discatrtyoeopt = By.xpath("//span[contains(text(),' STORAGE ')]");
  		By Discardon = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-mark-discard/div/div[2]/mat-form-field[2]/div/div[1]/div[3]/input");
  		By doscardsave = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-mark-discard/div/div[3]/div/button/span[1]/mat-icon");
  		By DiscardSamplem = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-sample-discard/div[2]/mat-tab-group/mat-tab-header/div/div/div/div[2]");
  		By Getmrnvrify = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry/div[3]/mat-table/mat-row/mat-cell[2]");
  		By ResultEntry = By.cssSelector("a[ng-reflect-router-link='pathology,result-entry']");
  		By checkboxdd = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");		
  		By holdd = By.cssSelector("button[ng-reflect-message='Hold']");		
  		By Confirmhold= By.cssSelector("mat-icon[ng-reflect-message='Hold']");
  		By getholddata = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row/mat-cell[14]");
  		By getholddatanmae = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row/mat-cell[3]/span[2]");


  		By CheckboxToUnhold = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Unbhold = By.cssSelector("button[ng-reflect-message='Unhold']");
  		By confirmunhold = By.cssSelector("mat-icon[ng-reflect-message='Unhold']");
  		By getdataAccepted = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row/mat-cell[14]");
  		By Reject = By.cssSelector("button[ng-reflect-message='Reject']");
  		By Selectreason = By.cssSelector("mat-select[ng-reflect-id='rejectReason']");
  		By Resaonoption= By.xpath("/html/body/div[2]/div[4]/div/div/div/mat-option[1]/span");
  		By Rejectbutton = By.cssSelector("mat-icon[ng-reflect-message='Reject']");
  		By SampleTracking = By.cssSelector("a[ng-reflect-router-link='phlebotomy']");

  		By checkboxclick= By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-central-receiving/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By ReceiveSample = By.cssSelector("button[ng-reflect-message='Receive Sample']");
  		By ConfirmReceiveSample = By.cssSelector("mat-icon[ng-reflect-message='Receive Sample']");
  		By statuss = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row/mat-cell[14]");
  		By Pringt = By.cssSelector("button[ng-reflect-message='Print']");

  		By ResultEntry1 = By.cssSelector("a[ng-reflect-router-link='pathology,result-entry']");
  		By Checkboxchab = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
  		By checkboocx = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");

  		By check = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-processing/div[3]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Result_entryupbuton = By.xpath("//mat-row[1]/mat-cell[6]");
  		By InternalDemo = By.cssSelector("textarea[ng-reflect-name='dataw']");
  		By selectrecoo = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-processing/div[3]/div[2]/mat-table/mat-row");
  		By modifyrecord = By.xpath("//mat-row[@data-automation-attribute='row-worklist']/mat-cell[1]");

  		By Parameterinput1 = By.xpath("//tr[1]/td[2]/div/input");
  		By Parameterinput2 = By.xpath("//tr[2]/td[2]/div/input");
  		By Parameterinput3 = By.xpath("//tr[3]/td[2]/div/input");
  		By Parameterinput4 = By.xpath("//tr[4]/td[2]/div/input");
  		By Parameterinput5 = By.xpath("//tr[5]/td[2]/div/input");
  		By Parameterinput6 = By.xpath("//tr[6]/td[2]/div/input");
  		By Parameterinput7 = By.xpath("//tr[7]/td[2]/div/input");
  		By Parameterinput8 = By.xpath("//tr[8]/td[2]/div/input");
  		By Parameterinput9 = By.xpath("//tr[9]/td[2]/div/input");
  		By Parameterinput10 = By.xpath("//tr[10]/td[2]/div/input");
  		By Parameterinput111 = By.xpath("//tr[11]/td[2]/div/input");
  		By Parameterinput112 = By.xpath("//tr[12]/td[2]/div/input");
  		By parameterforretest = By.xpath("//tr[12]/td[2]/div/input");
  		By Clickoncheckbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-processing/div[3]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By ClickOnsAVE = By.cssSelector("img[title='Save']");	
  		By submitbut = By.cssSelector("img[title='Save']");
  		...
  		By Sample_No = By.xpath("//mat-row[1]/mat-cell[6]");
  		// By ResultValifdation = By.cssSelector("a[ng-reflect-router-link='pathology,verification-list']"
  		By Checkboxt = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-processing/div[3]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By SampleTrackingg = By.cssSelector("a[ng-reflect-router-link='phlebotomy']");
  		By ClickOncheckbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-verification-list/app-result-entry/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Clickon_checkbox= By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-verification/div[3]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Clickonsubmit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-verification/div[4]/table/tr/td[6]/button");
  		By ResultApporoavl = By.cssSelector("a[ng-reflect-router-link='pathology,approval-list']");
  		By Verified = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-approval-list/app-result-entry/div[3]/mat-table/mat-row/mat-cell[14]");
  		By Click_Back = By.xpath("//span[contains(text(),'Back')]");
  		By Submitbutton = By.xpath("//span[contains(text(),'Submit')]");
  		By Resultvalcech = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-verification-list/app-result-entry/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Click_OnThreedot = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row/mat-cell[15]/mat-icon");
  		By Upload_document = By.xpath("//span[contains(text(),'Upload Document')]");
  		By upload_secondButton = By.cssSelector("mat-icon[ng-reflect-message='Upload Document']");
  		By ChooseFile=By.xpath("/html/body/div[2]/div[4]/div/mat-dialog-container/app-uploadfile/div/div[2]/table/tr/td/input");
  		By UploadButtonthird = By.cssSelector("mat-icon[ng-reflect-message='Upload']");
  		By save_lat=By.cssSelector("mat-icon[ng-reflect-message='Save']");
  		By Filename = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-documentupload/div[3]/div/div[1]/table/tbody/tr/td[2]");

  		By checkboxvalidation = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-verification-list/app-result-entry/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Rejectn = By.cssSelector("button[ng-reflect-message='Reject']");
  		By Reject_resonn= By.cssSelector("mat-select[ng-reflect-placeholder='Reject Reason']");
  		By Rejectoopt = By.xpath("//span[contains(text(),' Sample Recollection ')]");
  		By Rejectsave = By.cssSelector("mat-icon[ng-reflect-message='Reject']");
  		By StatusReject = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-phlebotomy/mat-tab-group/div/mat-tab-body[1]/div/div/mat-table/mat-accordion/mat-expansion-panel/div/div/div/table/tr/td[14]/span/b");


  		By UploadResultEntrybutton1 = By.cssSelector("button[ng-reflect-message='Upload Document']");
  		By UploadResultEntrybutton2 = By.cssSelector("mat-icon[ng-reflect-message='Upload Document']");
  		By CheeoseFile_4 = By.xpath("/html/body/div[3]/div[4]/div/mat-dialog-container/app-uploadfile/div/div[2]/table/tr/td/input");
  		By Upload3 = By.cssSelector("mat-icon[ng-reflect-message='Upload']");
  		By SaveButton5 = By.cssSelector("mat-icon[ng-reflect-message='Save']");
  		By ThreeDot = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-verification-list/app-result-entry/div[3]/mat-table/mat-row/mat-cell[15]/mat-icon");
  		By UploadDocumet =By.xpath("//span[contains(text(),'Upload Document')]");
  		By FileNameAssertion = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-documentupload/div[3]/div/div[1]/table/tbody/tr/td[2]");
  		By Uploaddocumet_2 = By.cssSelector("mat-icon[ng-reflect-message='Upload Document']");
  		By ChooseFileValidation = By.xpath("/html/body/div[2]/div[4]/div/mat-dialog-container/app-uploadfile/div/div[2]/table/tr/td/input");
  		By Uploadnewfile = By.cssSelector("mat-icon[ng-reflect-message='Upload']");
  		By SaveValidation = By.cssSelector("mat-icon[ng-reflect-message='Save']");
  		By NewFileValidation = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-documentupload/div[3]/div/div[1]/table/tbody/tr[2]/td[2]");

  		By Reset = By.xpath("//span[contains(text(),'Retest')]");
  		By RBCCheckbox = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-confirm-dialog-recall/div/div[2]/mat-table/mat-row[1]/td/mat-checkbox");
  		By comments = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-confirm-dialog-recall/div/div[2]/mat-table/mat-row[1]/mat-cell[2]/mat-form-field/div/div[1]/div[3]/input");
  		By ClickOnReason = By.cssSelector("mat-select[ng-reflect-name='first']");
  		By SampleRestest = By.xpath("//span[contains(text(),'Sample Retest')]");
  		By Confirmmm= By.cssSelector("mat-icon[ng-reflect-message='Confirm']");
  		By checkbow = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-verification-list/app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
  		By ResultApprovalCheckbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-approval-list/app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
  		By Resultapprovalcheckboxsubmit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-approval/div[3]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Submmit = By.xpath("//span[contains(text(),'Submit')]");
  		By Report = By.cssSelector("a[ng-reflect-router-link='result-entry-report']");
  		By getpatiaentname = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-approval-list/app-result-entry/div[3]/mat-table/mat-row/mat-cell[3]/span[2]");
  		By Patientnameget = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-report/div[3]/mat-table/mat-row[1]/mat-cell[2]");
  		By Clickontecord = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-verification/div[3]/div[2]/mat-table/mat-row/mat-cell[1]");
  		By ResulApproval= By.cssSelector("a[ng-reflect-router-link='pathology,approval-list']");
  		By ResultApporvalCheckbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-approval-list/app-result-entry/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By SecondCheckboxClikc = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-approval/div[3]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Clickonrecord = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-approval/div[3]/div[2]/mat-table/mat-row/mat-cell[1]");
  		By Uploaddoc = By.cssSelector("button[ng-reflect-message='Upload Document']");
  		By Uploaddocumet = By.cssSelector("mat-icon[ng-reflect-message='Upload Document']");
  		By CheeoseFille = By.xpath("/html/body/div[2]/div[4]/div/mat-dialog-container/app-uploadfile/div/div[2]/table/tr/td/input");
  		By Uploadd = By.cssSelector("mat-icon[ng-reflect-message='Upload']");
  		By Savee = By.cssSelector("mat-icon[ng-reflect-message='Save']");

  		By GetapprovalFilename = By.xpath("/html/body/div[2]/div[2]/div/mat-dialog-container/app-documentupload/div[3]/div/div[1]/table/tbody/tr/td[2]");
  		By Recordcheckbox =By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-verification/div[3]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");    		
  		By Clickonrecordd = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-verification/div[3]/div[2]/mat-table/mat-row/mat-cell[1]");
  		By retestparameter = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-verification/div[3]/div[2]/mat-table/div[1]/mat-accordion/mat-expansion-panel/div/div/div/table/tr[1]/td[2]/div/input");
  		By Recollect = By.xpath("//span[contains(text(),'Recollect')]");
  		By Reasonn = By.cssSelector("mat-select[ng-reflect-name='first']");
  		By ReasonOpt = By.xpath("//span[contains(text(),'Sample Recollection')]");
  		By Yesss = By.cssSelector("mat-icon[ng-reflect-message='Yes']");
  		By getpatiaentnameu = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[3]/span[2]");
  		By Recollectegettext = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-phlebotomy/mat-tab-group/div/mat-tab-body[1]/div/div/mat-table/mat-accordion/mat-expansion-panel/div/div/div/table/tr/td[14]/span/b");
  		By Submitbuttonn = By.xpath("//span[contains(text(),'Submit')]");
  		By Checkboxsd = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-verification-list/app-result-entry/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Checkboxclikc = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-verification/div[3]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By checkbogvx =By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
  		By checkboxvalidate = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-verification-list/app-result-entry/div[3]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By Testnamechecbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-verification/div[3]/div[2]/mat-table/mat-row/mat-cell[1]/mat-checkbox");
  		By resultapprovalrec = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry-approval/div[3]/div[2]/mat-table/mat-row/mat-cell[1]");
  		By checkboxfdb = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
        ...
        By PrintAll = By.cssSelector("img[title='Print']");
    ...
    public Media_Observation_Growth_Completed_Save_Result_Entry_Hold(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		// Navigating to the LAB module
				...
				Thread.sleep(1000);
				driver.findElement(name).sendKeys("GENERALFLOW");
				Thread.sleep(1000);
	...
	public void Resultentryadvance() throws InterruptedException {
		...
		// Click on Lab in the menu
		driver.findElement(Lab).click();
		Thread.sleep(3000);

		// Move to the sidebar using Actions
		new Actions(driver).moveToElement(driver.findElement(SideBar)).build().perform();
		Thread.sleep(3000);

		// Click on the 'Microbiology' option
		driver.findElement(Microbilogy).click();
		Thread.sleep(3000);

		// Click on 'Result Entry Dashboard'
		driver.findElement(ResultEntryDashboard).click();
		Thread.sleep(3000);

		// Get MRN value from the element
		String mrnValue = driver.findElement(Getmrn).getText();
		Thread.sleep(3000);
		...
		// Send the MRN value to the search input field
		driver.findElement(name_3).sendKeys(mrnValue);
		Thread.sleep(3000);
		...
		String verifymrn = driver.findElement(getmrnn).getText();
		String Actualmrn = verifymrn;
		String Expectedmrn = verifymrn;
		Assert.assertEquals(Actualmrn, Expectedmrn, "MRN has been verified sucessfully");
		
		
		
		
	}
public void WorlListprint() throws InterruptedException {
		...
		driver.findElement(PrintAll).click();
		Thread.sleep(3000);

		String GetUrl = driver.getCurrentUrl();
		String Actualmrn = GetUrl;
		String Expectedmrn = GetUrl;
		Assert.assertEquals(Actualmrn, Expectedmrn, "MRN has been verified sucessfully");
