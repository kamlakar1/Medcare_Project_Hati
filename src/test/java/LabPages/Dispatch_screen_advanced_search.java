...
public class Dispatch_screen_advanced_search
{
    ...
    By getmrn = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-phlebotomy/mat-tab-group/div/mat-tab-body[1]/div/div/mat-table/mat-row[1]/mat-cell[1]");
	public Dispatch_screen_advanced_search(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		String getmrnw = driver.findElement(getmrn).getText();
				
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys(getmrnw);
		Thread.sleep(5000);
		...
		//String verifymrn = driver.findElement(getmrnw).getText();
		String Actualmrn = getmrnw;
		String Expectedmrn = getmrnw;
