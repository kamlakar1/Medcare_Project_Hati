...
public class Microbiology_Media_Observation_Advanced_search
{
    ...
    By GetMn = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-incubation/div[3]/mat-table/mat-row[1]/mat-cell[1]");

	public Microbiology_Media_Observation_Advanced_search(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(3000);
		String jj = driver.findElement(GetMn).getText();
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys(jj);
		Thread.sleep(5000);
