...
public class Phlebotomy_Printand_submit_Pending_Dispatched_Reprint
{
	...
	public Phlebotomy_Printand_submit_Pending_Dispatched_Reprint(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(4000);
		//	driver.findElement(closee).click();
		...
		Actions act0 = Actions(driver);
		WebElement overforopdslide9=driver.findElement(SideBarMenu33);
		act0.moveToElement(overforopdslide9).build().perform();

		Thread.sleep(2000);
		driver.findElement(sampletrack).click();
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		String IssueListindvrify = driver.findElement(printandsubmit).getText();
		String ActualQuantity = IssueListindvrify;
		String ExpectedQuantity = IssueListindvrify;
		Thread.sleep(3000);
		driver.findElement(printandsubmit).click();
		Thread.sleep(1000);
