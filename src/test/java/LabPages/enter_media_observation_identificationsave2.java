...
public class  enter_media_observation_identificationsave2
{
	...
	public enter_media_observation_identificationsave2(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void Enter_Abnormal_Result() throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(name_3).sendKeys("GENERALFLOW");
		Thread.sleep(1000);
		...
		driver.findElement(Testvale13).sendKeys("4");
		Thread.sleep(3000);
	...
	public void Enter_Critical_Result() throws InterruptedException {
	...
	public void Enter_Recollect_Result() throws InterruptedException {
		...
		driver.findElement(SampleNO).click();
		Thread.sleep(3000);


		driver.findElement(ResultValidationn).click();
		Thread.sleep(3000);

		driver.findElement(REsultsubmit).click();
		Thread.sleep(3000);

		driver.findElement(SideBarr).click();
		Thread.sleep(3000);

		driver.findElement(ResultApproval).click();
		Thread.sleep(3000);

		driver.findElement(SampleNO).click();
		Thread.sleep(3000);

		driver.findElement(Checkboxapp).click();
		Thread.sleep(3000);

		driver.findElement(Recollect).click();
		Thread.sleep(3000);
		...
		driver.findElement(rejectopttt).click();
		Thread.sleep(3000);
	...
	public void Enter_reject_Result() throws InterruptedException {
	...
	public void Retest_in_Result_Validatione() throws InterruptedException {
	...
	public void EnterAbnormal_ResultModify() throws InterruptedException {
		...
		driver.findElement(Expand).click();
		Thread.sleep(1000);
		driver.findElement(name_3).sendKeys("sichu");
		Thread.sleep(1000);
		driver.findElement(sercahghh).click();
		Thread.sleep(3000);
	...
	public void Click_back_Verify_color_code_resultvatliaftionNormal() throws InterruptedException {
