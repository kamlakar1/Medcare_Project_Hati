...
public class  enter_media_observation_identificationsave_provisonal_print
{
	//private static final By UploadImhe = null;
		...
		public enter_media_observation_identificationsave_provisonal_print(WebDriver driver)
		{
			this.driver=driver;
		}
        ...
        By PreliminaryRelease = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[3]/div/mat-checkbox/label/span[1]/span[1]");
	...
	//Thread.sleep(3000);
		...
		driver.findElement(PreliminaryRelease).click();
		Thread.sleep(3000);
