...
public class Phlebotomy_Pending_Outsource_Reject_Current_order_Print_and_submit
{
	...
	By mrnnn = By.cssSelector("input[ng-reflect-placeholder='MRN']");
	...
	By Dispatch = By.cssSelector("a[ng-reflect-router-link='outsourced']");
	By threedotmenu = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dispatching/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[10]/mat-icon");
	...
	By Dispatched = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dispatching/div[3]/div/mat-tab-group/mat-tab-header/div/div/div/div[2]");
	By ScanBarcode = By.cssSelector("input[ng-reflect-placeholder='Sample ID']");
	By Barcode = By.xpath("//button//span[contains(text(),'Barcode')]");
	By selectcheckbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-outsourced/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
	By Reject = By.cssSelector("img[title='Reject']");
	By Reason = By.cssSelector("mat-select[ng-reflect-name='first']");
	By Reasonopt=By.xpath("//span[contains(text(),'Sample Reject on Dispatch')]");
	By save = By.cssSelector("mat-icon[ng-reflect-message='Yes']");
	By SampleTracking = By.id("22662");
	By Patiantname = By.cssSelector("input[ng-reflect-placeholder='Patient Name']");
	By getpatname = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-outsourced/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row/mat-cell[4]/span[2]");
	By Printandsample = By.cssSelector("img[title='Print and Submit']");
	By submit = By.cssSelector("button[value='submit']");
	By recollect = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-phlebotomy/mat-tab-group/div/mat-tab-body[1]/div/div/mat-table/mat-row[1]/mat-cell[7]/span");
	By Clickonchecbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-phlebotomy/mat-tab-group/div/mat-tab-body[1]/div/div/mat-table/mat-accordion/mat-expansion-panel/div/div/div/table/tr/td[1]/mat-checkbox");
	By Clickonyes = By.cssSelector("button[value='submit']");
	By Saveandsubmit = By.cssSelector("mat-icon[ng-reflect-message='Print and Submit']");
	By getstatus = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-phlebotomy/mat-tab-group/div/mat-tab-body[1]/div/div/mat-table/mat-accordion/mat-expansion-panel/div/div/div/table/tr/td[14]/span");
	public Phlebotomy_Pending_Outsource_Reject_Current_order_Print_and_submit(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	//	Thread.sleep(2000);
		...
		Thread.sleep(5000);
		String getpatiantname = driver.findElement(getpatname).getText();
		System.out.println(getpatiantname);
		Thread.sleep(5000);
		...
		Thread.sleep(5000);
		Actions actttt= new Actions(driver);
		WebElement overforopdslide2=driver.findElement(SideBar);
		actttt.moveToElement(overforopdslide2).build().perform();
		Thread.sleep(5000);
		driver.findElement(SampleTracking).click();
		Thread.sleep(5000);
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		Thread.sleep(5000);
		driver.findElement(Patiantname).sendKeys(getpatiantname);
		Thread.sleep(5000);
		driver.findElement(sercahghh).click();
		Thread.sleep(5000);
		driver.findElement(recollect).click();
		Thread.sleep(5000);
		driver.findElement(Clickonchecbox).click();
		Thread.sleep(5000);
		...
		Assert.assertEquals(URL, "https://medcare-productqa.hatiintl.com/#/Dashboard/pdfViewer");
		Thread.sleep(5000);
