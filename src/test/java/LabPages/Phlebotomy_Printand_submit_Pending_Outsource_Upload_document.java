...
public class Phlebotomy_Printand_submit_Pending_Outsource_Upload_document
{
	...
	By threedotmenu = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-outsourced/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[10]");
	By Upload = By.xpath("/html/body/div[6]/div[2]/div/div/div/button[3]/mat-icon");
	By upload_2 = By.cssSelector("mat-icon[ng-reflect-message='Upload Document']");
	By ChooseFiles=By.xpath("/html/body/div[7]/div[4]/div/mat-dialog-container/app-uploadfile/div/div[2]/table/tr/td/input");
	By upload_3 = By.xpath("/html/body/div[7]/div[4]/div/mat-dialog-container/app-uploadfile/div/div[3]/div/button/span[1]/mat-icon");
	By saveupload = By.xpath("/html/body/div[7]/div[2]/div/mat-dialog-container/app-documentupload/div[3]/div/div[2]/table/tr/td[2]/button[2]/span[1]/mat-icon");
	...
	By Getsampleno = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-outsourced/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[3]");
	public Phlebotomy_Printand_submit_Pending_Outsource_Upload_document(WebDriver driver)
	{
		this.driver=driver;
	}
