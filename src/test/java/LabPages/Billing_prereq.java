...
public class Billing_prereq
{
	//private static final By UploadImhe = null;
	WebDriver driver=null;
	
	By nop = By.cssSelector("mat-icon[ng-reflect-message='No']");
	...
	By ServiceSelect=By.xpath("//span[contains(text(),'Culture Bacterial, Throat Swab |')]");
	...
	By Store = By.cssSelector("mat-select[ng-reflect-name='store']");
	By Stroeopt = By.xpath("//span[contains(text(),' KL IP Pharmacy')]");
	By close = By.cssSelector("mat-icon[ng-reflect-message='Close']");
	
	By REGISTER = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/ng-sidebar/aside/app-sidebar/app-menu/ul/li[3]/a");
	public Billing_prereq(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(5000);
		driver.findElement(mainmenuuu).click();
		//BillIcon
		Thread.sleep(2000);
		...
		//ServiceName
		Thread.sleep(5000);
		driver.findElement(ServiceName).sendKeys("cult");
	...
	public void hemotollogyService() throws InterruptedException, AWTException {
	 ...
	 */
		...
		//ServiceName
		Thread.sleep(5000);
		driver.findElement(ServiceName).sendKeys("Urin");

		//ServiceSelect
		Thread.sleep(6000);
		driver.findElement(ServiceSelect1).click();
