...
public class Microbiology_Result_Verification_Advanced_search
{
	...
	By getmrn = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-outsourced/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[3]");
	By Microbilogy = By.id("1567");	
	By Verification = By.id("15679");
	By Result_Entry_Verification = By.id("15679");
    ...
    public Microbiology_Result_Verification_Advanced_search(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(3000);
		String ii = driver.findElement(GetMrn).getText();
		Thread.sleep(3000);
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys(ii);
		Thread.sleep(5000);
