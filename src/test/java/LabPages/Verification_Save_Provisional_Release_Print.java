...
public class  Verification_Save_Provisional_Release_Print
{
	...
	public Verification_Save_Provisional_Release_Print(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	By Provisional = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[3]/div/mat-checkbox/label/span[1]");
	...
	//Thread.sleep(3000);
		...
		/*
		String gg = driver.findElement(BulkEntry).getText();
