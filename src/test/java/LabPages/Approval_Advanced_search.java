...
public class Approval_Advanced_search
{
	...
	By getmrn = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry-approval/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[2]");
	By Microbilogy = By.id("1567");	
	By microbioresultentry = By.id("15679");
	By ResultentryApproval = By.cssSelector("a[ng-reflect-router-link='microbiology,result-entry-appr']");

    By GetMRN = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry-approval/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[2]");

	public Approval_Advanced_search(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(3000);
		driver.findElement(ResultentryApproval).click();
		Thread.sleep(3000);
		String ff = driver.findElement(GetMRN).getText();
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys(ff);
		Thread.sleep(5000);
