...
public class Result_Verification_Bulk_Entry2 {
	// private static final By UploadImhe = null;
	WebDriver driver = null;
	By Hold = By.cssSelector("button[ng-reflect-message='Hold']");
	By Saave = By.xpath(
			"/html/body/div[2]/div[2]/div/mat-dialog-container/app-sample-processing-dialog/div/div/form/div[2]/div/button[1]");
	// Race
	...
	By savesampleidenti = By.xpath(
			"/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/section/div/div/div[4]/button");
	...
	By getmrnober = By.xpath(
			"/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-incubation/div[3]/mat-table/mat-row[1]/mat-cell[1]");
	By getmrn2 = By.xpath(
			"/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[2]");
	By Resultcerification = By.cssSelector("a[ng-reflect-router-link='microbiology,result-entry-vari']");
	By editverifi = By.xpath(
			"/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-mirco-result-verification/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[15]/mat-icon");
	By savbunitrresult = By.xpath(
	...
	By verifytheststus = By.xpath(
			"/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-mirco-result-verification/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[14]");
	By BulkEntry = By.cssSelector("button[ng-reflect-message='Bulk Entry']");

	public Result_Verification_Bulk_Entry2(WebDriver driver) {
		this.driver = driver;
	}
    ...
    By checkbojx = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-mirco-result-verification/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox");
	public void enter_media_observation_identification() throws InterruptedException, IOException, AWTException {
		...
		Thread.sleep(2000);
		WebElement SideBarr147 = wait.until(ExpectedConditions.elementToBeClickable(SideBarr));
		SideBarr147.click();
		Thread.sleep(2000);
		WebElement Resultcerification2 = wait.until(ExpectedConditions.elementToBeClickable(Resultcerification));
		Resultcerification2.click();
		/*
		 * WebElement editverifi3=
		 * wait.until(ExpectedConditions.elementToBeClickable(editverifi));
		 * editverifi3.click();
		 * 
		 * WebElement savbunitrresult3=
		 * wait.until(ExpectedConditions.elementToBeClickable(savbunitrresult));
		 * savbunitrresult3.click();
		 */
		//Thread.sleep(3000);
		driver.findElement(checkbojx).click();
		...
		/*
		 String gg = driver.findElement(Saave).getText();
		 
		 String Expected = gg; String Actaul = gg;
		 
		 Assert.assertEquals(Expected, Actaul, "Status has  been matched");
		 */
