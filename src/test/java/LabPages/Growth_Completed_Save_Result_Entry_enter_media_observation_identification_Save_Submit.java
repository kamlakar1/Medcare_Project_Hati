...
public class  Growth_Completed_Save_Result_Entry_enter_media_observation_identification_Save_Submit
{
	...
	By clickonedit = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-incubation/div[3]/mat-table/mat-row[1]/mat-cell[14]/mat-icon");
	...
	By selectrecheckbox = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-phlebotomy/mat-tab-group/div/mat-tab-body[1]/div/div/mat-table/mat-accordion/mat-expansion-panel/mat-expansion-panel-header/span[1]/mat-panel-title/mat-checkbox");
	...
	By submitsample = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-micro-result-entrydetails/div[2]/mat-grid-list/div/mat-grid-tile[4]/div/section/div/div/div[4]/button");
	...
	public Growth_Completed_Save_Result_Entry_enter_media_observation_identification_Save_Submit(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	//	WebElement mrnnn12 = wait.until(ExpectedConditions.elementToBeClickable(mrnnn));
		//mrnnn12.sendKeys("HISCKLMRN24512413");
		//driver.findElement(mrnnn)
	//	WebElement sercahghh12 = wait.until(ExpectedConditions.elementToBeClickable(sercahghh));
	//	sercahghh12.click();
	...
	//	WebElement Expand128 = wait.until(ExpectedConditions.elementToBeClickable(Expand));
		//Expand128.click();
	//	driver.findElement(Expand).click();
		//WebElement mrnnn129 = wait.until(ExpectedConditions.elementToBeClickable(mrnnn));
		//mrnnn129.sendKeys("HAUKIN");
		//driver.findElement(mrnnn)
	//	WebElement sercahghh182 = wait.until(ExpectedConditions.elementToBeClickable(sercahghh));
	//	sercahghh182.click();
	...
	//	descopt1.click();
		...
		interpretopt1.click();
		WebElement savesampleidenti1 = wait.until(ExpectedConditions.elementToBeClickable(submitsample));
