...
public class Dispatched_same_unit_Cancel3
{
	...
	By Dispatched = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dispatching/div[2]/mat-grid-list/div/mat-grid-tile[3]/div/button[2]");
	...
	By cancelopt = By.xpath("//span[contains(text(),' Dispatching Cancel ')]");
	By HYes= By.cssSelector("mat-icon[ng-reflect-message='Yes']");
	By threedot = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dispatching/div[3]/div/mat-tab-group/div/mat-tab-body[2]/div/div/mat-table/mat-row[1]/mat-cell[10]/mat-icon");
	By reprint= By.xpath("/html/body/div[2]/div[2]/div/div/div/button[1]");
	...
	By ClickOnThreeDot = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dispatching/div[3]/div/mat-tab-group/div/mat-tab-body[2]/div/div/mat-table/mat-row[1]/mat-cell[10]");
	
	By Reprint = By.xpath("	/html/body/div[7]/div[2]/div/div/div/button[1]/span");
	By Submit = By.cssSelector("mat-icon[ng-reflect-message='submit']");
	public Dispatched_same_unit_Cancel3(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		// Navigating to the LAB module
				...
				Thread.sleep(2000);
				driver.findElement(ClickOnThreeDot).click();
				Thread.sleep(2000);
