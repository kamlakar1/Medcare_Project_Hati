...
public class Phlebotomy_Printand_submit_Pending_Dispatched_Dispatched_same_unit_Cancel
{
	...
	By Printandsample = By.cssSelector("img[title='Print and Sample']");
	...
	By ClickOncancel = By.cssSelector("img[title='Cancel']");
	By Reason = By.xpath("/html/body/div[7]/div[2]/div/mat-dialog-container/app-confirm-remarks/div/form/div[2]/mat-form-field[1]/div/div[1]/div[3]/mat-select/div/div[1]");
	By cancelopt = By.xpath("//span[contains(text(),'Sample Cancellation')]");
	...
	By SampleNo = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-dispatching/div[3]/div/mat-tab-group/div/mat-tab-body[2]/div/div/mat-table/mat-row[1]/mat-cell[3]");
	By Submit = By.cssSelector("mat-icon[mattooltip='submit']");
	public Phlebotomy_Printand_submit_Pending_Dispatched_Dispatched_same_unit_Cancel(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(1000);
		driver.findElement(name).sendKeys("MICROBILOGYFLOW");
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		driver.findElement(cancelopt).click();
		Thread.sleep(2000);
