...
public class  Submit_Result_VerificationSubmit
{
	...
	By ResultAPPROBVAL = By.id("2266305");
	...
	By editverifi = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-mirco-result-verification/app-micro-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[1]/mat-checkbox/label/span[1]");
	...
	public Submit_Result_VerificationSubmit(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	By Checkboxx = By.xpath("//mat-row[1]/mat-cell[1]/mat-checkbox");
	By Print = By.cssSelector("img[title='Print']");
	By name_3 = By.cssSelector("input[ng-reflect-placeholder='Patient Name']");
	By Printt = By.cssSelector("img[title='Print']");
	By Threedpot = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-approval-list/app-result-entry/div[3]/mat-table/mat-row[1]/mat-cell[15]/mat-icon");
	By Reprint = By.xpath("/html/body/div[5]/div[2]/div/div/div/button[1]");
	...
	public void  Print_worklist() throws InterruptedException, IOException, AWTException 
	{	  
		...
		// Click on Result Verification
		driver.findElement(ResultAPPROBVAL).click();
		Thread.sleep(3000);

		// Click on Result Verification
		driver.findElement(Threedpot).click();
		Thread.sleep(3000);

		// Click on Edit Verification
		driver.findElement(Reprint).click();
		Thread.sleep(3000);

		// Click on Save Unit Result
		//driver.findElement(Printt).click();
		//Thread.sleep(3000);

		
		// Get text from printworklist
