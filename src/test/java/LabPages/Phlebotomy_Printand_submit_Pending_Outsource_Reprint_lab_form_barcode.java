...
public class Phlebotomy_Printand_submit_Pending_Outsource_Reprint_lab_form_barcode
{
	...
	By SampleNo = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-outsourced/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[3]");
	public Phlebotomy_Printand_submit_Pending_Outsource_Reprint_lab_form_barcode(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		Thread.sleep(5000);
		String gg = driver.findElement(SampleNo).getText();
		driver.findElement(ScanBarcode).sendKeys(gg, Keys.ENTER);
		Thread.sleep(5000);
		/*
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys("HISCKLMRN24412054");
		Thread.sleep(5000);
		...
		*/
		...
		Thread.sleep(5000);
		String IssueListindvrify = driver.findElement(Barcode).getText();
		String ActualQuantity = IssueListindvrify;
		String ExpectedQuantity = IssueListindvrify;
		Thread.sleep(3000);
		driver.findElement(Barcode).click();
		Thread.sleep(5000);
