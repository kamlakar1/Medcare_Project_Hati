...
public class Media_Observation_Growth_Completed_Save_Result_Entry_Unhold
{
    ...
    public Media_Observation_Growth_Completed_Save_Result_Entry_Unhold(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	{	  
		...
		//Clicking on menu Icon
                ...
                driver.findElement(PatintMRN).sendKeys(null);
	...
	//	driver.findElement(Expand).click();
		...
		mrnnn1.sendKeys("HISCKLMRN24512220");
