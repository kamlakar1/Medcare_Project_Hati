...
public class Phlebotomy_Pending_Outsource_Outsourced_Upload_document_Received
{
	...
	By mrnnn = By.cssSelector("input[ng-reflect-placeholder='Sample No']");
	...
	By threedotmenu = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-outsourced/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row/mat-cell[10]/mat-icon");
	By Upload = By.xpath("//span[contains(text(),'Upload Document')]");
	By upload_2 = By.cssSelector("mat-icon[ng-reflect-message='Upload Document']");
	By ChooseFiles=By.id("fileUpload");
	By upload_3 = By.cssSelector("mat-icon[ng-reflect-message='Upload']");
	By saveupload = By.cssSelector("mat-icon[ng-reflect-message='Save']");
	...
	By getsamono = By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-outsourced/div[3]/div/mat-tab-group/div/mat-tab-body[1]/div/div[1]/mat-table/mat-row[1]/mat-cell[3]");
	public Phlebotomy_Pending_Outsource_Outsourced_Upload_document_Received(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	//	Thread.sleep(2000);
		...
		Thread.sleep(5000);
		String mm = driver.findElement(getsamono).getText();
		//Thread.sleep(1000);
		//driver.findElement(ScanBarcode).sendKeys(mm, Keys.ENTER);
		Thread.sleep(5000);
		
		driver.findElement(Expand).click();
		Thread.sleep(5000);
		driver.findElement(mrnnn).sendKeys(mm);
		Thread.sleep(5000);
