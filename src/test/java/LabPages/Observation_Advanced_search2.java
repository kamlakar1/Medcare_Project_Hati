...
public class Observation_Advanced_search2 {
	...
	public Observation_Advanced_search2(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void enter_media_observation_identification() throws InterruptedException, IOException, AWTException {
		 ...
		 * WebElement mrnnn1 =
		 * wait.until(ExpectedConditions.elementToBeClickable(mrnnn));
		 * mrnnn1.sendKeys("HAUKIN"); WebElement sercahghh1 =
		...
		Expand1.click();
		WebElement mrnnn1 = wait.until(ExpectedConditions.elementToBeClickable(mrnnnm));
		mrnnn1.sendKeys(getmrnober1); 
		WebElement sercahghh1 = wait.until(ExpectedConditions.elementToBeClickable(sercahghh));
		sercahghh1.click();
		
		String getmrnober12 = driver.findElement(getmrnober).getText();
		
		String Expected = getmrnober12;
		String Actaul = getmrnober12;
