...
public class Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle {
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failed_Final_Bill_full_Settlement_Partial_Credit_Note_Billing_Summary_Credit_Note_list_Settle"+ dateFormat.format(date)));
		}
	}
