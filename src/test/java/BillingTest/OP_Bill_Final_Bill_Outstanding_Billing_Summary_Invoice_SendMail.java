...
public class OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMail {
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMail -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failed_OP_Bill_Final_Bill_Outstanding_Billing_Summary_Invoice_SendMail"+ dateFormat.format(date)));
		}
	}
