...
public class Debit_Note_with_discount_Section_Final_Bill_Partial_Settlement {
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","Debit_Note_with_discount_Section_Final_Bill_Partial_Settlement -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failed_Debit_Note_with_discount_Section_Final_Bill_Partial_Settlement"+ dateFormat.format(date)));
		}
	}
