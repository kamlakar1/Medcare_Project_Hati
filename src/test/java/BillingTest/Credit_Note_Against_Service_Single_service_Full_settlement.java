...
public class Credit_Note_Against_Service_Single_service_Full_settlement {
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","Credit_Note_Against_Service_Single_service_Full_settlement -"+dateFormat.format(date),false);
		recorder.start();  
