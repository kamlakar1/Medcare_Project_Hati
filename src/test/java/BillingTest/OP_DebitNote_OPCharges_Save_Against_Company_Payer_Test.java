...
public class OP_DebitNote_OPCharges_Save_Against_Company_Payer_Test {
  ...
  public void startBrowser() throws ATUTestRecorderException, InterruptedException 
  {
	  ...
	  WebDriverManager.chromedriver().setup();
		...
		recorder = new ATUTestRecorder(".//Videos//","OP_DebitNote_OPCharges_Save_Against_Company_Payer_Test"+dateFormat.format(date),false);
		recorder.start();
  }
