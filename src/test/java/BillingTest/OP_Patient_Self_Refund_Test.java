...
public class OP_Patient_Self_Refund_Test {
  ...
  {
	  BillingPages.OP_Patient_Self_Refund_Page FullRefund=new BillingPages.OP_Patient_Self_Refund_Page(driver);
	  FullRefund.OPRefundForSelf(PrimaryIdNumberPar,ExparyDatePar,SecondaryIdNumberPar,SecondaryExparyDatePar,FullNamePar,DateOfBirthPar,MotherNamePar,PatientNotesPar,ResidentialAddressPar,PostCodePar,MobileNumberPar,Emailpar,PersonalFaxpar,WorkFaxpar,WorkContactNopar,HomeContactNopar,DepositAmountPar,DepositRemarksPar,IDNoPar,PaymentRemarksPar,RefundAmountPar);
  ...
  public void startBrowser() throws ATUTestRecorderException, InterruptedException 
  {
	  WebDriverManager.chromedriver().setup();
		...
		recorder = new ATUTestRecorder(".//Videos//","OP_Patient_Self_Refund_Test"+dateFormat.format(date),false);
		recorder.start();
