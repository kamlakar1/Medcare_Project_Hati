...
public class Existing_Patient_OPCharge_Save_Self_Test {
	...
	public void startBrowser() throws ATUTestRecorderException, InterruptedException 
	{
		...
		recorder = new ATUTestRecorder(".//Videos//","Existing_Patient_OPCharge_Save_Self_Test"+dateFormat.format(date),false);
		recorder.start();
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_Existing_Patient_OPCharge_Save_Self_Test"+ dateFormat.format(date)));
		}
