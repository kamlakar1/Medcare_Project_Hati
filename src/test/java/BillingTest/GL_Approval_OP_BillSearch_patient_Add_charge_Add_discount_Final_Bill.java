...
public class GL_Approval_OP_BillSearch_patient_Add_charge_Add_discount_Final_Bill {
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","GL_Approval_OP_BillSearch_patient_Add_charge_Add_discount_Final_Bill -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//GL_Approval_OP_BillSearch_patient_Add_charge_Add_discount_Final_Bill"+ dateFormat.format(date)));
		}
	}
