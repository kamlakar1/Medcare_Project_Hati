...
public class OP_Patient_Self_Deposit_Full_Consume_Test {
  ...
  {
	  BillingPages.OP_Patient_Self_Deposit_Full_Consume_Page OPPatientDepositSelf=new BillingPages.OP_Patient_Self_Deposit_Full_Consume_Page(driver);
	  OPPatientDepositSelf.OPPatientDepositSelfFullConsume(PrimaryIdNumber12,ExparyDatePar,SecondaryIdNumber12,SecondaryExparyDatePar,FullNamePar,DateOfBirthPar,MotherNamePar,PatientNotes,ResidentialAddressPar,PostCodePar,MobileNumberPar,Emailpar,PersonalFaxpar,WorkFaxpar,WorkContactNopar,HomeContactNopar,DepositAmountPar,DepositRemarksPar,IDNoPar,PaymentRemarksPar,ServiceNamePar,ServiceName2Par);
  ...
  public void startBrowser() throws ATUTestRecorderException, InterruptedException 
  {
	  ...
	  WebDriverManager.chromedriver().setup();
		...
		recorder = new ATUTestRecorder(".//Videos//","OP_Patient_Self_Deposit_Full_Consume_Test"+dateFormat.format(date),false);
		recorder.start();
  ...
  public void FailedScreenShot(ITestResult Result) throws IOException
  {
      if(ITestResult.FAILURE==Result.getStatus())
      {
          ...
          FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OP_Patient_Self_Deposit_Full_Consume_Test"+ dateFormat.format(date)));
      }
