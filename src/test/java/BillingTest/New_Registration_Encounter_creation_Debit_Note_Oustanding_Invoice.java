...
public class New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice {
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//New_Registration_Encounter_creation_Debit_Note_Oustanding_Invoice"+ dateFormat.format(date)));
		}
	}
