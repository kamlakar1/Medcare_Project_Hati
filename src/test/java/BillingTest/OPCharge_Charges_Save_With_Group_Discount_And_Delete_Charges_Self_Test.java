...
import BillingPages.OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Page;
import OPDpages.Login;
import atu.testrecorder.ATUTestRecorder;
import atu.testrecorder.exceptions.ATUTestRecorderException;
import io.github.bonigarcia.wdm.WebDriverManager;

public class OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Test {
  ...
  public void startBrowser() throws ATUTestRecorderException, InterruptedException 
  {
	  ...
	  WebDriverManager.chromedriver().setup();
		...
		recorder = new ATUTestRecorder(".//Videos//","OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self_Test"+dateFormat.format(date),false);
		recorder.start();
  ...
  public void FailedScreenShot(ITestResult Result) throws IOException
  {
      if(ITestResult.FAILURE==Result.getStatus())
      {
          ...
          FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OPCharge_Charges_Save_With_Group_Discount_And_Delete_Charges_Self"+ dateFormat.format(date)));
      }
