...
public class Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note {
	...
	{
		BillingPages.Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note DebitNote=new BillingPages.Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note(driver);
		DebitNote.Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Notefunc(QuickPrimaryIdNumberPar,QuickExparyDatePar,QuickDateOfBirthPar,QuickMobileNumberPar,QuickEncounterRemarksPar,QuickAddNotesPar,QuickEncounterNotesPar,QuickPatientNotesPar,QuickReferralRemarksPar,ServiceNamePar,ServiceName2Par,ReceivedFromPar,IdentificationNoPar,RemarksPar);
	...
	public void startBrowser() throws ATUTestRecorderException 
	{
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
		Date date = new Date();
		recorder = new ATUTestRecorder(".//Videos//","Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note -"+dateFormat.format(date),false);
		recorder.start();  
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failed_Debit_Note_Billing_Summary_Debit_Note_List_Print_Debit_Note"+ dateFormat.format(date)));
		}
	}
