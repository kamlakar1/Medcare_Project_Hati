...
import BillingPages.Existing_Patient_OPCharge_WithDiscount_Save_Self_Page;
...
public class Existing_Patient_OPCharge_WithDiscount_Save_Self_Test {
  ...
  public void startBrowser() throws ATUTestRecorderException, InterruptedException 
  {
		...
		recorder = new ATUTestRecorder(".//Videos//","Existing_Patient_OPCharge_WithDiscount_Save_Self_Test"+dateFormat.format(date),false);
		recorder.start();
