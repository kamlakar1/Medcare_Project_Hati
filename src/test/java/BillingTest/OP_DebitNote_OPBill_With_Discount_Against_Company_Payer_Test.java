...
import BillingPages.OP_Debit_Note_OPBill_Against_Company_Payer_Page;
import BillingPages.OP_Debit_Note_OPBill_With_Discount_Against_Company_Payer_Page;
...
public class OP_DebitNote_OPBill_With_Discount_Against_Company_Payer_Test {
  ...
  public void startBrowser() throws ATUTestRecorderException, InterruptedException 
  {
		...
		recorder = new ATUTestRecorder(".//Videos//","OP_DebitNote_OPBill_With_Discount_Against_Company_Payer_Test"+dateFormat.format(date),false);
		recorder.start();
  ...
  public void FailedScreenShot(ITestResult Result) throws IOException
  {
      if(ITestResult.FAILURE==Result.getStatus())
      {
          ...
          FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OP_DebitNote_OPCharges_Save_Against_Company_Payer_Test"+ dateFormat.format(date)));
      }
