...
public class OP_GLApproval_Status_Approved_Test {
 ...
 public void startBrowser() throws ATUTestRecorderException, InterruptedException 
 {
		...
		recorder = new ATUTestRecorder(".//Videos//","OP_GLApproval_Status_Approved_Test"+dateFormat.format(date),false);
		recorder.start();
 ...
 public void FailedScreenShot(ITestResult Result) throws IOException
 {
     if(ITestResult.FAILURE==Result.getStatus())
     {
         ...
         FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_OP_GLApproval_Status_Approved_Test"+ dateFormat.format(date)));
     }
